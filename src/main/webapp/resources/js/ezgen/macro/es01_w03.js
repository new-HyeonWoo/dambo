...
function MC_토지의표시_전체면적_수정() {
    ...
    GetComponent('DBGrid_담보제공비율').GetRow(GetNumber('i'), [{key: '담보제공비율_전체면적', value: 'SEC_REGI_SIZE'},
    ...
    GetComponent('DBGrid_담보제공비율').SetRow(GetValue('i'), [{key: 'SEC_REGI_SIZE', value: GetValue('토지의표시_전체면적')},
    ...
    SetValue('담보제공비율_비율', GetNumber('담보제공비율_분자') / GetNumber('담보제공비율_분모'))
    SetValue('담보제공비율_담보제공면적', GetNumber('담보제공비율_전체면적') * GetNumber('담보제공비율_비율'))


    GetComponent('DBGrid_담보제공비율').SetRow(GetValue('i'), [{key: 'SEC_RATE', value: GetValue('담보제공비율_비율')},
    ...
    GetComponent('DBGrid_평가액').GetRow(GetNumber('i'), [{key: '평가액_평가가액', value: 'INC_AMT'},]);


    SetValue('담보제공비율_비율', GetNumber('담보제공비율_분자') / GetNumber('담보제공비율_분모'))
    SetValue('담보제공비율_담보제공면적', GetNumber('담보제공비율_전체면적') * GetNumber('담보제공비율_비율'))
    SetValue('담보제공비율_최종평가가액', GetNumber('평가액_평가가액') * GetNumber('담보제공비율_비율'))


    GetComponent('DBGrid_담보').SetRow(GetValue('i'), [{key: 'SEC_NUME', value: GetValue('담보제공비율_분자')},
...
function MC_담보제공비율_전체면적() {
    ...
    GetComponent('DBGrid_토지의표시').GetRows("", [{key: '토지의표시_일단지구분_Arr', value: 'POT_GU'},
    ...
    GetComponent('DBGrid_담보제공비율').SetRow(GetValue('토지의표시_RowPosition'), [{key: 'LN_SEQ', value: GetValue('토지의표시_순번')},
...
function MC_토지의표시_자동연산() {
    ...
    SetValue('토지의표시_개별공시지가_총', GetNumber('토지의표시_개별공시지가') * GetNumber('토지의표시_면적'))


    GetComponent('DBGrid_토지의표시').SetRow(-1, [{key: 'L_SIZE_PY', value: GetValue('토지의표시_면적_평')},
...
function MC_본건토지_자동추가() {
    ...
    GetComponent('DBGrid_본건토지').SetRow(GetValue('토지의표시_RowPosition'), [{key: 'LN_SEQ', value: GetValue('토지의표시_순번')},
...
function MC_주소반환() {
    ...
    GetComponent('DBGrid_주소').GetRow(-1, [{key: '팝업_전체주소', value: 'JUSO_FULL'},]);
    ...
    if (GetValue('주소구분') == 2) {
        ...
        GetComponent('DBGrid_토지의표시').SetRow(-1, [{key: 'MIN_BOUND', value: GetValue('팝업_전체주소')},
    ...
    if (GetValue('주소구분') == 3) {
        ...
        GetComponent('DBGrid_표준지공시지가').SetRow(-1, [{key: 'JUSO1', value: GetValue('팝업_전체주소')},], true);

    }

    if (GetValue('주소구분') == 4) {

        GetComponent('DBGrid_비준가격_산정사례').SetRow(-1, [{key: 'JUSO1', value: GetValue('팝업_전체주소')},
...
function MC_Combo_일단지구분() {
    ...
    GetComponent('DBGrid_토지의표시').GetRows("", [{key: 'Combo_일단지구분_Arr', value: 'POT_GU'},
...
function MC_건물단가_항목변경() {
    ...
    GetComponent('DBGrid_건물단가').GetRow(GetNumber('건물단가_RowPosition'), [{key: '건물단가_표준단가_급수', value: 'CB_BUILD_CODE'},
...
function MC_비준가격_저촉률() {
    ...
    GetZoonData('Q_코드_도시계획').GetRow(GetValue('00_RowIndex'), [{key: '비준가격_도시계획_본건', value: 'ATTR_08'},]);
    ...
    GetZoonData('Q_코드_도시계획').GetRow(GetValue('00_RowIndex'), [{key: '비준가격_도시계획_표준지', value: 'ATTR_08'},]);


    GetZoonData('Q_코드_저촉률').FindIndex('00_RowIndex', (row) => {

        if ((row['CD_CODE'] == GetValue('Combo_비준가격_표준지요인_저축률'))) {
            return true;
        }
    ...
    GetZoonData('Q_코드_저촉률').GetRow(GetValue('00_RowIndex'), [{key: '비준가격_저촉률_본건', value: 'ATTR_08'},]);
    ...
    GetZoonData('Q_코드_저촉률').GetRow(GetValue('00_RowIndex'), [{key: '비준가격_저촉률_표준지', value: 'ATTR_08'},]);
    ...
    SetValue('Edit_비준가격_비교치_저촉률', GetNumber('비준가격_저촉률_본건_값') / GetNumber('비준가격_저촉률_표준지_값'))


    GetComponent('DBGrid_비준가격').SetRow(-1, [{key: 'LIMIT_AREA_C', value: GetValue('Edit_비준가격_비교치_저촉률')}, true]);

}

function MC_Combo_표준지() {

    GetComponent('DBGrid_표준지공시지가').GetRows("", [{key: 'Combo_표준지_Arr', value: 'S_GU'},]);
...
function MC_담보제공비율_건물_전체면적() {
    ...
    GetComponent('DBGrid_건물의표시').GetRows("", [{key: '건물의표시_등기구분_Arr', value: 'REGI_GU'},

        {key: '건물의표시_면적_Arr', value: 'CB_SIZE'},]);


    GetComponent('DBGrid_담보제공비율_건물').SetRow(GetValue('건물의표시_RowPosition'), [{key: 'REGI_GU', value: GetValue('건물의표시_등기구분')},
        ...
        {key: 'SEC_REGI_SIZE', value: GetValue('건물의표시_면적')},], true);
...
function MC_비준가격_집계표() {
    ...
    GetComponent('DBGrid_비준가격').GetRow(-1, [{key: '비준가격_일단지구분', value: 'POT_GU'},
    ...
    GetComponent('DBGrid_비준가격집계표').SetRow(GetValue('비준가격_RowPosition'), [{key: 'POT_GU', value: GetValue('비준가격_일단지구분')},
        ...
        {key: 'FACTOR_TOT', value: GetNumber('비준가격_요인합계')},

        {key: 'APAS_DAN', value: GetNumber('비준가격_산정단가')},

        {key: 'APPL_DAN', value: GetNumber('비준가격_적용단가')},], true);
...
function MC_비준가격_참조값_본건() {
    ...
    GetComponent('DBGrid_토지의표시').GetRow(GetNumber('토지의표시_RowPosition'), [{key: '토지의표시_최소행정구역', value: 'MIN_BOUND'},]);


    GetComponent('DBGrid_본건토지').GetRow(GetNumber('토지의표시_RowPosition'), [{key: '토지의표시_도로조건', value: 'OF_ROAD_CODE'},
    ...
    GetComponent('DBGrid_비준가격').SetRow(-1, [{key: 'JUSO_M', value: GetValue('토지의표시_최소행정구역')},
        ...
        {key: 'ROAD_SIDE_M', value: GetValue('토지의표시_도로조건')},], true);
...
function MC_배당표_배당금건물_RowChange() {
    ...
    GetComponent('DBGrid_배당금건물_계산M').GetRow(-1, [{key: '배당표_배당금계산건물M_순번', value: 'REGI_GU'},]);
...
function MC_저장_담보제공비율_건물() {
    ...
    RunQuery('저장_담보제공비율_건물', {
        '년도': GetValue('년도'),
        '감정순번': GetValue('감정순번'),
        '저장_담보제공비율_건물_년도': GetValue('저장_담보제공비율_건물_년도'),
        '저장_담보제공비율_건물_일련번호': GetValue('저장_담보제공비율_건물_일련번호'),
        '저장_담보제공비율_건물_순번': GetValue('저장_담보제공비율_건물_순번')
    }, 'POST');
...
function MC_배당표_배당금건물_삭제M_전체() {
    ...
    GetComponent('DBGrid_건물의표시').GetRow(-1, [{key: '건물의표시_건물의표시순번', value: 'LN_SEQ'}]);
...
function MC_담보제공비율_참조값() {
    ...
    GetComponent('DBGrid_토지의표시').GetRow(-1, [{key: '토지의표시_일단지구분', value: 'POT_GU'},
    ...
    GetComponent('DBGrid_담보제공비율').GetRow(-1, [{key: '토지의표시_면적', value: 'SEC_OFFER_SIZE'},
    ...
    GetComponent('DBGrid_기타요인').GetRow(GetNumber('표준지공시지가_RowPosition'), [{key: '기타요인_표준지공시지가', value: 'STD_APPL_DAN'},
    ...
    GetComponent('DBGrid_비준가격집계표').GetRow(GetNumber('표준지공시지가_RowPosition'), [{key: '비준가격_산정단가', value: 'APAS_DAN'},
    ...
    GetComponent('DBGrid_평가액').SetRow(GetValue('토지의표시_RowPosition'), [{key: 'ANNO_DAN', value: GetValue('토지의표시_개별공시지가')},
        ...
        {key: 'INC_AMT', value: GetNumber('평가액_평가가액')},], true);
...
function MC_저장_ValidationCheck_비준가격() {
    ...
    if (GetArray('저장_비준가격_일단지구분', GetValue('i')) == "") {
        SetValue('저장_Error_Message', "비준가격산정_일단지구분을 선택하여 주십시오.")
    }

    if (GetArray('저장_비준가격_사례번호', GetValue('i')) == "") {
...
function MC_저장_ValidationCheck_본건토지() {
    ...
    if (GetArray('저장_본건토지_형상', GetValue('i')) == "") {
        SetValue('저장_Error_Message', "본건토지_형상을 선택하여 주십시오.")
    }

    if (GetArray('저장_본건토지_도로조건', GetValue('i')) == "") {
        SetValue('저장_Error_Message', "본건토지_도로조건을 선택하여 주십시오.")
    }

    if (GetArray('저장_본건토지_이용현황', GetValue('i')) == "") {
        SetValue('저장_Error_Message', "본건토지_이용현황을 선택하여 주십시오.")
    }

    if (GetArray('저장_본건토지_용도지역', GetValue('i')) == "") {
...
function MC_Combo_사례번호() {
    ...
    GetComponent('DBGrid_비준가격_산정사례').GetRows("", [{key: 'Combo_사례번호_Arr', value: 'EX_NO'},]);
...
function MC_보정표_예상낙찰가_건물_계산() {
    ...
    SetValue('보정표_예상낙찰가_건물', GetNumber('보정표_예상낙찰가_건물') + (GetArray('담보_건물_최종평가가액_Arr', GetNumber('i')) * GetNumber('Edit_보정표_적용할낙찰가율')))
...
function MC_저장_ValidationCheck_기타요인() {
    ...
    if (GetArray('저장_기타요인_사정보정률', GetValue('i')) <= 0) {
        SetValue('저장_Error_Message', "기타요인_사정보정률을 입력하여 주십시오.")
    }

    if (GetArray('저장_기타요인_가격수준', GetValue('i')) == "") {
...
*/
    ...
    GetComponent('DBGrid_건물의표시').SetRows(GetValue('m_index'), [{key: 'SEC_NUME', value: GetValue('담보제공비율_건물_분자')},
        ...
        {key: 'SEC_DESC', value: GetValue('담보제공비율_건물_사유')},], true);
...
function MC_담보제공비율_비율() {
    ...
    GetComponent('DBGrid_담보제공비율').GetRow(GetNumber('담보제공비율_RowPosition'), [{key: '담보제공비율_전체면적', value: 'SEC_REGI_SIZE'},
    ...
    GetComponent('DBGrid_평가액').GetRow(-1, [{key: '평가액_평가가액', value: 'INC_AMT'},]);
    ...
    GetComponent('DBGrid_담보').SetRow(GetValue('담보제공비율_RowPosition'), [{key: 'SEC_NUME', value: GetValue('담보제공비율_분자')},
        ...
        {key: 'FNL_INC_AMT', value: GetValue('담보제공비율_최종평가가액')},], true);


    GetComponent('DBGrid_담보제공비율').SetRow(-1, [{key: 'SEC_RATE', value: GetValue('담보제공비율_비율')},

        {key: 'SEC_OFFER_SIZE', value: GetValue('담보제공비율_담보제공면적')},

        {key: 'SEC_DESC_ENABLE', value: GetValue('00_NUMBER')},], true);
...
function MC_저장_Key만들기() {
    ...
    GetZoonData('Q_감정순번').GetRow(0, [{key: 'Edit_감정순번', value: 'SEQ'},
...
function MC_저장_입력표() {
    ...
    GetComponent('DBGrid_담보').GetRows("", [{key: '담보_최종평가가액_Arr', value: 'FNL_INC_AMT'},]);


    GetComponent('DBGrid_담보_건물').GetRows("", [{key: '담보_건물_최종평가가액_Arr', value: 'FNL_INC_AMT'},]);
    ...
    if (isNotEmpty(GetValue('Edit_Doc_Key'))) {
        ...
        RunQuery('저장_결재자현황_영업_Clear', {
            'YYYY': GetValue('년도'), 'SEQ': GetValue('감정순번')
        }, 'POST');


        RunQuery('저장_결재자현황_영업', {
            'DOC_KEY': GetValue('Edit_Doc_Key'), 'YYYY': GetValue('년도'), 'SEQ': GetValue('감정순번')
        }, 'POST');
...
function MC_건물의표시_전체면적_수정() {
    ...
    GetComponent('DBGrid_담보제공비율_건물').GetRow(GetNumber('i'), [{key: '건물의표시_등기구분', value: 'REGI_GU'},]);
    ...
    GetComponent('DBGrid_담보제공비율_건물').SetRow(GetValue('i'), [{key: 'SEC_REGI_SIZE', value: GetValue('건물의표시_전체면적')},

        {key: 'SEC_DENO', value: GetValue('건물의표시_전체면적')},]);


    GetComponent('DBGrid_담보제공비율_건물').GetRow(GetNumber('i'), [{key: '담보제공비율_건물_전체면적', value: 'SEC_REGI_SIZE'},
    ...
    GetComponent('DBGrid_담보제공비율_건물').SetRow(GetValue('i'), [{key: 'SEC_RATE', value: GetValue('담보제공비율_건물_비율')},

        {key: 'SEC_OFFER_SIZE', value: GetValue('담보제공비율_건물_담보제공면적')},], true);
    ...
    GetComponent('DBGrid_담보_건물').SetRow(GetValue('i'), [{key: 'SEC_NUME', value: GetValue('담보제공비율_건물_분자')},

        {key: 'SEC_DENO', value: GetValue('담보제공비율_건물_분모')},

        {key: 'SEC_RATE', value: GetValue('담보제공비율_건물_비율')},

        {key: 'REGI_GU', value: GetValue('담보제공비율_건물_등기구분')},], true);
...
function MC_저장_ValidationCheck() {
    ...
    GetComponent('DBGrid_토지의표시').GetModifyData([{key: '저장_토지의표시_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_담보제공비율_건물').GetModifyData([{key: '저장_담보제공비율_건물_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_건물의표시').GetModifyData([{key: '저장_건물의표시_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_담보제공비율').GetModifyData([{key: '저장_담보제공비율_건물_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_본건토지').GetModifyData([{key: '저장_본건토지_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_표준지공시지가').GetModifyData([{key: '저장_표준지공시지가_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_비준가격_산정사례').GetModifyData([{key: '저장_비준가격산정사례_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_기준가격').GetModifyData([{key: '저장_기준가격_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_비준가격').GetModifyData([{key: '저장_비준가격_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_기타요인').GetModifyData([{key: '저장_기타요인_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_평가액').GetModifyData([{key: '저장_평가액_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_담보').GetModifyData([{key: '저장_담보_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_건물단가').GetModifyData([{key: '저장_건물단가_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_담보_건물').GetModifyData([{key: '저장_담보_건물_년도', value: 'YYYY', isDelRowInclude: true},
...
*/
    ...
    GetComponent('TabControl1').SetCurSel(8.0);

    if (isNotEmpty(GetValue('저장_Error_Message'))) {
        return false;
    }

    GetComponent('DBGrid_배당표_주택임대차보증금_계산').GetModifyData([{key: '저장_배당표_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_배당금_계산D').GetModifyData([{key: '저장_배당표_배당금_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_배당금건물_계산D').GetModifyData([{key: '저장_배당표_배당금_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_사진관리').GetModifyData([{key: '저장_문서관리_년도', value: 'YYYY', isDelRowInclude: true},
    ...
    GetComponent('DBGrid_문서').GetModifyData([{key: '저장_문서관리_문서_년도', value: 'YYYY', isDelRowInclude: true},
...
function MC_탭_상태변경() {
    ...
    GetComponent('TabControl1').EnableTab(10, 0);
...
function MC_저장_ValidationCheck_기준가격() {
    ...
    if (GetArray('저장_기준가격_일단지구분', GetValue('i')) == "") {
        SetValue('저장_Error_Message', "표준지공시지가기준가격_일단지구분을 선택하여 주십시오.")
    }

    if (GetArray('저장_기준가격_표준지구분', GetValue('i')) == "") {
...
function MC_저장_ValidationCheck_사진() {
    ...
    if (GetArray('저장_문서관리_문서_경로및파일명', GetValue('i')) == "") {
        SetValue('저장_Error_Message', "관련문서_파일을 선택하여 주십시오.")
    }

    if (GetArray('저장_문서관리_문서_사진명', GetValue('i')) == "") {
...
function MC_토지의표시_전체합계() {
    ...
    GetComponent('DBGrid_토지의표시').GetRows('', [{key: '토지의표시_면적_Arr', value: 'L_SIZE'},
...
function MC_담보제공비율_건물_비율() {
    ...
    for (SetValue('i', 0); GetValue('i') < GetNumber('담보제공비율_건물_RowCount'); SetValue('i', GetValue('i') + 1)) {
    ...
    for (SetValue('i', 0); GetValue('i') < GetNumber('담보_건물_RowCount'); SetValue('i', GetValue('i') + 1)) {
        MC_담보_건물_최종평가가액();
    }
...
function MC_저장_키설정() {
    ...
    GetComponent('DBGrid_토지의표시').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
    ...
    GetComponent('DBGrid_담보제공비율').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
    ...
    GetComponent('DBGrid_본건토지').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
    ...
    GetComponent('DBGrid_표준지공시지가').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
    ...
    GetComponent('DBGrid_비준가격_산정사례').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
    ...
    GetComponent('DBGrid_기준가격').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
    ...
    GetComponent('DBGrid_비준가격').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
    ...
    GetComponent('DBGrid_기타요인').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
    ...
    GetComponent('DBGrid_평가액').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
    ...
    GetComponent('DBGrid_담보').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
    ...
    GetComponent('DBGrid_건물의표시').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
    ...
    GetComponent('DBGrid_담보제공비율_건물').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
    ...
    GetComponent('DBGrid_건물단가').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
    ...
    GetComponent('DBGrid_배당표_주택임대차보증금_계산').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
    ...
    GetComponent('DBGrid_배당금_계산D').SetRows(GetValue('m_index'), [{key: 'YYYY', value: GetValue('년도')},
...
function MC_저장_쿼리호출() {
    ...
    if (GetValue('저장_비가격산정사례준_RowCount') > 0) {
        MC_저장_비준가격산정사례();
    }
    ...
    RunQuery('저장_배당금_권리자_CLEAR', {}, 'POST');
    ...
    // if (GetValue('저장_담보재공비율_건물_RowCount') > 0) {
    //     MC_저장_담보재공비율_건물();
    // }
...
function MC_저장_보정표() {
    ...
    if (GetValue('Combo_보정표_법정지상권_존속기간') == "") {
...
function MC_배당금_Flag변경() {
    ...
    //
    //
    // GetComponent('DBGrid_배당금_계산').SetModifyFlag('None', None);
...
function MC_배당표_배당금_계산_기초데이터() {
    ...
    GetZoonData('Q_배당표_배당금_계산D_Temp').GetRows("", [{key: '배당표_배당금계산TMP_배당순위', value: 'RANK'},
...
function MC_배당표_배당금_계산_기초데이터_입력() {
    ...
    GetZoonData('Q_배당표_배당금_계산D').AddRow(0, [GetValue('년도'),
...
function MC_배당표_배당금건물_계산_기초데이터() {
    ...
    GetZoonData('Q_배당표_배당금건물_계산D_Temp').GetRows("", [{key: '배당표_배당금계산건물TMP_배당순위', value: 'RANK'},
...
function MC_배당표_배당금건물_계산_기초데이터_입력() {
    ...
    GetZoonData('Q_배당표_배당금건물_계산D').AddRow(0, [GetValue('년도'),
...
function MC_배당표_상가임대차보증금_계산() {
    ...
    GetComponent('DBGrid_배당표_상가건물_임대차보증금_계산').GetRow(GetNumber('i'), [{key: '배당표_상가_임대차보증금', value: 'STO_LSEC_AMT'},
...
function MC_저장_배당표_배당금D() {
    ...
    GetZoonData('Q_배당표_배당금_계산D').SetRows(GetValue('m_index'), [{key: 'FLAG', value: GetValue('I')}, {
        key: 'YYYY',
        value: GetValue('년도')
    }, {key: 'SEQ', value: GetValue('감정순번')}]);


    GetZoonData('Q_배당표_배당금_계산D').GetRows("", [{key: '저장_배당표_배당금_년도', value: 'YYYY'},
    ...
    // GetZoonData('Q_배당표_배당금_계산D').SetRows(GetValue('m_index'), [{key: 'FLAG', value: 'D'},
    //
    // ]);
    //
    //
    // GetZoonData('Q_배당표_배당금_계산D').GetRows("", [{key: '저장_배당표_배당금D_년도', value: 'YYYY'},
    //
...
function MC_저장_배당표건물_배당금D() {
    ...
    GetZoonData('Q_배당표_배당금건물_계산D').SetRows(GetValue('m_index'), [{key: 'FLAG', value: 'I'},
    ...
    GetZoonData('Q_배당표_배당금건물_계산D').GetRows("", [{key: '저장_배당표_배당금건물_년도', value: 'YYYY'},
    ...
    // GetZoonData('Q_배당표_배당금건물_계산D').SetRows(GetValue('m_index'), [{key: 'FLAG', value: 'D'},
    //
    // ]);
    //
    //
    // GetZoonData('Q_배당표_배당금건물_계산D').GetRows("", [{key: '저장_배당표_배당금건물D_년도', value: 'YYYY'},
    //
...
function MC_저장_ValidationCheck_배당표_배당금() {
    ...
    if (GetArray('저장_배당표_배당금_단독담보', GetValue('i')) <= 0 && GetValue('저장_배당표_배당금_공동담보') <= 0) {
    ...
    if (GetArray('저장_배당표_배당금_발생일자', GetValue('i')) == "" || GetArray('저장_배당표_배당금_발생일자', GetValue('i')) == "00000000") {
...
function MC_토지배당금M_참조값() {
    ...
    GetComponent('DBGrid_토지의표시').GetRow(GetNumber('토지의표시_RowPosition'), [{key: '토지의표시_일단지구분', value: 'POT_GU'},
    ...
    GetComponent('DBGrid_배당금_계산M').SetRow(GetValue('토지의표시_RowPosition'), [{key: 'POT_GU', value: GetValue('토지의표시_일단지구분')},

        {key: 'LOT_NUM', value: GetValue('토지의표시_지번')},

        {key: 'MIN_BOUND', value: GetValue('토지의표시_최소행정구역')},], true);
...
function MC_저장_주택임차보증금() {
    ...
    RunQuery('Q_배당표_주택임차보증금_계산', {}, 'GET');

}

function MC_배당표_배당금_RowChange() {

    GetComponent('DBGrid_배당금_계산M').GetRow(-1, [{key: '배당표_배당금계산M_순번', value: 'LN_SEQ'},]);
...
function MC_평가액_참조값() {
    ...
    GetComponent('DBGrid_토지의표시').GetRow(GetNumber('i'), [{key: '토지의표시_일단지구분', value: 'POT_GU'},
    ...
    GetComponent('DBGrid_기타요인').GetRow(GetNumber('기타요인_RowPosition'), [{key: '기타요인_표준지공시지가', value: 'STD_APPL_DAN'},
    ...
    if (GetValue('기타요인_RowPosition') >= 0) {
        ...
        GetComponent('DBGrid_비준가격집계표').GetRow(GetNumber('비준가격산정사례_RowPosition'), [{key: '비준가격_산정단가', value: 'APAS_DAN'},
        ...
        GetComponent('DBGrid_평가액').SetRow(GetValue('i'), [{key: 'ANNO_AMT', value: GetValue('토지의표시_개별공시지가')},
...
function MC_기준가격_감가율() {
    ...
    GetComponent('DBGrid_기준가격').GetRow(-1, [{key: '기준가격_일단지구분', value: 'POT_GU'},]);
...
function MC_기준가격_집계표() {
    ...
    GetComponent('DBGrid_기준가격').GetRow(GetNumber('기준가격_RowPosition'), [{key: '기준가격_일단지구분', value: 'POT_GU'},
    ...
    GetComponent('DBGrid_기준가격집계표').SetRow(GetValue('기준가격_RowPosition'), [{key: 'POT_GU', value: GetValue('기준가격_일단지구분')},
...
function MC_기준가격_참조값_본건() {
    ...
    GetComponent('DBGrid_기준가격').GetRow(-1, [{key: '토지의표시_순번', value: 'POT_GU'},]);

    if (GetValue('토지의표시_순번') == '') {
        return false;
    }
    ...
    GetComponent('DBGrid_기준가격').SetRow(-1, [{key: 'JUSO_M', value: GetValue('토지의표시_최소행정구역')},
...
function MC_기준가격_참조값_표준지() {
    ...
    GetComponent('DBGrid_기준가격').GetRow(-1, [{key: '표준지공시지가_표준지구분', value: 'STD_GU'},]);
    ...
    GetComponent('DBGrid_표준지공시지가').FindIndex('표준지공시지가_RowPosition', (row) => {
        ...
        if ((row['S_HU'] == GetValue('표준지공시지가_표준지구분'))) {
            return true;
        }
    ...
    GetComponent('DBGrid_기준가격').SetRow(-1, [{key: 'JUSO_S', value: GetValue('표준지공시지가_소재지')},
...
function MC_기타요인_산정보정률() {
    ...
    if (GetNumber('기타요인_최저') > GetNumber('기타요인_비준가격')) {
    ...
    } else if (GetNumber('기타요인_최저') == GetNumber('기타요인_비준가격')) {
        ...
        SetValue('기타요인_산정보정률', GetNumber('기타요인_비준가격') / GetNumber('기타요인_표준지공시지가'))
    } else if (GetNumber('기타요인_비준가격') == GetNumber('기타요인_최고')) {
        SetValue('기타요인_산정보정률', GetNumber('기타요인_비준가격') / GetNumber('기타요인_표준지공시지가'))
    ...
    GetComponent('DBGrid_기타요인').SetRow(GetValue('기타요인_RowPosition'), [{key: 'APAS_RATE', value: GetValue('기타요인_산정보정률')},

        {key: 'APPL_RATE', value: GetValue('기타요인_적용보정률')},

        {key: 'ASSESS_DESC_ENABLE', value: GetValue('00_NUMBER')},], true);

    if (GetValue('00_NUMBER') == 0) {

        GetComponent('DBGrid_기타요인').SetRow(GetValue('기타요인_RowPosition'), [{key: 'ASSESS_DESC', value: ''},], true);
...
function MC_기타요인_참조값() {
    ...
    GetComponent('DBGrid_기타요인').GetRow(GetNumber('i'), [{key: '기타요인_일단지구분', value: 'POT_GU'},]);
    ...
    if (GetValue('기준가격_RowPosition') >= 0) {
        ...
        GetComponent('DBGrid_기준가격').GetRow(GetNumber('기준가격_RowPosition'), [{key: '기타요인_표준지공시지가', value: 'APPL_DAN'},]);


        GetComponent('DBGrid_기타요인').SetRow(GetValue('i'), [{key: 'STD_APPL_DAN', value: GetValue('기타요인_표준지공시지가')},], true);
    ...
    if (GetValue('비준가격_RowPosition') >= 0) {
        ...
        GetComponent('DBGrid_비준가격집계표').GetRows(GetValue('m_index'), [{key: '기타요인_비준가격_Arr', value: 'APPL_DAN'},]);
        ...
        GetComponent('DBGrid_기타요인').SetRow(GetValue('i'), [{key: 'CO_AMT', value: GetValue('기타요인_비준가격')},], true);
...
function MC_기타요인_최저최고() {
    ...
    GetComponent('DBGrid_기타요인').GetRow(GetNumber('기타요인_RowPosition'), [{key: '기타요인_가격수준', value: 'MA_NR_AREA_CODE'},]);
    ...
    GetComponent('DBGrid_기타요인').SetRow(GetValue('기타요인_RowPosition'), [{key: 'MA_NR_MIN_AMT', value: GetValue('기타요인_최저')},

        {key: 'MA_NR_MAX_AMT', value: GetValue('기타요인_최고')},], true);
...
function MC_담보_참조값() {
    ...
    GetComponent('DBGrid_담보').GetRow(GetNumber('i'), [{key: '평가액_비율', value: 'SEC_RATE'},]);


    SetValue('평가액_최종평가가액', GetNumber('평가액_평가가액') * (GetNumber('평가액_비율') / 100))


    GetComponent('DBGrid_담보').SetRow(GetValue('i'), [{key: 'INC_AMT', value: GetNumber('평가액_평가가액')},

        {key: 'FNL_INC_AMT', value: GetNumber('평가액_최종평가가액')},], true);
...
function MC_배당표_배당금_삭제M_전체() {
    ...
    GetComponent('DBGrid_토지의표시').GetRow(-1, [{key: '토지의표시_순번', value: 'LN_SEQ'},]);
...
function MC_보정표_예상낙찰가() {
    ...
    SetValue('Edit_보정표_적용할낙찰가율', GetValue('Edit_보정표_기준낙찰가율') * GetValue('Edit_보정표_단독주택_접한도로폭_적용률') * GetValue('Edit_보정표_단독주택_대지의면적_적용률') * GetValue('Edit_보정표_단독주택_경과년도_적용률') * GetValue('Edit_보정표_상업용_접한도로폭_적용률') * GetValue('Edit_보정표_상업용_토지의형상_적용률') * GetValue('Edit_보정표_상업용_주변상권_적용률') * GetValue('Edit_보정표_상업용_경과년도_적용률') * GetValue('Edit_보정표_주거용_접한도로의폭_적용률') * GetValue('Edit_보정표_주거용_토지의면적_적용률') * GetValue('Edit_보정표_주거용_입지조건_적용률') * GetValue('Edit_보정표_주거용_경과년도_적용률') * GetValue('Edit_보정표_공유지분_적용률') * GetValue('Edit_보정표_법정지상권_적용률') * GetValue('Edit_보정표_점유자형태_적용률'))
    ...
    for (SetValue('i', 0); GetValue('i') < GetNumber('담보_RowCount'); SetValue('i', GetValue('i') + 1)) {
        MC_보정표_예상낙찰가_계산();
    }
    ...
    GetComponent('DBGrid_담보_건물_Group').GetRows("", [{key: '담보_건물_최종평가가액_Arr', value: 'FNL_INC_AMT'},
...
function MC_토지배당금계산_SYNC() {
    ...
    GetComponent('DBGrid_배당금_계산D').GetRow(GetNumber('i'), [{key: '배당표_배당금계산_배당순위', value: 'RANK'},
    ...
    if (GetNumber('배당표_배당금계산_IDX') >= 0) {
        ...
        GetZoonData('Q_배당표_배당금_계산D').SetRow(GetNumber('배당표_배당금계산_IDX'), [{key: 'DISP_RANK', value: GetValue('배당표_배당금계산_표시순위')},
...
function MC_배당표_배당금_채권최고액() {
    ...
    GetZoonData('Q_배당표_배당금_계산D').GetRows("", [{key: '배당표_배당금계산_단독담보_Arr', value: 'CRED_SELF_AMT'},
    ...
    GetZoonData('Q_배당표_배당금건물_계산D').GetRows("", [{key: '배당표_배당금계산건물_공동담보_Arr', value: 'CRED_COMB_AMT'},
...
function MC_입력표_주택_상가가임대보증금적용지역셋팅() {
    // if (GetValue('담보종류') == '201') {
    //     Function	None
    // }
}
...
function MC_배당표_배당금_기본항목자동설정() {
    ...
    if (GetValue('i') >= 0) {
        ...
        GetZoonData('Q_배당표_배당금_계산D').SetRows(GetValue('m_index'), [{key: 'CRED_COMB_AMT', value: GetNumber('Edit_배당표_경매비용')},
    ...
    if (GetValue('i') >= 0) {
        ...
        if (GetValue('00_가임대보증금초과여부') == 'Y') {
            ...
            GetZoonData('Q_배당표_배당금_계산D').SetRows(GetValue('m_index'), [{key: 'CRED_COMB_AMT', value: GetValue('Edit_배당표_경락가액')},
        ...
        if (GetValue('00_가임대보증금초과여부') == 'N') {
            ...
            GetZoonData('Q_배당표_배당금_계산D').SetRows(GetValue('m_index'), [{
                key: 'CRED_COMB_AMT',
                value: GetValue('Edit_배당표_합계_최종적용가임대보증금')
            },
    ...
    if (GetValue('i') >= 0) {
        ...
        if (GetValue('00_가임대보증금초과여부') == 'Y') {
            ...
            GetZoonData('Q_배당표_배당금_계산D').SetRows(GetValue('m_index'), [{key: 'CRED_COMB_AMT', value: GetValue('Edit_배당표_상가_경락가액')},
        ...
        if (GetValue('00_가임대보증금초과여부') == 'N') {
            ...
            GetZoonData('Q_배당표_배당금_계산D').SetRows(GetValue('m_index'), [{key: 'CRED_COMB_AMT', value: GetValue('Edit_배당표_상가_합계_최우선변제보증금')},
    ...
    if (GetValue('i') >= 0) {
        ...
        GetZoonData('Q_배당표_배당금건물_계산D').SetRows(GetValue('m_index'), [{key: 'CRED_COMB_AMT', value: GetNumber('Edit_배당표_경매비용')},
    ...
    if (GetValue('i') >= 0) {
        if (GetValue('00_가임대보증금초과여부') == 'Y') {
            ...
            GetZoonData('Q_배당표_배당금건물_계산D').SetRows(GetValue('m_index'), [{key: 'CRED_COMB_AMT', value: GetValue('Edit_배당표_경락가액')},
    ...
    if (GetValue('i') >= 0) {
        ...
        if (GetValue('00_가임대보증금초과여부') == 'Y') {
            ...
            GetZoonData('Q_배당표_배당금건물_계산D').SetRows(GetValue('m_index'), [{key: 'CRED_COMB_AMT', value: GetValue('Edit_배당표_상가_경락가액')},
        ...
        if (GetValue('00_가임대보증금초과여부') == 'N') {
            ...
            GetZoonData('Q_배당표_배당금건물_계산D').SetRows(GetValue('m_index'), [{
                key: 'CRED_COMB_AMT',
                value: GetValue('Edit_배당표_상가_합계_최우선변제보증금')
            }, {key: 'CRED_COMB_AMT_ORG', value: GetValue('Edit_배당표_상가_합계_최우선변제보증금')},]);
...
function MC_배당표_배당금_계산_EditChange() {
    ...
    GetComponent('DBGrid_배당금_계산D').GetRow(-1, [{key: '배당표_배당금계산_권리의내용', value: 'RIGHT_CODE'},]);
    ...
    GetZoonData('Q_코드_권리의내용').GetRow(GetValue('배당표_배당금계산_RowPosition'), [{key: '배당표_배당금계산_배당순위', value: 'ATTR_08'},]);


    GetComponent('DBGrid_배당금_계산D').SetRow(-1, [{key: 'PRO_RATE_CODE', value: GetValue('배당표_배당금계산_배당순위')},
...
function MC_기준가격_저촉률() {
    ...
    GetZoonData('Q_코드_도시계획').GetRow(GetValue('00_RowIndex'), [{key: '기준가격_도시계획_본건', value: 'ATTR_08'},]);
    ...
    GetZoonData('Q_코드_도시계획').GetRow(GetValue('00_RowIndex'), [{key: '기준가격_도시계획_표준지', value: 'ATTR_08'},
    ...
    GetZoonData('Q_코드_저촉률').GetRow(GetValue('00_RowIndex'), [{key: '기준가격_저촉률_본건', value: 'ATTR_08'},]);
    ...
    GetZoonData('Q_코드_저촉률').GetRow(GetValue('00_RowIndex'), [{key: '기준가격_저촉률_표준지', value: 'ATTR_08'},]);
    ...
    GetComponent('DBGrid_기준가격').SetRow(-1, [{key: 'LIMIT_AREA_C', value: GetValue('Edit_기준가격_비교치_저촉률')},], true);
...
function MC_저장_ValidationCheck_일단지중복_Loop() {
    ...
    GetComponent('DBGrid_기준가격').GetRows("", [{key: '토지의표시_일단지구분_Arr', value: 'POT_GU'},]);
...
function MC_배당표_주택임대차보증금_계산() {
    ...
    GetComponent('DBGrid_배당표_주택임대차보증금_계산').GetRow(GetNumber('i'), [{key: '배당표_주택임대차보증금_방의총수', value: 'RESI_RM_CNT'},
    ...
    GetComponent('DBGrid_배당표_주택임대차보증금_계산').SetRow(GetValue('i'), [{
        key: 'REP_BE_SEC_AMT',
        value: GetValue('배당표_주택임대차보증금_최종가임대보증금')
    },
    ...
    GetComponent('DBGrid_배당표_주택임대차보증금_계산').GetRows("", [{key: '배당표_주택임대차보증금_방의총수Arr', value: 'RESI_RM_CNT'},
...
function MC_배당표_배당금_공통() {
    ...
    GetComponent('DBGrid_배당금_계산M').GetRow(GetNumber('i'), [{key: '배당표_배당금계산_순번', value: 'LN_SEQ'},]);
...
function MC_배당표_배당금건물_공통() {
    ...
    GetComponent('DBGrid_배당금건물_계산M').GetRow(GetNumber('i'), [{key: '배당표_배당금계산건물_순번', value: 'REGI_GU'},
...
function MC_배당표_배당금건물_공통_Loop() {
    ...
    SetValue('배당표_배당금계산건물_배당표구분', "3")
    SetValue('배당표_배당금계산건물_배당순위', GetArray('배당표_배당금계산_배당순위_Arr', GetValue('j')))
    SetValue('배당표_배당금계산건물_표시순위', GetArray('배당표_배당금계산_표시순위_Arr', GetValue('j')))
    SetValue('배당표_배당금계산건물_발생일자', GetArray('배당표_배당금계산_발생일자_Arr', GetValue('j')))
    SetValue('배당표_배당금계산건물_당사설정', GetArray('배당표_배당금계산_당사설정_Arr', GetValue('j')))
    SetValue('배당표_배당금계산건물_권리자', GetArray('배당표_배당금계산_권리자_Arr', GetValue('j')))
    SetValue('배당표_배당금계산건물_권리의내용', GetArray('배당표_배당금계산_권리의내용_Arr', GetValue('j')))
    SetValue('배당표_배당금계산건물_말소여부', GetArray('배당표_배당금계산_말소여부_Arr', GetValue('j')))
    SetValue('배당표_배당금계산건물_단독담보', GetArray('배당표_배당금계산_단독담보_Arr', GetValue('j')))
    SetValue('배당표_배당금계산건물_단독담보_ORG', GetArray('배당표_배당금계산_단독담보_ORG_Arr', GetValue('j')))
    SetValue('배당표_배당금계산건물_공동담보', GetArray('배당표_배당금계산_공동담보_Arr', GetValue('j')))
    SetValue('배당표_배당금계산건물_공동담보_ORG', GetArray('배당표_배당금계산_공동담보_ORG_Arr', GetValue('j')))
    SetValue('배당표_배당금계산건물_배당순위_Proc', GetArray('배당표_배당금계산_배당순위_Proc_Arr', GetValue('j')))
...
function MC_공통보고서_조회() {
    ...
    if (GetValue('00_NUMBER') == 2) {
        ...
        GetZoonData('Q_공통보고서_최고최저').GetRow(0, [{key: 'Edit_공통보고서_본사_최저가', value: 'MIN_AMT'},
        ...
        GetZoonData('Q_공통보고서_보정표').GetRow(0, [{key: 'Edit_공통보고서_본사_예상낙찰가율', value: '적용할낙찰가율'},

            {key: 'Edit_공통보고서_본사_예상낙찰가', value: '예상낙찰가'},]);


        GetZoonData('Q_공통보고서_당사설정액').GetRow(0, [{key: 'Edit_공통보고서_본사_당사설정액', value: '채권금액'},]);


        GetZoonData('Q_공통보고서_초과부족설정액').GetRow(0, [{key: 'Edit_공통보고서_본사_초과부족설정분', value: '초과_부족설정액'},]);


        GetZoonData('Q_공통보고서_토지').GetRow(0, [{key: 'Edit_공통보고서_본사_평가가격', value: '최종평가_금액'},]);


        GetZoonData('Q_공통보고서_건물').GetRow(0, [{key: 'Edit_공통보고서_본사_평가가격_건물', value: '최종평가_금액'},]);


        GetZoonData('Q_공통보고서_최고최저JB').GetRow(0, [{key: 'Edit_공통보고서_지점_최저가', value: 'MIN_AMT'},

            {key: 'Edit_공통보고서_지점_최고가', value: 'MAX_AMT'},]);


        GetZoonData('Q_공통보고서_보정표JB').GetRow(0, [{key: 'Edit_공통보고서_지점_예상낙찰가', value: '예상낙찰가'},

            {key: 'Edit_공통보고서_지점_예상낙찰가율', value: '적용할낙찰가율'},]);


        GetZoonData('Q_공통보고서_당사설정액JB').GetRow(0, [{key: 'Edit_공통보고서_지점_당사설정액', value: '채권금액'},]);


        GetZoonData('Q_공통보고서_초과부족설정액JB').GetRow(0, [{key: 'Edit_공통보고서_지점_초과부족설정분', value: '초과_부족설정액'},]);


        GetZoonData('Q_공통보고서_토지JB').GetRow(0, [{key: 'Edit_공통보고서_지점_평가가격', value: '최종평가_금액'},

        ]);


        GetZoonData('Q_공통보고서_건물JB').GetRow(0, [{key: 'Edit_공통보고서_지점_평가가격_건물', value: '최종평가_금액'},]);

    }

    if (GetValue('00_NUMBER') != 2) {

        GetZoonData('Q_공통보고서_최고최저').GetRow(0, [{key: 'Edit_공통보고서_지점_최저가', value: 'MIN_AMT'},

            {key: 'Edit_공통보고서_지점_최고가', value: 'MAX_AMT'},]);


        GetZoonData('Q_공통보고서_보정표').GetRow(0, [{key: 'Edit_공통보고서_지점_예상낙찰가율', value: '적용할낙찰가율'},

            {key: 'Edit_공통보고서_지점_예상낙찰가', value: '예상낙찰가'},]);


        GetZoonData('Q_공통보고서_당사설정액').GetRow(0, [{key: 'Edit_공통보고서_지점_당사설정액', value: '채권금액'},]);


        GetZoonData('Q_공통보고서_초과부족설정액').GetRow(0, [{key: 'Edit_공통보고서_지점_초과부족설정분', value: '초과_부족설정액'},]);


        GetZoonData('Q_공통보고서_토지').GetRow(0, [{key: 'Edit_공통보고서_지점_평가가격', value: '평가가격'},

        ]);


        GetZoonData('Q_공통보고서_건물').GetRow(0, [{key: 'Edit_공통보고서_지점_평가가격_건물', value: '최종평가_금액'},]);
...
function MC_비준가격_경과일() {
    ...
    RunQuery('Q_경과일자', {
        '감정일자': GetValue('감정일자'), '비준가격_시점수정_사례_날짜': GetValue('비준가격_시점수정_사례_날짜')
    }, 'GET');


    GetZoonData('Q_경과일자').GetRow(0, [{key: 'Edit_비준가격_표준지요인_시점수정_날짜_경과일', value: 'ELAP_YYMM'},]);
...
function MC_비준가격_요인합계() {
    ...
    GetComponent('DBGrid_비준가격').SetRow(-1, [{key: 'FACTOR_TOT', value: GetValue('Edit_비준가격_비교치_요인합계')},

        {key: 'APAS_DAN', value: GetValue('Edit_비준가격_비교치_산정단가')},

        {key: 'APPL_DAN', value: GetValue('Edit_비준가격_비교치_적용단가')},], true);
...
function MC_비준가격_항목변경() {
    ...
    SetValue('Edit_비준가격_비교치_기타', GetValue('비준가격_기타_비교치'))
...
function MC_담보제공비율_건물_등기구분() {
    ...
    GetComponent('DBGrid_건물의표시').GetRow(GetNumber('i'), [{key: '건물의표시_등기구분', value: 'REGI_GU'},
...
function MC_담보제공비율_건물_등기구분_AddRow() {
    ...
    GetComponent('DBGrid_건물의표시').GetRows(GetValue('m_index'), [{key: '건물의표시_면적_Arr', value: 'CB_SIZE'},]);
...
function MC_담보제공비율_건물_비율_Loop() {
    ...
    GetComponent('DBGrid_담보제공비율_건물').GetRow(GetNumber('i'), [{key: '담보제공비율_건물_분자', value: 'SEC_NUME'},
    ...
    GetComponent('DBGrid_담보_건물').SetRows(GetValue('m_index'), [{key: 'SEC_NUME', value: GetValue('담보제공비율_건물_분자')},

        {key: 'SEC_DENO', value: GetValue('담보제공비율_건물_분모')},

        {key: 'SEC_RATE', value: GetValue('담보제공비율_건물_비율')},], true);
...
function MC_담보_건물_최종평가가액() {
    ...
    GetComponent('DBGrid_담보_건물').GetRow(GetNumber('i'), [{key: '담보_건물_평가가격', value: 'INC_AMT'},
    ...
    GetComponent('DBGrid_담보_건물').SetRow(GetValue('i'), [{key: 'FNL_INC_AMT', value: GetValue('담보_건물_최종평가가액')},], true);
...
function MC_기준가격_경과일() {
    ...
    GetZoonData('Q_경과일자').GetRow(0, [{key: 'Edit_기준가격_표준지요인_시점수정_날짜_경과일', value: 'ELAP_YYMM'},]);
...
function MC_기준가격_요인합계() {
    ...
    GetComponent('DBGrid_기준가격').SetRow(-1, [{key: 'DEPRE_RATE', value: GetValue('Edit_기준가격_비교치_감가율')},
        ...
        {key: 'APPL_FACTOR_TOT', value: GetValue('Edit_기준가격_비교치_적용요인합계')},], true);

}

function MC_기준가격_집계표_곱() {

    SetValue('기준가격집계표_가로', GetNumber('기준가격_도로접면_비교치') * GetNumber('기준가격_도로거리_비교치'))
    SetValue('기준가격집계표_접근', GetNumber('기준가격_관공서_비교치') * GetNumber('기준가격_중심지역_비교치') * GetNumber('기준가격_기타접근성_비교치'))
    SetValue('기준가격집계표_환경', GetNumber('기준가격_철도_비교치') * GetNumber('기준가격_폐기물_비교치') * GetNumber('기준가격_기타환경_비교치'))
    SetValue('기준가격집계표_행정', GetNumber('기준가격_용도지역_비교치') * GetNumber('기준가격_용도지구_비교치') * GetNumber('기준가격_도시계획_비교치') * GetNumber('기준가격_기타제한_비교치'))
    SetValue('기준가격집계표_획지', GetNumber('기준가격_고저_비교치') * GetNumber('기준가격_형상_비교치') * GetNumber('기준가격_방위_비교치') * GetNumber('기준가격_면적_비교치') * GetNumber('기준가격_토지이용_비교치') * GetNumber('기준가격_기타_비교치'))
    SetValue('기준가격집계표_기타', GetNumber('기준가격_장래_비교치') * GetNumber('기준가격_기타조건_비교치'))
    SetValue('기준가격_요인합계', GetNumber('기준가격_소재지_비교치') * GetNumber('기준가격_시점수정_비교치') * GetNumber('기준가격집계표_가로') * GetNumber('기준가격집계표_접근') * GetNumber('기준가격집계표_환경') * GetNumber('기준가격집계표_행정') * GetNumber('기준가격집계표_획지') * GetNumber('기준가격집계표_기타'))
...
function MC_보정표_예상낙찰가_건물_계산_예상낙찰가() {
    ...
    SetValue('담보_건물_최종평가가액', GetArray('담보_건물_최종평가가액_Arr', GetNumber('i')) * GetNumber('Edit_보정표_적용할낙찰가율'))
    SetValue('배당표_배당금계산_순번', GetArray('배당표_배당금계산_순번_Arr', GetNumber('i')))
    SetValue('담보_건물_최종평가가액', GetNumber('담보_건물_최종평가가액') / 100)
    ...
    GetComponent('DBGrid_배당금건물_계산M').SetRow(GetNumber('00_RowIndex'), [{key: 'FNL_INC_AMT', value: GetNumber('담보_건물_최종평가가액')},], true);
    ...
    GetComponent('DBGrid_감정가액산출내역_건물').SetRow(GetValue('00_RowIndex'), [
        {key: 'FNL_INC_AMT', value: GetNumber('담보_건물_최종평가가액')}
    ], true);
...
function MC_보정표_예상낙찰가_계산() {
    ...
    SetValue('담보_최종평가가액', GetArray('담보_최종평가가액_Arr', GetValue('i')) * GetValue('Edit_보정표_적용할낙찰가율'))
    ...
    SetValue('평가액_평가가액', GetArray('평가액_평가가액_Arr', GetValue('i')))
    ...
    GetComponent('DBGrid_배당금_계산M').SetRow(GetValue('00_RowIndex'), [{key: 'FNL_INC_AMT', value: GetValue('담보_최종평가가액')},
...
function MC_보정표_감정가격산출내역_합계() {
    ...
    SetValue('Edit_보정표_감정가격산출내역_예상낙찰가', GetNumber('Edit_보정표_감정가격산출내역_평가액') * (GetNumber('Edit_보정표_적용할낙찰가율') / 100))
    ...
    SetValue('Edit_보정표_감정가격산출내역_예상낙찰가_건물', GetNumber('Edit_보정표_감정가격산출내역_평가액_건물') * (GetNumber('Edit_보정표_적용할낙찰가율') / 100))

}

function MC_보정표_평가가격() {

    GetComponent('DBGrid_평가액').GetRows("", [{key: '평가액_평가가액_Arr', value: 'INC_AMT'},]);


    GetComponent('DBGrid_건물평가액_집계표').GetRows("", [{key: '건물평가액_집계표_평가가액_Arr', value: 'INC_AMT'},]);
...
function MC_탁상감정_조회() {
    ...
    GetZoonData('Q_탁상감정').GetRow(0, [{key: '탁상감정_내용', value: 'ESTI_OPI'},
    ...
    if (GetValue('isReadOnly') == 'O') {
        ...
        GetComponent('TabControl1').EnableTab(12, 1);
        ...
        GetComponent('TabControl1').SetItemText(11, '');
...
function MC_기준가격_참조값_본건_일괄적용() {
    ...
    GetComponent('DBGrid_본건토지').GetRow(-1, [{key: '본건토지_POT_GU', value: 'POT_GU'},]);


    GetComponent('DBGrid_본건토지').FindIndex('본건토지_I', (row) => {

        if ((row['POT_GU'] == GetValue('본건토지POT_GU'))) {
            return true;
        }
    ...
    GetComponent('DBGrid_본건토지').GetRow(GetNumber('본건토지_I'), [{key: '토지의표시_도로조건', value: 'OF_ROAD_CODE'},
...
function MC_기준가격_참조값_본건_LOOP() {
    ...
    GetComponent('DBGrid_기준가격').SetRow(GetValue('본건토지_INDEX'), [{key: 'JUSO_M', value: GetValue('토지의표시_최소행정구역')},
    ...
    GetComponent('DBGrid_기준가격').GetRow(GetNumber('본건토지_INDEX'), [{key: '기준가격_일단지구분', value: 'POT_GU'},
    ...
    GetComponent('DBGrid_기준가격').SetRow(GetValue('본건토지_INDEX'), [{key: 'DEPRE_RATE', value: GetValue('기준가격_비교치_감가율')},
        ...
        {key: 'APPL_FACTOR_TOT', value: GetValue('기준가격_비교치_적용요인합계')},], true);
...
function MC_비준가격_참조값_본건_LOOP() {
    ...
    GetComponent('DBGrid_비준가격').SetRow(GetValue('본건토지_INDEX'), [{key: 'JUSO_M', value: GetValue('토지의표시_최소행정구역')},
    ...
    GetComponent('DBGrid_비준가격').GetRow(GetNumber('본건토지_INDEX'), [{key: '비준가격_일단지구분', value: 'POT_GU'},
    ...
    GetComponent('DBGrid_비준가격').SetRow(GetValue('본건토지_INDEX'), [{key: 'FACTOR_TOT', value: GetValue('비준가격_비교치_요인합계')},

        {key: 'APAS_DAN', value: GetValue('비준가격_비교치_산정단가')},

        {key: 'APPL_DAN', value: GetValue('비준가격_비교치_적용단가')},], true);
