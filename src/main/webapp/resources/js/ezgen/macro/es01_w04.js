...
function MC_Combo_초기화() {
    ...
    RunQuery('Q_코드_토지의고저', {}, 'GET');


    RunQuery('Q_코드_농지의현황', {}, 'GET');


    RunQuery('Q_코드_토지의고저', {}, 'GET');


    RunQuery('Q_코드_임야의현황', {}, 'GET');


    RunQuery('Q_코드_개발가능성_경사도', {}, 'GET');


    RunQuery('Q_코드_개발가능성_위치', {}, 'GET');


    RunQuery('Q_코드_공유지분소유지현황', {}, 'GET');
...
function MC_Combo_일단지구분_SQL() {
    ...
    } else if (GetValue('i') == 20) {
        SetValue('Combo_일단지구분_SQL21', GetArray('Combo_일단지구분_Arr', GetValue('i')))
    } else if (GetValue('i') == 21) {
        SetValue('Combo_일단지구분_SQL22', GetArray('Combo_일단지구분_Arr', GetValue('i')))
    } else if (GetValue('i') == 22) {
        SetValue('Combo_일단지구분_SQL23', GetArray('Combo_일단지구분_Arr', GetValue('i')))
    } else if (GetValue('i') == 23) {
        SetValue('Combo_일단지구분_SQL24', GetArray('Combo_일단지구분_Arr', GetValue('i')))
    } else if (GetValue('i') == 24) {
        SetValue('Combo_일단지구분_SQL25', GetArray('Combo_일단지구분_Arr', GetValue('i')))
    } else if (GetValue('i') == 25) {
        SetValue('Combo_일단지구분_SQL26', GetArray('Combo_일단지구분_Arr', GetValue('i')))
    } else if (GetValue('i') == 26) {
        SetValue('Combo_일단지구분_SQL27', GetArray('Combo_일단지구분_Arr', GetValue('i')))
    } else if (GetValue('i') == 27) {
        SetValue('Combo_일단지구분_SQL28', GetArray('Combo_일단지구분_Arr', GetValue('i')))
    } else if (GetValue('i') == 28) {
        SetValue('Combo_일단지구분_SQL29', GetArray('Combo_일단지구분_Arr', GetValue('i')))
    } else if (GetValue('i') == 29) {
        SetValue('Combo_일단지구분_SQL30', GetArray('Combo_일단지구분_Arr', GetValue('i')))
    }
...
function MC_배당표_상가임대차보증금_계산() {
    ...
    SetValue('배당표_상가_실제임대차보증금', GetValue('배당표_상가_임대차보증금') + (GetValue('배당표_상가_월세') * 100))
            ...
            if (GetValue('배당표_상가_임대차보증금') > 0) {
                ...
                if (GetValue('배당표_상가_임대차보증금') <= GetValue('배당표_상가_최우선변제보증금')) {
                    ...
                    if (GetValue('배당표_상가_확정일자여부') == "Y") {
                        SetValue('배당표_상가_최우선변제보증금', GetValue('배당표_상가_최우선변제보증금'))
                        SetValue('배당표_상가_임대차보증금_확정', GetValue('배당표_상가_임대차보증금') - GetValue('배당표_상가_최우선변제보증금'))
                        SetValue('배당표_상가_임대차보증금_확정없는', 0)

                    } else {
                        SetValue('배당표_상가_최우선변제보증금', GetValue('배당표_상가_최우선변제보증금'))
                        SetValue('배당표_상가_임대차보증금_확정', 0)
                        SetValue('배당표_상가_임대차보증금_확정없는', GetValue('배당표_상가_임대차보증금') - GetValue('배당표_상가_최우선변제보증금'))
...
function MC_비준가격_집계표() {
    ...
    GetComponent('DBGrid_비준가격집계표').SetRow(GetValue('비준가격_RowPosition'), [
        ...
        {key: 'APPL_DAN', value: GetNumber('비준가격_적용단가')}
    ]);
...
function MC_보정표_예상낙찰가_계산() {
    ...
    GetComponent('DBGrid_배당금_계산M').SetRow(GetNumber('00_RowIndex'), [
...
function MC_저장_배당표건물_배당금D() {
    ...
    RunQuery('Q_배당금_배당금_계산M', {
        '년도': GetValue('년도'),
        '감정순번': GetValue('감정순번')
    }, 'GET');


    RunQuery('Q_배당금_배당금_계산D', {
        '년도': GetValue('년도'),
        '감정순번': GetValue('감정순번')
    }, 'GET');
...
function MC_Combo_사례번호() {
    ...
    RunQuery('Q_사례번호갱신', {
        'Combo_사례번호_Count': GetNumber('Combo_사례번호_Count'),
        'Combo_사례번호_SQL1': GetNumber('Combo_사례번호_SQL1'),
        'Combo_사례번호_SQL2': GetNumber('Combo_사례번호_SQL2'),
        'Combo_사례번호_SQL3': GetNumber('Combo_사례번호_SQL3'),
        'Combo_사례번호_SQL4': GetNumber('Combo_사례번호_SQL4'),
        'Combo_사례번호_SQL5': GetNumber('Combo_사례번호_SQL5'),
        'Combo_사례번호_SQL6': GetNumber('Combo_사례번호_SQL6'),
        'Combo_사례번호_SQL7': GetNumber('Combo_사례번호_SQL7'),
        'Combo_사례번호_SQL8': GetNumber('Combo_사례번호_SQL8'),
        'Combo_사례번호_SQL9': GetNumber('Combo_사례번호_SQL9'),
        'Combo_사례번호_SQL10': GetNumber('Combo_사례번호_SQL10'),
        'Combo_사례번호_SQL11': GetNumber('Combo_사례번호_SQL11')
    }, 'GET');
...
function MC_평가액_참조값() {
    ...
    if (GetValue('기타요인_RowPosition') >= 0) {
        ...
        GetComponent('DBGrid_담보제공비율').GetRow(GetNumber('i'), [
            {key: '토지의표시_면적', value: 'SEC_REGI_SIZE'}
        ]);


        SetValue('비준가격_산정단가', GetNumber('기타요인_표준지공시지가') * Round(GetNumber('기타요인_적용보정률'), 2))
        SetValue('비준가격_적용단가', Round(GetNumber('비준가격_산정단가') / 10, 0) * 10)
        SetValue('평가액_평가가액', GetNumber('비준가격_적용단가') * GetNumber('토지의표시_면적'))
...
function MC_기타요인_산정보정률() {
    ...
    GetComponent('DBGrid_기타요인').SetRow(GetNumber('기타요인_RowPosition'), [
...
function MC_담보제공비율_비율() {
    ...
    SetValue('담보제공비율_비율', GetNumber('담보제공비율_분자') / GetNumber('담보제공비율_분모') * 100)
    SetValue('담보제공비율_담보제공면적', GetNumber('담보제공비율_전체면적') * (GetNumber('담보제공비율_비율') / 100))
    SetValue('담보제공비율_최종평가가액', GetNumber('평가액_평가가액') * (GetNumber('담보제공비율_비율') / 100))
...
function MC_저장_입력표() {
    ...
    GetComponent('DBGrid_담보').GetRows("", [
        {key: '담보제공비율_최종평가가액_Arr', value: 'FNL_INC_AMT'}
    ]);


    SetValue('담보제공비율_최종평가가액', Sum('담보제공비율_최종평가가액_Arr'));
    ...
    RunQuery('저장_담보마스터', {
        ...
        'CURR_AMT': 0,
        'PLMIN_BID_AMT': GetValue('담보제공비율_최종평가가액'),
...
function MC_저장_ValidationCheck() {
    ...
    GetComponent('DBGrid_토지의표시').GetRowCount('저장_담보제공비율_RowCount');
    ...
    GetComponent('DBGrid_담보제공비율').GetRowCount('저장_담보제공비율_RowCount');
    ...
    GetComponent('DBGrid_본건토지').GetRowCount('저장_본건토지_RowCount');
    ...
    GetComponent('DBGrid_표준지공시지가').GetRowCount('저장_표준지공시지가_RowCount');
    ...
    GetComponent('DBGrid_비준가격_산정사례').GetRowCount('저장_비준가격산정사례_RowCount');
    ...
    GetComponent('DBGrid_기준가격').GetRowCount('저장_기준가격_RowCount');
    ...
    GetComponent('DBGrid_비준가격').GetRowCount('저장_비준가격_RowCount');
    ...
    GetComponent('DBGrid_기타요인').GetRowCount('저장_기타요인_RowCount');
...
if (isEmpty(GetValue('Combo_보정표_공유지분')   )) {
	SetValue('저장_Error_Message', "낙찰가율보정표_공유지분소유자현황을 선택하여 주십시오." )
}

if (isEmpty(GetValue('Combo_보정표_위치')   )) {
	SetValue('저장_Error_Message', "낙찰가율보정표_임야_개발가능성(위치)를 선택하여 주십시오." )
}

if (isEmpty(GetValue('Combo_보정표_경사도')   )) {
	SetValue('저장_Error_Message', "낙찰가율보정표_임야_개발가능성(경사도) 선택하여 주십시오." )
}

if (isEmpty(GetValue('Combo_보정표_임야현황')   )) {
	SetValue('저장_Error_Message', "낙찰가율보정표_임야_임야의현황을 선택하여 주십시오." )
}

if (isEmpty(GetValue('Combo_보정표_토지고저')   )) {
	SetValue('저장_Error_Message', "낙찰가율보정표_농지_토지의고저를 선택하여 주십시오." )
}

if (isEmpty(GetValue('Combo_보정표_농지현황')   )) {
	SetValue('저장_Error_Message', "낙찰가율보정표_농지_농지의현황을 선택하여 주십시오." )
}

if (isEmpty(GetValue('Combo_보정표_고저')   )) {
	SetValue('저장_Error_Message', "낙찰가율보정표_주거,상업,공업지역_토지의고저를 선택하여 주십시오." )
}

if (isEmpty(GetValue('Combo_보정표_입지조건')   )) {
	SetValue('저장_Error_Message', "낙찰가율보정표_주거,상업,공업지역_담보물입지조건을 선택하여 주십시오." )
}

if (isEmpty(GetValue('Combo_보정표_토지형상')   )) {
	SetValue('저장_Error_Message', "낙찰가율보정표_주거,상업,공업지역_토지의형상을 선택하여 주십시오." )
}

if (isEmpty(GetValue('Combo_보정표_접한도로폭')   )) {
	SetValue('저장_Error_Message', "낙찰가율보정표_주거,상업,공업지역_접한도로의폭을 선택하여 주십시오." )
}
...
function MC_저장_ValidationCheck_배당표_상가임차보증금() {
    ...
    if (isEmpty(GetArray('저장_배당표_상가_상호성명', GetValue('i')))) {
...
function MC_탭_상태변경() {
    ...
    GetComponent('TabControl1').EnableTab(9, 0);
...
function MC_저장_ValidationCheck_기준가격() {
    ...
    if (isEmpty(GetArray('저장_기준가격_일단지구분', GetValue('i')))) {
        SetValue('저장_Error_Message', "표준지공시지가기준가격집계표_일단지구분을 선택하여 주십시오.")

    }


    if (isEmpty(GetArray('저장_기준가격_표준지구분', GetValue('i')))) {
        SetValue('저장_Error_Message', "표준지공시지가기준가격집계표_표준지구분을 선택하여 주십시오.")
...
function MC_저장_보정표() {
    ...
    RunQuery('저장_보정표', {
        ...
        'BARE_ADJ_ROAD': GetValue('Combo_보정표_접한도로폭'),
        'BARE_SHAPE_CODE': GetValue('Combo_보정표_토지형상'),
        'BARE_CONV_LOCATED': GetValue('Combo_보정표_입지조건'),
        'BARE_UNDUR_CODE': GetValue('Combo_보정표_고저'),
        'FARM_CURR_CODE': GetValue('Combo_보정표_농지현황'),
        'FARM_UNDUR_CODE': GetValue('Combo_보정표_토지고저'),
        'WOOD_CURR_CODE': GetValue('Combo_보정표_임야현황'),
        'WOOD_GRAD_CODE': GetValue('Combo_보정표_경사도'),
        'WOOD_LOC_CODE': GetValue('Combo_보정표_위치'),
        'PUBL_CODE': GetValue('Combo_보정표_공유지분'),
        'PUBL_RATE': GetValue('Edit_보정표_공유지분_적용률'),
        'BARE_ADJ_RATE': GetValue('Edit_보정표_접한도로폭_적용율'),
        'BARE_SHAPE_RATE': GetValue('Edit_보정표_토지형상_적용률'),
        'BARE_CONV_RATE': GetValue('Edit_보정표_입지조건_적용률'),
        'BARE_UNDUR_RATE': GetValue('Edit_보정표_고저_적용율'),
        'FARM_CURR_RATE': GetValue('Edit_보정표_농지현황_적용률'),
        'FARM_UNDUR_RATE': GetValue('Edit_보정표_토지의고저_적용률'),
        'WOOD_CURR_RATE': GetValue('Edit_보정표_임야현황_적용률'),
        'WOOD_GRAD_RATE': GetValue('Edit_보정표_개발경사도_적용률'),
        'WOOD_LOC_RATE': GetValue('Edit_보정표_위치_적용률'),
        'DOMAIN_RATE': GetValue('Edit_보정표_법정지상권_적용률'),
    }, 'POST');

}

function MC_토지배당금계산건물_SYNC() {
...
function MC_보정표_예상낙찰가() {
    ...
    SetValue('Edit_보정표_적용할낙찰가율', GetNumber('Edit_보정표_기준낙찰가율') * GetNumber('Edit_보정표_접한도로폭_적용율') * GetNumber('Edit_보정표_토지형상_적용률') * GetNumber('Edit_보정표_입지조건_적용률') * GetNumber('Edit_보정표_토지의고저_적용률') * GetNumber('Edit_보정표_농지현황_적용률') * GetNumber('Edit_보정표_고저_적용율') * GetNumber('Edit_보정표_임야현황_적용률') * GetNumber('Edit_보정표_개발경사도_적용률') * GetNumber('Edit_보정표_위치_적용률') * GetNumber('Edit_보정표_공유지분_적용률') * GetNumber('Edit_보정표_법정지상권_적용률'))
    ...
    SetValue('Edit_보정표_예상낙찰가', GetNumber('보정표_예상낙찰가') / 100)
    SetValue('Edit_배당표_총예상낙찰가', GetNumber('보정표_예상낙찰가') / 100)
...
function MC_Combo_보정표_기본값셋팅() {
    ...
    GetComponent('Combo_보정표_경사도').SetCurSel(0.0);


    GetComponent('Combo_보정표_고저').SetCurSel(0.0);


    GetComponent('Combo_보정표_공유지분').SetCurSel(0.0);


    GetComponent('Combo_보정표_농지현황').SetCurSel(0.0);


    GetComponent('Combo_보정표_법정지상권').SetCurSel(0.0);


    GetComponent('Combo_보정표_위치').SetCurSel(0.0);


    GetComponent('Combo_보정표_임야현황').SetCurSel(0.0);


    GetComponent('Combo_보정표_입지조건').SetCurSel(0.0);


    GetComponent('Combo_보정표_장래의이용').SetCurSel(-1.0);


    GetComponent('Combo_보정표_접한도로폭').SetCurSel(0.0);


    GetComponent('Combo_보정표_토지고저').SetCurSel(0.0);


    GetComponent('Combo_보정표_토지형상').SetCurSel(0.0);


    GetComponent('Combo_보정표_현재의주된').SetCurSel(-1.0);


    SetValue('Edit_보정표_개발경사도_적용률', 1);

    SetValue('Edit_보정표_고저_적용율', 1);

    SetValue('Edit_보정표_공유지분_적용률', 1);

    SetValue('Edit_보정표_기준낙찰가율', 100);

    SetValue('Edit_보정표_농지현황_적용률', 1);
    ...
    SetValue('Edit_보정표_위치_적용률', 1);

    SetValue('Edit_보정표_유사부동산낙찰가율', 100);

    SetValue('Edit_보정표_임야현황_적용률', 1);

    SetValue('Edit_보정표_입지조건_적용률', 1);

    SetValue('Edit_보정표_적용할낙찰가율', 100);

    SetValue('Edit_보정표_접한도로폭_적용율', 1);

    SetValue('Edit_보정표_토지의고저_적용률', 1);

    SetValue('Edit_보정표_토지형상_적용률', 1);
...
function MC_배당표_배당금_계산_기초데이터() {
    ...
    GetZoonData('Q_배당표_배당금_계산D_Temp').GetRows("", [
        ...
        {key: '배당표_배당금계산TMP_당사설정', value: 'HITE_YN'}
    ]);
...
function MC_공통보고서_조회() {
    ...
    RunQuery('Q_공통보고서_예상1차입찰가', {
        '년도': GetValue('년도'),
        '감정순번': GetValue('감정순번'),
    }, 'GET');


    if (GetValue('00_요청부서') == '1000827') { //관재파트에서 감정서를 작성하는 경우 지점처럼 작동하게..
        SetValue('00_NUMBER', 1)
    } else {
    ...
    if (GetValue('00_NUMBER') == 2) {
        ...
        GetZoonData('Q_공통보고서_보정표').GetRow(0, [
            ...
            {key: 'Edit_공통보고서_본사_예상낙찰가', value: '예상낙찰가_금액'}
        ]);
        ...
        GetZoonData('Q_공통보고서_보정표JB').GetRow(0, [
            ...
            {key: 'Edit_공통보고서_지점_예상낙찰가', value: '예상낙찰가_금액'}
        ]);
        ...
        GetZoonData('Q_공통보고서_예상1차입찰가').GetRow(0, [
            {key: 'Edit_공통보고서_지점_평가가격', value: '예상1차입찰가_지점'},
            {key: 'Edit_공통보고서_본사_평가가격', value: '예상1차입찰가_본사'}
        ]);
    ...
    if (GetValue('00_NUMBER') != 2) {
        ...
        GetZoonData('Q_공통보고서_예상1차입찰가').GetRow(0, [
            {key: 'Edit_공통보고서_지점_평가가격', value: '예상1차입찰가_본사'}
        ]);
...
function MC_비준가격_요인합계() {
    ...
    SetValue('Edit_비준가격_비교치_적용단가', GetValue('Edit_비준가격_비교치_산정단가'));
    // SetValue('Edit_비준가격_비교치_적용단가', Round((GetValue('Edit_비준가격_비교치_산정단가') / 10), 0))
    // SetValue('Edit_비준가격_비교치_적용단가', GetValue('Edit_비준가격_비교치_적용단가') * 10)
...
function MC_기준가격_요인합계() {
    ...
    SetValue('Edit_기준가격_비교치_적용단가', Round((GetValue('Edit_기준가격_비교치_산정단가') / 10), 0))
    SetValue('Edit_기준가격_비교치_적용단가', GetValue('Edit_기준가격_비교치_적용단가') * 10)
...
function MC_보정표_평가가격() {
    ...
    SetValue('Edit_보정표_평가가격', Sum('평가액_평가가액_Arr'))
    SetValue('Edit_보정표_제1차예상최저입찰가', Sum('담보_최종평가가액_Arr'))
