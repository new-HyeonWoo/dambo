...
const pageZoon = {
    ...
    OnInitialize : function() {
        ...
        const Combo_비준_층별_본건 = new Combo('Combo_비준_층별_본건', Q_00_전유부분의위치,{
            isShow : true,
            isEnable : false,
            format : {
                text : 'CD_DESC',
        ...
        const Q_00_전유부분의위치_총층수중해당층 = new FunctionZoonData('Q_00_전유부분의위치_총층수중해당층', () => {
            return RunAndReturnQuery('Q_00_전유부분의위치_총층수중해당층', {
                '총층수': GetValue('Combo_입력표_총층수')
            });
        });
        const Combo_입력표_해당층 = new ReactiveCombo('Combo_입력표_해당층', ['Combo_입력표_총층수'], Q_00_전유부분의위치_총층수중해당층,{
            isShow : true,
            isEnable : true,
            format : {
                text : 'CD_DESC',
            ...
            .on({
                ...
                dblclick: function() {
                    ...
                    SetValue('URL', "/view/es01/w02/p00?" +
                        "yyyy=" + GetValue('년도')
                        + "&seq=" + GetValue('감정순번')
                        + "&repo_div=" + GetValue('TreeView1_공통보고서_감정의견')
