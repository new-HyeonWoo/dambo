    ...
    OnInitialize: function () {
        ...
        const Command_배당처리 = new Picture('Command_배당처리', new JsonZoonData('Command_배당처리', {}), {
            ...
            if (GetValue('Edit_배당표_총예상낙찰가') == 0) {
                MsgBox("총 예상낙찰가가 ZEROS(0)인 자료는 GetValue('배당처리')를 할 수 없습니다.", '[자료확인]', true);
                return false;
            }
            ...
            if (GetValue('저장_Error_Message') != 'Y') {
                MsgBox("배당처리가 정상적으로 진행되지 않았습니다." + Hex(10) + "권리자의 내용을 초기화합니다." + Hex(10) + "권리관계를 다시 입력하십시요.", '[배당처리 확인 필요]', false);
            }
        ...
        const Picture64 = new Picture('Picture64', new JsonZoonData('Picture64', {}), {
            ...
            if (GetValue('i') == 1) {
                MsgBox("완료된 탁상감정 내용이 존재합니다." + Hex(10) + "요청하실 경우 기존 자료는 삭제됩니다." + Hex(10) + "탁상감정을 요청하시겠습니까?", '', false);
            }


            if (isEmpty(GetValue('i'))) {
                MsgBox("탁상감정을 의뢰하시겠습니까?" + Hex(10) + "탁상감정된 내용은 GetValue('탁상감정현황')에서 확인하실 수 있습니다.", '', false);
            }
...
//                 <br>"+GetValue('탁상감정_파일명')+" 본건의 탁상감정을 의뢰합니다.
//             <br><a href==http://203.234.236.9:8080/jsp/es00/es00_w03.jsp?yyyy=="+GetValue('년도')+"&seq=="+GetValue('감정순번')+"&sec_code=="+GetValue('Combo_집합건물종류')+"&conExt==Y target==_blank>감정내용보기</a>
//             <br> 하이트맥주  "+GetValue('탁상감정_성명'))


            if (GetValue('i') == 2) {
                MsgBox("진행 중인 탁상감정이 있습니다." + Hex(10) + "재전송하시겠습니까?", '', false);
            }
        ...
        const Picture92 = new Picture('Picture92', new JsonZoonData('Picture92', {}), {
            isShow: GetValue('01_배당자료수정가능여부') == 'Y' || GetValue('_사원번호') == '106790',
            isEnable: true
        }).on('OnClick', function () {
            _배당집계표수정();
        ...
        let SubForm_감정요청자료_영업_URL = '/view/es01/w04/appraisal';
        ...
        let SubForm_거래처조회_URL = '/view/es01/w04/account';
        ...
        const DBGrid_주소 = new DBGrid('DBGrid_주소', new JsonZoonData('DBGrid_주소', {}), {
            isShow: true,
            isEnable: true
        ...
        const Command_도로주소_조회 = new Picture('Command_도로주소_조회', new JsonZoonData('Command_도로주소_조회', {}), {
            ...
            if (isNotEmpty(GetValue('TEMP_MSG'))) {
                MsgBox(GetValue('TEMP_MSG'), '확인', false);
            }


            RunQuery('Q_도로명주소목록', {
                'CITY': GetValue('CITY'),
                'CITYGU': GetValue('CITYGU'),
                'ROAD_NM': GetValue('ROAD_NM')
            }, 'GET');
        });
        ...
        const Picture90 = new Picture('Picture90', new JsonZoonData('Picture90', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Table48 = new Edit('Table48', new JsonZoonData('Table48', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Label93 = new Label('Label93', new JsonZoonData('Label93', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Command_응찰_01_쿼리 = new Command('Command_응찰_01_쿼리', new JsonZoonData('Command_응찰_01_쿼리', {}), {
            ...
            GetZoonData('Q_42_응찰입력표_전감정의개요').GetRow(0, [
                {key: '응찰_개요_지점_감정일', value: '지점_감정일'},
            ...
            RunQuery('Q_43_응찰입력표_선순위권리내역', {}, 'GET');


            RunQuery('Q_44_응찰입력표_선순위부담금액', {}, 'GET');
        ...
        const Command_응찰_11_내용 = new Command('Command_응찰_11_내용', new JsonZoonData('Command_응찰_11_내용', {}), {
            ...
            SetValue('응찰_내용_입찰예정가_금액', Round(Round(GetValue('응찰_내용_법원감정가합계') * (GetValue('Edit_보정표_적용할낙찰가율') / 100), 0) / 1000, 0) * 1000);
            ...
            SetValue('응찰_내용_토지_단가_평당', Round(Round(GetValue('응찰_내용_토지_금액') / (GetValue('Edit_토지의표시_합계_면적') * 0.3025), 0) / 1000, 0) * 1000);
...
// 402:(토건)상업용
// 501:토지
                Round((GetNumber('응찰_내용_입찰예정가_금액') * (StrToNum(GetValue('응찰_수지_취득_취득세_Combo')) / 100)) / 1000, 0) * 1000);
...
// 402:(토건)상업용
// 501:토지
                Round((GetNumber('응찰_내용_입찰예정가_금액') * (StrToNum(GetValue('응찰_수지_취득_등록세_Combo')) / 100)) / 1000, 0) * 1000);
        ...
        const Command_응찰_15_보유수익 = new Command('Command_응찰_15_보유수익', new JsonZoonData('Command_응찰_15_보유수익', {}), {
            ...
            SetValue('응찰_수지_보유수익_합계', GetValue('응찰_수지_보유수익_임대수익')
                + GetValue('응찰_수지_보유수익_기타수익'));
        ...
        const Command_응찰_17_처분비용 = new Command('Command_응찰_17_처분비용', new JsonZoonData('Command_응찰_17_처분비용', {}), {
            ...
            SetValue('응찰_수지_처분_합계', GetValue('응찰_수지_처분_비용')
                + GetValue('응찰_수지_처분_기타비용'));
        ...
        const Command_응찰_91_저장 = new Command('Command_응찰_91_저장', new JsonZoonData('Command_응찰_91_저장', {}), {
            ...
            RunQuery('저장_42_응찰_전감정개요', {}, 'POST');


            GetComponent('DBGrid_응찰_기일내역').GetModifyData([
                {key: 'YYYY', value: '년도', isDelRowInclude: true},

                {key: 'SEQ', value: '감정순번', isDelRowInclude: true},

                {key: 'JUM_ESTI_DATE', value: '응찰_개요_지점_감정일', isDelRowInclude: true},

                {key: 'JUM_SABUN1', value: '응찰_개요_지점_담당자', isDelRowInclude: true},

                {key: 'JUM_SABUN2', value: '응찰_개요_지점_파트장', isDelRowInclude: true},

                {key: 'JUM_SABUN3', value: '응찰_개요_지점_팀장', isDelRowInclude: true},

                {key: 'JUM_SABUN4', value: '응찰_개요_지점_지점장', isDelRowInclude: true},

                {key: 'JUM_PL_MIN_BID_AMT', value: '응찰_개요_지점_제1차예상낙찰가', isDelRowInclude: true},

                {key: 'JUM_PL_BID_AMT', value: '응찰_개요_지점_예상낙찰가', isDelRowInclude: true},

                {key: 'JUM_PL_BID_RATE', value: '응찰_개요_지점_예상낙찰가율', isDelRowInclude: true},

                {key: 'JUM_SEC_AMT', value: '응찰_개요_지점_담보여력', isDelRowInclude: true},

                {key: 'JUM_COMP_AMT', value: '응찰_개요_지점_당사채권금액', isDelRowInclude: true},

                {key: 'JUM_COMP_RIGHT', value: '응찰_개요_지점_당사순위및등기', isDelRowInclude: true},

                {key: 'ESTI_DATE', value: '응찰_개요_본사_감정일', isDelRowInclude: true},

                {key: 'SABUN1', value: '응찰_개요_본사_1차결재', isDelRowInclude: true},

                {key: 'SABUN2', value: '응찰_개요_본사_2차결재', isDelRowInclude: true},

                {key: 'SABUN3', value: '응찰_개요_본사_3차결재', isDelRowInclude: true},

                {key: 'SABUN4', value: '응찰_개요_본사_관재파트장', isDelRowInclude: true},

                {key: 'SABUN5', value: '응찰_개요_본사_팀장', isDelRowInclude: true},

                {key: 'PL_MIN_BID_AMT', value: '응찰_개요_본사_제1차예상낙찰가', isDelRowInclude: true},

                {key: 'PL_BID_AMT', value: '응찰_개요_본사_예상낙찰가', isDelRowInclude: true},

                {key: 'PL_BID_RATE', value: '응찰_개요_본사_예상낙찰가율', isDelRowInclude: true},

                {key: 'SEC_AMT', value: '응찰_개요_본사_담보여력', isDelRowInclude: true},

                {key: 'COMP_AMT', value: '응찰_개요_본사_당사채권금액', isDelRowInclude: true},

                {key: 'COMP_RIGHT', value: '응찰_개요_본사_당사순위및등기', isDelRowInclude: true},
            ]);
        ...
        const Edit_본건인근지역_임야_최저가_평 = new MaskEdit('Edit_본건인근지역_임야_최저가_평', new JsonZoonData('Edit_본건인근지역_임야_최저가_평', {}), {
            isShow: true,
            isEnable: true,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_본건인근지역_임야_최고가_평 = new MaskEdit('Edit_본건인근지역_임야_최고가_평', new JsonZoonData('Edit_본건인근지역_임야_최고가_평', {}), {
            isShow: true,
            isEnable: true,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Picture23 = new Picture('Picture23', new JsonZoonData('Picture23', {}), {
            ...
            GetComponent('DBGrid_표준지공시지가').GetRows("", [
                {key: '표준지공시지가_표준지구분_Arr', value: 'S_GU'}
            ]);
        ...
        const Combo_기준가격_본건요인_관공서접근성 = new Combo('Combo_기준가격_본건요인_관공서접근성', new JsonZoonData('Q_코드_관공서접근성', {}), {
            ...
            GetZoonData('Q_코드_관공서접근성').FindIndex('00_RowIndex', (row) => {
                ...
                if ((row['CD_CODE'] == GetValue('Combo_기준가격_표준지요인_관공서접근성'))) {
                    return true;
                }
        ...
        const Edit_기준가격_본건요인_시점수정_날짜 = new MaskEdit('Edit_기준가격_본건요인_시점수정_날짜', new JsonZoonData('Edit_기준가격_본건요인_시점수정_날짜', {}), {
            isShow: true,
            isEnable: false,
            mask: 'yyyy-mm-dd',
            maskType: '날짜',
        ...
        const Edit_기준가격_표준지요인_시점수정_날짜 = new MaskEdit('Edit_기준가격_표준지요인_시점수정_날짜', new JsonZoonData('Edit_기준가격_표준지요인_시점수정_날짜', {}), {
            isShow: true,
            isEnable: true,
            mask: 'yyyy-mm-dd',
            maskType: '날짜',
        ...
        const 기준_Label_시점_본건_경과일 = new Label('기준_Label_시점_본건_경과일', new JsonZoonData('기준_Label_시점_본건_경과일', {}), {
            isShow: true,
            isEnable: false
        })
        const Edit_기준가격_표준지요인_시점수정_날짜_경과일 = new Label('Edit_기준가격_표준지요인_시점수정_날짜_경과일', new JsonZoonData('Edit_기준가격_표준지요인_시점수정_날짜_경과일', {}), {
            isShow: true,
            isEnable: false
        })
        ...
        const Edit_비준가격_비교치_기타환경조건 = new MaskEdit('Edit_비준가격_비교치_기타환경조건', new JsonZoonData('Edit_비준가격_비교치_기타환경조건', {}), {
            isShow: true,
            isEnable: true,
            mask: ';7;#,###1.00',
            maskType: '숫자',
        ...
        const Label18 = new Edit('Label18', new JsonZoonData('Label18', {}), {
            isShow: true,
            isEnable: false
        })
        const Edit_비준가격_표준지요인_가격사례 = new MaskEdit('Edit_비준가격_표준지요인_가격사례', new JsonZoonData('Edit_비준가격_표준지요인_가격사례', {}), {
            isShow: true,
            isEnable: false,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_비준가격_표준지요인_시점수정_날짜 = new MaskEdit('Edit_비준가격_표준지요인_시점수정_날짜', new JsonZoonData('Edit_비준가격_표준지요인_시점수정_날짜', {}), {
            isShow: true,
            isEnable: true,
            mask: 'yyyy-mm-dd',
            maskType: '날짜',
        ...
        const Edit_비준가격_표준지요인_시점수정_날짜_경과일 = new Label('Edit_비준가격_표준지요인_시점수정_날짜_경과일', new JsonZoonData('Edit_비준가격_표준지요인_시점수정_날짜_경과일', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const 감정가액산출Ⅳ = new Edit('감정가액산출Ⅳ', new JsonZoonData('감정가액산출Ⅳ', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Edit_보정표_접한도로폭_적용율 = new MaskEdit('Edit_보정표_접한도로폭_적용율', new JsonZoonData('Edit_보정표_접한도로폭_적용율', {}), {
            isShow: true,
            isEnable: false,
            mask: '-;1;#,###1.00',
            maskType: '숫자',
        ...
        const Edit_보정표_토지형상_적용률 = new MaskEdit('Edit_보정표_토지형상_적용률', new JsonZoonData('Edit_보정표_토지형상_적용률', {}), {
            isShow: true,
            isEnable: false,
            mask: ';1;#,###1.00',
            maskType: '숫자',
        ...
        const Edit_보정표_입지조건_적용률 = new MaskEdit('Edit_보정표_입지조건_적용률', new JsonZoonData('Edit_보정표_입지조건_적용률', {}), {
            isShow: true,
            isEnable: false,
            mask: ';1;#,###1.00',
            maskType: '숫자',
        ...
        const Edit_보정표_고저_적용율 = new MaskEdit('Edit_보정표_고저_적용율', new JsonZoonData('Edit_보정표_고저_적용율', {}), {
            isShow: true,
            isEnable: false,
            mask: ';1;#,###1.00',
            maskType: '숫자',
        ...
        const Edit_보정표_농지현황_적용률 = new MaskEdit('Edit_보정표_농지현황_적용률', new JsonZoonData('Edit_보정표_농지현황_적용률', {}), {
            isShow: true,
            isEnable: false,
            mask: '-;1;#,###1.00',
            maskType: '숫자',
        ...
        const Edit_보정표_토지의고저_적용률 = new MaskEdit('Edit_보정표_토지의고저_적용률', new JsonZoonData('Edit_보정표_토지의고저_적용률', {}), {
            isShow: true,
            isEnable: false,
            mask: '-;1;#,###1.00',
            maskType: '숫자',
        ...
        const Edit_보정표_임야현황_적용률 = new MaskEdit('Edit_보정표_임야현황_적용률', new JsonZoonData('Edit_보정표_임야현황_적용률', {}), {
            isShow: true,
            isEnable: false,
            mask: '-;1;#,###1.00',
            maskType: '숫자',
        ...
        const Edit_보정표_개발경사도_적용률 = new MaskEdit('Edit_보정표_개발경사도_적용률', new JsonZoonData('Edit_보정표_개발경사도_적용률', {}), {
            isShow: true,
            isEnable: false,
            mask: '-;1;#,###1.00',
            maskType: '숫자',
        ...
        const Edit_보정표_위치_적용률 = new MaskEdit('Edit_보정표_위치_적용률', new JsonZoonData('Edit_보정표_위치_적용률', {}), {
            isShow: true,
            isEnable: false,
            mask: '-;1;#,###1.00',
            maskType: '숫자',
        ...
        const Combo_보정표_현재의주된 = new Combo('Combo_보정표_현재의주된', new JsonZoonData('Q_코드_이용현황', {}), {
            ...
            // GetZoonData('Q_점유자의형태').FindIndex('_관리부서', (row) => {
            //
            //     if ((row['기본_년도'] == GetValue('_관리부서'))) {
            //         return true;
            //     }
            //
            //     return false;
        ...
        const Combo_보정표_접한도로폭 = new Combo('Combo_보정표_접한도로폭', new JsonZoonData('Q_코드_접한도로의폭', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
            ...
            GetZoonData('Q_코드_접한도로의폭').FindIndex('콤보_IDX', (row) => {
                ...
                if ((row['CD_CODE'] == GetValue('Combo_보정표_접한도로폭'))) {
                    return true;
                }
            ...
            GetZoonData('Q_코드_접한도로의폭').GetRow(GetValue('콤보_IDX'), [
                {key: 'Edit_보정표_접한도로폭_적용율', value: 'ATTR_08'}
            ]);
        ...
        const Combo_보정표_토지형상 = new Combo('Combo_보정표_토지형상', new JsonZoonData('Q_코드_토지의형상', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
            ...
            GetZoonData('Q_코드_토지의형상').FindIndex('콤보_IDX', (row) => {
                ...
                if ((row['CD_CODE'] == GetValue('Combo_보정표_토지형상'))) {
                    return true;
                }
            ...
            GetZoonData('Q_코드_토지의형상').GetRow(GetValue('콤보_IDX'), [
                {key: 'Edit_보정표_토지형상_적용률', value: 'ATTR_08'}
            ]);
        ...
        const Combo_보정표_입지조건 = new Combo('Combo_보정표_입지조건', new JsonZoonData('Q_코드_담보물의입지조건', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
            ...
            GetZoonData('Q_코드_담보물의입지조건').FindIndex('콤보_IDX', (row) => {
                ...
                if ((row['CD_CODE'] == GetValue('Combo_보정표_입지조건'))) {
                    return true;
                }
            ...
            GetZoonData('Q_코드_담보물의입지조건').GetRow(GetValue('콤보_IDX'), [
                {key: 'Edit_보정표_입지조건_적용률', value: 'ATTR_08'}
            ]);
        ...
        const Combo_보정표_고저 = new Combo('Combo_보정표_고저', new JsonZoonData('Q_코드_토지의고저', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
            ...
            GetZoonData('Q_코드_토지의고저').FindIndex('콤보_IDX', (row) => {

                if ((row['CD_CODE'] == GetValue('Combo_보정표_고저'))) {
                    return true;
                }
            ...
            GetZoonData('Q_코드_토지의고저').GetRow(GetValue('콤보_IDX'), [
                {key: 'Edit_보정표_고저_적용율', value: 'ATTR_08'}
            ]);
        ...
        const Combo_보정표_농지현황 = new Combo('Combo_보정표_농지현황', new JsonZoonData('Q_코드_농지의현황', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
            ...
            GetZoonData('Q_코드_농지의현황').FindIndex('콤보_IDX', (row) => {

                if ((row['CD_CODE'] == GetValue('Combo_보정표_농지현황'))) {
                    return true;
                }
            ...
            GetZoonData('Q_코드_농지의현황').GetRow(GetValue('콤보_IDX'), [
                {key: 'Edit_보정표_농지현황_적용률', value: 'ATTR_08'}
            ]);
        ...
        const Combo_보정표_토지고저 = new Combo('Combo_보정표_토지고저', new JsonZoonData('Q_코드_토지의고저', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
            ...
            GetZoonData('Q_코드_토지의고저').FindIndex('콤보_IDX', (row) => {
                ...
                if ((row['CD_CODE'] == GetValue('Combo_보정표_토지고저'))) {
                    return true;
                }
            ...
            GetZoonData('Q_코드_토지의고저').GetRow(GetValue('콤보_IDX'), [
                {key: 'Edit_보정표_토지의고저_적용률', value: 'ATTR_08'}
            ]);
        ...
        const Combo_보정표_임야현황 = new Combo('Combo_보정표_임야현황', new JsonZoonData('Q_코드_임야의현황', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
            ...
            GetZoonData('Q_코드_임야의현황').FindIndex('콤보_IDX', (row) => {

                if ((row['CD_CODE'] == GetValue('Combo_보정표_임야현황'))) {
                    return true;
                }
            ...
            GetZoonData('Q_코드_임야의현황').GetRow(GetValue('콤보_IDX'), [
                {key: 'Edit_보정표_임야현황_적용률', value: 'ATTR_08'}
            ]);
        ...
        const Combo_보정표_경사도 = new Combo('Combo_보정표_경사도', new JsonZoonData('Q_코드_개발가능성_경사도', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
            ...
            GetZoonData('Q_코드_개발가능성_경사도').FindIndex('콤보_IDX', (row) => {

                if ((row['CD_CODE'] == GetValue('Combo_보정표_경사도'))) {
                    return true;
                }
            ...
            GetZoonData('Q_코드_개발가능성_경사도').GetRow(GetValue('콤보_IDX'), [
                {key: 'Edit_보정표_개발경사도_적용률', value: 'ATTR_08'}
            ]);
        ...
        const Combo_보정표_위치 = new Combo('Combo_보정표_위치', new JsonZoonData('Q_코드_개발가능성_위치', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
            ...
            GetZoonData('Q_코드_개발가능성_위치').FindIndex('콤보_IDX', (row) => {

                if ((row['CD_CODE'] == GetValue('Combo_보정표_위치'))) {
                    return true;
                }
            ...
            GetZoonData('Q_코드_개발가능성_위치').GetRow(GetValue('콤보_IDX'), [
                {key: 'Edit_보정표_위치_적용률', value: 'ATTR_08'}
            ]);
        ...
        const Combo_보정표_공유지분 = new Combo('Combo_보정표_공유지분', new JsonZoonData('Q_코드_공유지분소유지현황', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
            ...
            GetZoonData('Q_코드_공유지분소유지현황').FindIndex('콤보_IDX', (row) => {
            ...
            GetZoonData('Q_코드_공유지분소유지현황').GetRow(GetValue('콤보_IDX'), [
        ...
        const Combo_보정표_법정지상권 = new Combo('Combo_보정표_법정지상권', new JsonZoonData('Q_코드_법정지상권', {}), {
            ...
            GetZoonData('Q_코드_법정지상권').FindIndex('Combo_Idx', (row) => {
            ...
            GetZoonData('Q_코드_법정지상권').GetRow(GetValue('Combo_Idx'), [
        ...
        const Combo_입력표_업소구분 = new Combo('Combo_입력표_업소구분', 입력표_업소구분, {
            ...
            if (GetValue('Combo_입력표_업소구분') == "1") {
                ...
                // GetComponent('Edit_업소명').SetReadOnly(None);
            ...
            if (isEmpty(GetValue('Combo_입력표_업소구분'))) {
                ...
                // GetComponent('Edit_업소대표자').SetReadOnly(None);
        ...
        const Edit_실거래가격_총액 = new MaskEdit('Edit_실거래가격_총액', new JsonZoonData('Edit_실거래가격_총액', {}), {
            ...
            SetValue('Edit_실거래가격_단가', Round(GetValue('Edit_실거래가격_총액') / GetValue('Edit_토지의표시_합계_면적') / 1000, 0))
            SetValue('Edit_실거래가격_단가', GetValue('Edit_실거래가격_단가') * 1000)
            SetValue('Edit_실거래가격_평당단가', Round(GetValue('Edit_실거래가격_총액') / GetValue('Edit_토지의표시_합계_면적_평') / 1000, 0))
        ...
        const Edit_토지의표시_합계_개별공시지가_면적 = new MaskEdit('Edit_토지의표시_합계_개별공시지가_면적', new JsonZoonData('Edit_토지의표시_합계_개별공시지가_면적', {}), {
            isShow: true,
            isEnable: false,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_토지의표시_합계_개별공시지가_면적_평 = new MaskEdit('Edit_토지의표시_합계_개별공시지가_면적_평', new JsonZoonData('Edit_토지의표시_합계_개별공시지가_면적_평', {}), {
            isShow: true,
            isEnable: false,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Table37 = new Edit('Table37', new JsonZoonData('Q_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Picture56 = new Picture('Picture56', new JsonZoonData('Picture56', {}), {
            ...
            if (isEmpty(GetValue('배당표_배당금계산M_순번'))) {
                MsgBox('입력 대상 토지를 선택하여 주십시오.', '', false);
                return false;
            }
            ...
            GetComponent('DBGrid_배당금_계산D').SetCurSel(GetNumber('배당표_배당금계산_RowCount'));


            GetComponent('DBGrid_배당금_계산D').SetEditFocus(GetNumber('배당표_배당금계산_RowCount') - 1, 'right_date');
        ...
        const Picture57 = new Picture('Picture57', new JsonZoonData('Picture57', {}), {
            ...
            if (GetValue('배당표_배당금계산_RowPosition') <= 5) {
                MsgBox('고정된 항목은 삭제하실 수 없습니다.', '', true);
                return false;
            }
        ...
        const DBGrid_사진관리 = new DBGrid('DBGrid_사진관리', new JsonZoonData('Q_문서관리_사진', {}), {
            ...
            if (isEmpty(GetValue('00_TEMP'))) {
                MsgBox("GetValue('구분')을 먼저 선택하세요.", '[알림]', false);
            }
        ...
        const Table26 = new Edit('Table26', new JsonZoonData('Q_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Picture51 = new Picture('Picture51', new JsonZoonData('Picture51', {}), {
            ...
            SetValue('URL', "/view/es01/w02/p03?yyyy=" + GetValue('년도') + "&seq=" + GetValue('감정순번'))


            showModalDialog(GetValue('URL'), '', '');

        })

        const TreeView1 = new TreeView('TreeView1', new JsonZoonData('Q_공통보고서_트리', {}), {
            isShow: true,
            isEnable: true,
            bind: [
            ...
            .on('OnDblClick', function () {
                ...
                SetValue('URL', "/view/es01/w02/p00?yyyy=" + GetValue('년도') + "&seq=" + GetValue('감정순번') + "&repo_div=" + GetValue('TreeView1') + "&repo_title=" + GetValue('공통보고서_제목'));


                GetComponent('TreeView1').HasChildren('공통보고서_트리');
        ...
        const Picture65 = new Picture('Picture65', new JsonZoonData('Picture65', {}), {
            ...
            if (isEmpty(GetValue('Edit_탁상감정_탁상감정가'))) {
                MsgBox('탁상감정가를 입력하여 주십시오.', '', false);
            }

            MsgBox("해당 담당자가 확인 가능하게 됩니다." + Hex(10) + "저장하시겠습니까?", '알림', false);
        ...
        const Label76 = new Edit('Label76', new JsonZoonData('Label76', {}), {
            isShow: true,
            isEnable: true
        })
        const Table27 = new Edit('Table27', new JsonZoonData('Q_결제진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Label77 = new Edit('Label77', new JsonZoonData('Label77', {}), {
            isShow: true,
            isEnable: true
        })
