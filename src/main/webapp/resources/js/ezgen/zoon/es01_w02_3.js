...
const pageZoon = {
    ...
    OnInitialize : function() {
            ...
            .on({
                change: function() {
                    ...
                    if (match(PageType.집합_아파트)) {
                        ...
                        RunButton('MC_배당표_주택임대차보증금_계산_전체');
                    }else{
                        GetZoonData('Q_00_인테리어비용').GetRow(GetNumber('00_RowIndex'), [
            ...
            .on({
                change: function() {
                    ...
                    if (match(PageType.집합_아파트)) {
                        ...
                        SetValue('MkEdit_보수금액',GetValue('MkEdit_보수단가')*GetValue('MkEdit_보수평형_평'));
                        ...
                        SetValue('MkEdit_보정표_평가가격',GetValue('MkEdit_감정가_평가가격'));
                        SetValue('MkEdit_보정표_최저입찰가',GetValue('MkEdit_감정가_최종평가가격'));
                        SetValue('MkEdit_보정표_예상낙찰가', Round((GetValue('MkEdit_보정표_최저입찰가')*GetValue('MkEdit_보정표_적용할낙찰가율')/100)/1000,0)*1000);
        ...
        const Combo_보정표_현재의주된 = new Combo('Combo_보정표_현재의주된', Q_코드_이용현황,{
            ...
            .on({
                change: function() {
                    SetValue('MkEdit_보정표_적용할낙찰가율', GetNumber('MkEdit_보정표_기준낙찰가율')*GetNumber('MkEdit_보정표_아파트단지규모_적용율')*GetNumber('MkEdit_보정표_전유부분면적_적용율')*GetValue('MkEdit_보정표_전유부분위치_적용율')*GetValue('MkEdit_보정표_건축물의경과년도_적용율')*GetValue('MkEdit_보정표_점유자의권리형태'));
                    SetValue('MkEdit_보정표_예상낙찰가', GetNumber('MkEdit_보정표_최저입찰가')*GetNumber('MkEdit_보정표_적용할낙찰가율')/100);
                }
            });
        ...
        const Command_비준_사례번호생성 = new Command('Command_비준_사례번호생성', new JsonZoonData('Command_비준_사례번호생성', {}),{
            ...
            .on({
                click : function() {
                    ...
                    GetComponent('Combo_비준_사례번호').AddData(GetValue('감정가_비준_사례번호_생성문자'), GetValue('감정가_비준_사례번호_생성'), '');
        ...
        const Command_수익_사례번호생성 = new Command('Command_수익_사례번호생성', new JsonZoonData('Command_수익_사례번호생성', {}),{
            ...
            .on({
                click : function() {
                    ...
                    GetComponent('수익_Combo_사례구분').GetWindowText('감정가_수익_사례구분명');
                }
            });
        ...
        const Command_수익가격_삭제 = new Command('Command_수익가격_삭제', new JsonZoonData('Command_수익가격_삭제', {}),{
            ...
            .on({
                click : function() {
                    GetComponent('DBGrid_수익가격').GetCurSel('감정가_수익_현재행');
        ...
        const Command_임대사례_삭제 = new Command('Command_임대사례_삭제', new JsonZoonData('Command_임대사례_삭제', {}),{
            ...
            .on({
                click : function() {
                    GetComponent('DBGrid_임대사례').GetCurSel('감정가_임대_현재행');
            ...
            .on({
                click : function() {
                    ...
                    SetValue('MkEdit_보정표_적용할낙찰가율', GetNumber('MkEdit_보정표_기준낙찰가율')
                        *GetNumber('MkEdit_보정표_상가의접근성_적용율')
                        *GetNumber('MkEdit_보정표_상가의층별위치_적용율')
                        *GetNumber('MkEdit_보정표_상권의발달정도_적용율')
        ...
        const DBGrid_거래처 = new DBGrid('DBGrid_거래처', match(PageType.집합_아파트) ? Q_거래처목록 : Q_POPUP_거래처목록,{
            ...
            .on('OnDblClick', function() {
                if(match(PageType.집합_아파트)){
                    ...
                    SetValue('Edit_거래처코드','팝업_거래처코드');
                    SetValue('Edit_거래처','팝업_거래처명');
                    SetValue('Edit_대표자','팝업_대표자');

                    GetComponent('DBGrid_거래처').HideSubForm();
                }else if(match(PageType.집합_상업용) || match(PageType.집합_오피스텔)){
        ...
        const DBGrid_비준가격 = new DBGrid('DBGrid_비준가격', Q_감정가_03_비준가격,{
            ...
            .on('OnDblClick', function() {
                ...
                GetComponent('DBGrid_비준가격').GetRow(-1, [
                    ...
                    { key: 'MkEdit_비준_가격_사례', value: '가격_사례' },
        ...
        const Edit_대지권소유권_평 = new Edit('Edit_대지권소유권_평', new JsonZoonData('Edit_대지권소유권_평', {}),{
            isShow : true,
            isEnable : false,
        });
        ...
        const Formula1 = new MaskEdit('Formula1', new JsonZoonData('Formula1', {}),{
            isShow : true,
            isEnable : false,
            mask: ';;#,###',
            maskType: '숫자'
