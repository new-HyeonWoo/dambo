    ...
    OnInitialize: function () {
        ...
        const Combo_집합건물종류 = new Combo('Combo_집합건물종류', new JsonZoonData('Q_코드_담보종류', {}), {
            ...
            if (GetValue('Combo_집합건물종류') == "101") {
                ...
                SetValue('MkEdit_시가_최고_단가', Round(GetValue('MkEdit_시가_최고_총액') / GetValue('MkEdit_전유면적') / 1000, 0))
                SetValue('MkEdit_시가_최고_평당단가', Round(GetValue('MkEdit_시가_최고_총액') / GetValue('MkEdit_전유면적_평') / 1000, 0))
                ...
                SetValue('MkEdit_기준시가_단가', Round(GetValue('MkEdit_기준시가_총액') / GetValue('MkEdit_전유면적') / 1000, 0))
                SetValue('MkEdit_기준시가_평당단가', Round(GetValue('MkEdit_기준시가_총액') / GetValue('MkEdit_전유면적_평') / 1000, 0))
                SetValue('MkEdit_시가_최저_단가', GetValue('MkEdit_시가_최저_단가') * 1000)
                SetValue('MkEdit_시가_최저_평당단가', GetValue('MkEdit_시가_최저_평당단가') * 1000)
                SetValue('MkEdit_시가_최고_단가', GetValue('MkEdit_시가_최고_단가') * 1000)
                SetValue('MkEdit_시가_최고_평당단가', GetValue('MkEdit_시가_최고_평당단가') * 1000)
        ...
        const Command_배당처리 = new Picture('Command_배당처리', new JsonZoonData('Command_배당처리', {}), {
            ...
            if (GetValue('02_배당표수정여부') == 'Y') {
                MsgBox("배당처리 후 자료가 수정되어 있습니다" + Hex(10) + "다시 배당처리를 하면 수정된 자료는 무시됩니다." + Hex(10) + "배당처리할까요?", '[알림]', false);
            }

            MsgBox('배당처리하시겠습니까?', '', false);
...
//             <br> 하이트맥주 "+GetValue('탁상감정_성명'))
        ...
        const Picture91 = new Picture('Picture91', new JsonZoonData('Picture91', {}), {
        ...
        const Picture94 = new Picture('Picture94', new JsonZoonData('Picture94', {}), {
            isShow: (GetValue('_사원번호') == '106790'),
            isEnable: true
        }).on('OnClick', function () {
        ...
        const Picture95 = new Picture('Picture95', new JsonZoonData('Picture95', {}), {
        ...
        const Picture96 = new Picture('Picture96', new JsonZoonData('Picture96', {}), {
            isShow: (GetValue('_사원번호') == '106790'),
            isEnable: true
        }).on('OnClick', function () {
        ...
        const SubForm_감정요청자료_영업_URL = '/view/es01/w03/1/appraisal';
        const SubForm_감정요청자료_영업 = new SubForm('SubForm_감정요청자료_영업', new JsonZoonData('SubForm_감정요청자료_영업', {}), SubForm_감정요청자료_영업_URL
        ,{
            isShow: true,
            isEnable: true
        });
        ...
        let SubForm_거래처조회_URL = '/view/es01/w03/1/account';
        ...
        const Table6 = new Edit('Table6', new JsonZoonData('Q_가임대보증금적용지역', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Table52 = new Edit('Table52', new JsonZoonData('Q_가임대보증금적용지역', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Picture100 = new Picture('Picture100', new JsonZoonData('Picture100', {}), {
            isShow: true,
            isEnable: true
        })
        const Label100 = new Label('Label100', new JsonZoonData('Label100', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Label101 = new Label('Label101', new JsonZoonData('Label101', {}), {
            isShow: true,
            isEnable: true
        })
        const Picture101 = new Picture('Picture101', new JsonZoonData('Picture101', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Label102 = new Label('Label102', new JsonZoonData('Label102', {}), {
            isShow: true,
            isEnable: true
        })
        const Picture102 = new Label('Picture102', new JsonZoonData('Picture102', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Label103 = new Label('Label103', new JsonZoonData('Label103', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Table42 = new Edit('Table42', new JsonZoonData('Q_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Table43 = new Edit('Table43', new JsonZoonData('Q_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Edit_비준가격_본건요인_시점수정_날짜 = new MaskEdit('Edit_비준가격_본건요인_시점수정_날짜', new
        JsonZoonData('Edit_비준가격_본건요인_시점수정_날짜', {}), {
            isShow: true,
            isEnable: false,
            mask: 'yyyy-mm-dd',
            maskType: '날짜',
        ...
        const Combo_비준가격_본건요인_장래의동향 = new Edit('Combo_비준가격_본건요인_장래의동향', new JsonZoonData('Combo_비준가격_본건요인_장래의동향', {}), {
            ...
            GetComponent('DBGrid_비준가격').SetRow(0, [
        ...
        const Table51 = new Edit('Table51', new JsonZoonData('Q_40_응찰입력표_마스타', {}), {
            isShow: true,
            isEnable: true
        })
...
//SetValue('Edit_건물단가_총단가조정지수', GetValue('Edit_건물단가_중개축여부_적용지수')*GetValue('Edit_건물단가_관리상태_적용지수'))
        ...
        const Edit_건물단가_적용보정률_사유 = new Edit('Edit_건물단가_적용보정률_사유', new JsonZoonData('Edit_건물단가_적용보정률_사유', {}), {
            isShow: true,
            isEnable: !(GetValue('Edit_건물단가_적용보정률') == '1.00')
        }).on('OnLostFocus', function () {
...
//SetValue('Edit_건물단가_총단가조정지수', GetValue('Edit_건물단가_중개축여부_적용지수')*GetValue('Edit_건물단가_관리상태_적용지수'))
        ...
        const 감정가액산출수익 = new Edit('감정가액산출수익', new JsonZoonData('감정가액산출수익', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Table41 = new Edit('Table41', new JsonZoonData('Q_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Edit_수익_수익가격_지가상승률 = new MaskEdit('Edit_수익_수익가격_지가상승률', new JsonZoonData('Edit_수익_수익가격_지가상승률', {}), {
            isShow: true,
            isEnable: true,
            mask: ';7;#,###1.00',
            maskType: '숫자',
        ...
        const Edit_수익_수익가격_보증금 = new MaskEdit('Edit_수익_수익가격_보증금', new JsonZoonData('Edit_수익_수익가격_보증금', {}), {
            isShow: true,
            isEnable: true,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_수익가격_월임료 = new MaskEdit('Edit_수익_수익가격_월임료', new JsonZoonData('Edit_수익_수익가격_월임료', {}), {
            isShow: true,
            isEnable: true,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_수익가격_운용이율 = new MaskEdit('Edit_수익_수익가격_운용이율', new JsonZoonData('Edit_수익_수익가격_운용이율', {}), {
            isShow: true,
            isEnable: false,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_수익가격_연간임대수익 = new MaskEdit('Edit_수익_수익가격_연간임대수익', new JsonZoonData('Edit_수익_수익가격_연간임대수익', {}), {
            isShow: true,
            isEnable: false,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_수익가격_기타수익 = new MaskEdit('Edit_수익_수익가격_기타수익', new JsonZoonData('Edit_수익_수익가격_기타수익', {}), {
            isShow: true,
            isEnable: true,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_수익가격_가능총수익합계 = new MaskEdit('Edit_수익_수익가격_가능총수익합계', new JsonZoonData('Edit_수익_수익가격_가능총수익합계', {}), {
            isShow: true,
            isEnable: false,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_수익가격_공실률 = new MaskEdit('Edit_수익_수익가격_공실률', new JsonZoonData('Edit_수익_수익가격_공실률', {}), {
            isShow: true,
            isEnable: true,
            mask: ';7;#,###1.00',
            maskType: '숫자',
        ...
        const Edit_수익_수익가격_유효총수익 = new MaskEdit('Edit_수익_수익가격_유효총수익', new JsonZoonData('Edit_수익_수익가격_유효총수익', {}), {
            isShow: true,
            isEnable: false,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_수익가격_운영경비비율 = new MaskEdit('Edit_수익_수익가격_운영경비비율', new JsonZoonData('Edit_수익_수익가격_운영경비비율', {}), {
            isShow: true,
            isEnable: true,
            mask: ';7;#,###1.00',
            maskType: '숫자',
        ...
        const Edit_수익_수익가격_운영경비 = new MaskEdit('Edit_수익_수익가격_운영경비', new JsonZoonData('Edit_수익_수익가격_운영경비', {}), {
            isShow: true,
            isEnable: false,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_수익가격_순영업소득 = new MaskEdit('Edit_수익_수익가격_순영업소득', new JsonZoonData('Edit_수익_수익가격_순영업소득', {}), {
            isShow: true,
            isEnable: false,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_수익가격_환원이율 = new MaskEdit('Edit_수익_수익가격_환원이율', new JsonZoonData('Edit_수익_수익가격_환원이율', {}), {
            isShow: true,
            isEnable: false,
            mask: ';7;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_수익가격_수익가격 = new MaskEdit('Edit_수익_수익가격_수익가격', new JsonZoonData('Edit_수익_수익가격_수익가격', {}), {
            isShow: true,
            isEnable: false,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_평가액_수익가격 = new MaskEdit('Edit_수익_평가액_수익가격', new JsonZoonData('Edit_수익_평가액_수익가격', {}), {
            isShow: true,
            isEnable: false,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_평가액_결정가격 = new MaskEdit('Edit_수익_평가액_결정가격', new JsonZoonData('Edit_수익_평가액_결정가격', {}), {
            isShow: true,
            isEnable: true,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_평가액_격차율 = new MaskEdit('Edit_수익_평가액_격차율', new JsonZoonData('Edit_수익_평가액_격차율', {}), {
            isShow: true,
            isEnable: false,
            mask: ';7;#,###1.00',
            maskType: '숫자',
        ...
        const Edit_수익_평가액_보수평형_평 = new MaskEdit('Edit_수익_평가액_보수평형_평', new JsonZoonData('Edit_수익_평가액_보수평형_평', {}), {
            isShow: true,
            isEnable: false,
            mask: ';7;#,###1.00',
            maskType: '숫자',
            ...
            SetValue('Edit_수익_평가액_보수평형', GetValue('Edit_수익_평가액_보수평형_평') * 3.3058)

        })

        const Edit_수익_평가액_보수단가 = new MaskEdit('Edit_수익_평가액_보수단가', new JsonZoonData('Edit_수익_평가액_보수단가', {}), {
            isShow: true,
            isEnable: false,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_평가액_금액 = new MaskEdit('Edit_수익_평가액_금액', new JsonZoonData('Edit_수익_평가액_금액', {}), {
            isShow: true,
            isEnable: false,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Edit_수익_평가액_평가가격 = new MaskEdit('Edit_수익_평가액_평가가격', new JsonZoonData('Edit_수익_평가액_평가가격', {}), {
            isShow: true,
            isEnable: false,
            mask: ';12;#,###1',
            maskType: '숫자',
        ...
        const Command_임대사례_추가 = new Picture('Command_임대사례_추가', new JsonZoonData('Command_임대사례_추가', {}), {
            isShow: true,
            isEnable: true
        }).on('OnClick', function () {
            ...
            SetValue('감정가_임대_RowCount', GetValue('감정가_임대_RowCount') - 1);


            SetValue('감정가_임대_현재행', GetValue('감정가_임대_RowCount') + 1)

        })

        const Command_임대사례_삭제 = new Picture('Command_임대사례_삭제', new JsonZoonData('Command_임대사례_삭제', {}), {
            isShow: true,
            isEnable: true
        }).on('OnClick', function () {
        ...
        const Combo_입지특성_도로조건 = new Combo('Combo_입지특성_도로조건', new JsonZoonData('Q_00_도로조건', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
        ...
        const Combo_입지특성_도로계통성 = new Combo('Combo_입지특성_도로계통성', new JsonZoonData('Q_00_도로계통성', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
        ...
        const Combo_입지특성_공공시설접근성 = new Combo('Combo_입지특성_공공시설접근성', new JsonZoonData('Q_00_공공시설접근성', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
        ...
        const Combo_입지특성_상업시설접근성 = new Combo('Combo_입지특성_상업시설접근성', new JsonZoonData('Q_00_상업시설접근성', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
        ...
        const Combo_입지특성_가격동향 = new Combo('Combo_입지특성_가격동향', new JsonZoonData('Q_00_가격동향', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
        ...
        const Edit_수익_평가액_보수평형 = new MaskEdit('Edit_수익_평가액_보수평형', new JsonZoonData('Edit_수익_평가액_보수평형', {}), {
            isShow: true,
            isEnable: false,
            mask: ';7;#,###1.00',
            maskType: '숫자',
        ...
        const Edit_수익_수익가격_임대료조사시점 = new MaskEdit('Edit_수익_수익가격_임대료조사시점', new JsonZoonData('Edit_수익_수익가격_임대료조사시점', {}), {
            isShow: true,
            isEnable: true,
            mask: 'yyyy-mm-dd',
            maskType: '날짜',
        ...
        const Combo_평가_인테리어단가 = new Combo('Combo_평가_인테리어단가', new JsonZoonData('Q_00_인테리어비용', {}), {
            isShow: true,
            isEnable: true,
            format: {
                text: 'CD_DESC',
        ...
        const Table44 = new Edit('Table44', new JsonZoonData('Q_00_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        const Table45 = new Edit('Table45', new JsonZoonData('Q_00_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        const Table46 = new Edit('Table46', new JsonZoonData('Q_00_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        const Table47 = new Edit('Table47', new JsonZoonData('Q_00_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        const Table48 = new Edit('Table48', new JsonZoonData('Q_00_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Command_응찰_12_부담비용합계 = new Command('Command_응찰_12_부담비용합계', new JsonZoonData('Command_응찰_12_부담비용합계', {}), {
            ...
            SetValue('응찰_수지_실제취득가', GetValue('응찰_수지_부담비용합계') + GetValue('응찰_내용_입찰예정가_금액'));
...
// 501:토지
        ...
        const Command_응찰_16_보유비용 = new Command('Command_응찰_16_보유비용', new JsonZoonData('Command_응찰_16_보유비용', {}), {
            ...
            SetValue('응찰_수지_보유비용_기회비용', //기회비용산출=(취득원가합계*5%*3)-(취득원가합계*5%*3*0.165)
                Round(((GetNumber('응찰_수지_취득_원가합계') * 0.05 * 3) - (GetNumber('응찰_수지_취득_원가합계') * 0.05 * 3 * 0.165)) / 1000, 0) * 1000);


            SetValue('응찰_수지_보유비용_부가세', //임대수익= (임대보증금*5%*3)+(월임대수입*36)
                Round(((GetNumber('응찰_수지_보유수익_임대보증금') * 0.05 * 0.1 * 3) + (GetNumber('응찰_수지_보유수익_월임대수입') * 36 * 0.1)) / 1000, 0) * 1000);


            SetValue('응찰_수지_보유비용_법인세', //임대수익= (임대보증금*5%*3)+(월임대수입*36)
                Round((GetNumber('응찰_수지_보유수익_합계') * 0.25) / 1000, 0) * 1000);


            if (Left(GetValue('담보종류'), 1) == "1") {
                SetValue('응찰_수지_보유비용_재산세', Round((GetNumber('응찰_수지_보유비용_주택기준시가') * 0.5 * 0.004) / 1000, 0) * 1000);
            } else {
                SetValue('응찰_수지_보유비용_재산세', Round((GetNumber('응찰_수지_보유비용_종부세적용면적') * 610) / 1000, 0) * 1000);
            }
        ...
        const Table32 = new Edit('Table32', new JsonZoonData('Q_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        const Table33 = new Edit('Table33', new JsonZoonData('Q_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Table34 = new Edit('Table34', new JsonZoonData('Q_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        const Table35 = new Edit('Table35', new JsonZoonData('Q_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        const DBGrid_배당표_상가건물_임대차보증금_계산 = new DBGrid('DBGrid_배당표_상가건물_임대차보증금_계산', new
        JsonZoonData('Q_배당표_상가임차보증금_계산', {}), {
            isShow: true,
            isEnable: true
        }).on('OnClick', function () {
        ...
        const Table36 = new Edit('Table36', new JsonZoonData('Q_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const DBGrid_배당금건물_계산D = new DBGrid('DBGrid_배당금건물_계산D', new DBGridZoonData('Q_배당표_배당금건물_계산D', {}, [
            ...
            if (GetValue('배당표_배당금계산건물_RowCount') > 6) {
        ...
        const Picture58 = new Picture('Picture58', new JsonZoonData('Picture58', {}), {
            ...
            if (isEmpty(GetValue('배당표_배당금계산건물M_순번'))) {
                MsgBox('입력 대상 건물 선택하여 주십시오.', '', true);
                return false;
            }
        ...
        const Picture59 = new Picture('Picture59', new JsonZoonData('Picture59', {}), {
            ...
            if (GetValue('배당표_배당금계산건물_RowPosition') <= 5) {
                MsgBox('고정된 항목은 삭제하실 수 없습니다.', '', false);
            }
        ...
        const Picture56 = new Picture('Picture56', new JsonZoonData('Picture56', {}), {
            ...
            if (isEmpty(GetValue('배당표_배당금계산M_순번'))) {
                MsgBox('입력 대상 토지를 선택하여 주십시오.', '', true);
                return false;
            }
        ...
        const Picture62 = new Picture('Picture62', new JsonZoonData('Picture62', {}), {
            ...
            MsgBox('현재 배당 항목을 모든 배당자료에 적용합니다. 진행하시겠습니까?', '', false);
        ...
        const Table38 = new Edit('Table38', new JsonZoonData('Q_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const TreeView1 = new TreeView('TreeView1', new JsonZoonData('Q_공통보고서_트리', {}), {
            ...
            .on('OnDblClick', function () {
                ...
                SetValue('URL', "/view/es01/w02/p00?" +
                    "yyyy=" + GetValue('년도')
                    + "&seq=" + GetValue('감정순번')
                    + "&repo_div=" + GetValue('TreeView1')
                    + "&repo_title=" + GetValue('공통보고서_제목'));
        ...
        const Label98 = new Label('Label98', new JsonZoonData('Label98', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Table50 = new Edit('Table50', new JsonZoonData('Q_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Table49 = new Edit('Table49', new JsonZoonData('Q_결재진행현황', {}), {
            isShow: true,
            isEnable: true
        })
        ...
        const Table3 = new Edit('Table3', new JsonZoonData('test', {}), {
            isShow: true,
            isEnable: true
        })
    }
