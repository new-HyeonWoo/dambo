const pageZoon = {
    ...
    OnInitialize: function () {
        ...
        const Cmd_해당년월일자부터 = new Command('Cmd_해당년월일자부터', new JsonZoonData('Cmd_해당년월일자부터', {}),{
            ...
            RunQuery('[해당년월]=[Formula_감정일자_부터]', {}, 'GET');
        ...
        const Group_그래프_X = new Edit('Group_그래프_X', new JsonZoonData('Group_그래프_X', {}),{
            isShow : true,
            isEnable : true
        })
        ...
        const Group_그래프_Y = new Edit('Group_그래프_Y', new JsonZoonData('Group_그래프_Y', {}),{
            isShow : true,
            isEnable : true
        })
        ...
        const Chart1 = new Edit('Chart1', new JsonZoonData('Q_담보목록_그래프용', {}),{
            isShow : true,
            isEnable : true
        })
        ...
        const Check_소재지 = new Tab('Check_소재지', new JsonZoonData('A', {}),{
            ...
            GetZoonData('Q_부서목록').FindIndexArray('None', (row) => {
        ...
        const Group_합산_기간 = new Group('Group_합산_기간', new JsonZoonData('Group_합산_기간', {}),{
            isShow : true,
            isEnable : true
        })
        ...
        const Group_합산_지점 = new Group('Group_합산_지점', new JsonZoonData('Group_합산_지점', {}),{
            isShow : true,
            isEnable : true
        })
        ...
        const Group_합산_담보종류 = new Group('Group_합산_담보종류', new JsonZoonData('Group_합산_담보종류', {}),{
            isShow : true,
            isEnable : true
        })
        ...
        const Group_합산_업소구분 = new Group('Group_합산_업소구분', new JsonZoonData('Group_합산_업소구분', {}),{
            isShow : true,
            isEnable : true
        })
