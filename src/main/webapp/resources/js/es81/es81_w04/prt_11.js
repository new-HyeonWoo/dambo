...
$(document).ready(function(){  
    ...
    PRT_11_입력표_토지_d_tot_obj.토지_개별공시지가_단가_prt22 = 0;
    PRT_11_입력표_토지_d_tot_obj.토지_개별공시지가_단가_평_prt22  = 0;
    ...
    if(PRT_11_입력표_토지_D.getData() != null ){
    	for(var i = 0; i <  PRT_11_입력표_토지_D.getData().length; i++){
    		...
    		PRT_11_입력표_토지_D_obj.담보제공비율_전체면적 = fn_dot_two(fn_input_number_toFixed(PRT_11_입력표_토지_D_obj.담보제공비율_전체면적));
    		PRT_11_입력표_토지_D_obj.담보제공비율_분자 = fn_dot_two(fn_input_number_toFixed(PRT_11_입력표_토지_D_obj.담보제공비율_분자));
    		PRT_11_입력표_토지_D_obj.담보제공비율_분모 = fn_dot_two(fn_input_number_toFixed(PRT_11_입력표_토지_D_obj.담보제공비율_분모));
    		PRT_11_입력표_토지_D_obj.담보제공비율_비율 = fn_dot_two(fn_input_number_toFixed(PRT_11_입력표_토지_D_obj.담보제공비율_비율));
    		PRT_11_입력표_토지_D_obj.담보제공비율_담보제공면적 = fn_dot_two(fn_input_number_toFixed(PRT_11_입력표_토지_D_obj.담보제공비율_담보제공면적));
    		
    		PRT_11_입력표_토지_D_obj.토지_면적 = fn_dot_two(fn_input_number_toFixed(PRT_11_입력표_토지_D_obj.토지_면적));
    		PRT_11_입력표_토지_D_obj.토지_면적_평 = fn_dot_two(fn_input_number_toFixed(PRT_11_입력표_토지_D_obj.토지_면적_평));
    	}
    }

	PRT_11_입력표_토지_d_tot_obj.토지_개별공시지가_단가 = fn_input_number(Math.ceil(Number(PRT_11_입력표_토지_d_tot_obj.토지_개별공시지가_단가) /  PRT_11_입력표_토지_D.getData().length));
	PRT_11_입력표_토지_d_tot_obj.토지_개별공시지가_단가_평  = fn_input_number(Math.ceil(Number(PRT_11_입력표_토지_d_tot_obj.토지_개별공시지가_단가_평) /  PRT_11_입력표_토지_D.getData().length));
	
	PRT_11_입력표_토지_d_tot_obj.토지_개별공시지가_단가_prt22 = fn_input_number(Math.floor(Number(PRT_11_입력표_토지_d_tot_obj.토지_개별공시지가) /  Number(PRT_11_입력표_토지_d_tot_obj.토지_면적) ));
	// PRT_11_입력표_토지_d_tot_obj.토지_개별공시지가_단가_평_prt22  =  fn_input_number(Math.ceil(Number(PRT_11_입력표_토지_d_tot_obj.토지_개별공시지가) /  Number(PRT_11_입력표_토지_d_tot_obj.토지_면적_평) ));
	PRT_11_입력표_토지_d_tot_obj.토지_개별공시지가_단가_평_prt22  =  fn_input_number(Truncate(Number(PRT_11_입력표_토지_d_tot_obj.토지_개별공시지가) /  Number(PRT_11_입력표_토지_d_tot_obj.토지_면적_평), 0 ));

	PRT_11_입력표_토지_d_tot_obj.토지_개별공시지가 = fn_input_number(PRT_11_입력표_토지_d_tot_obj.토지_개별공시지가);
	PRT_11_입력표_토지_d_tot_obj.담보제공비율_전체면적 = fn_dot_two(fn_input_number_toFixed(PRT_11_입력표_토지_d_tot_obj.담보제공비율_전체면적));
	...
	PRT_11_입력표_토지_d_tot_obj.담보제공비율_담보제공면적 = fn_dot_two(fn_input_number_toFixed(PRT_11_입력표_토지_d_tot_obj.담보제공비율_담보제공면적));
	PRT_11_입력표_토지_d_tot_obj.토지_면적 = fn_dot_two(fn_input_number_toFixed(PRT_11_입력표_토지_d_tot_obj.토지_면적));
	PRT_11_입력표_토지_d_tot_obj.토지_면적_평 = fn_dot_two(fn_input_number_toFixed(PRT_11_입력표_토지_d_tot_obj.토지_면적_평));
	...
	$('#prt_11_collateral').html(
		Mustache.render($('#prt_11_collateral_template').html(), {'list': PRT_11_입력표_토지_D.getData(), 'prt11_d_tot': PRT_11_입력표_토지_d_tot_obj} )
	);
