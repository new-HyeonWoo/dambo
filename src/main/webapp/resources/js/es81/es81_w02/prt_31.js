...
$(document).ready(function(){
    ...
    for(var i = 0; i <  PRT_31_담보사항_담보여력및초과부족설정.getData().length; i++){
    	...
    	PRT_31_담보사항_담보여력및초과부족설정_obj.당사설정금액 = fn_input_number(PRT_31_담보사항_담보여력및초과부족설정_obj.당사설정금액);
    	PRT_31_담보사항_담보여력및초과부족설정_obj.담보여력_설정전 = fn_input_number(PRT_31_담보사항_담보여력및초과부족설정_obj.담보여력_설정전);
    }
    
	$('#prt_31_our_settings').html(
		Mustache.render($('#prt_31_our_settings_template').html(), {'list': PRT_31_담보사항_담보여력및초과부족설정.getData()} )
	);
