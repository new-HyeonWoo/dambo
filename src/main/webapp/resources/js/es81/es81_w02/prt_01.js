var PRT_01_입력표 = new JsonZoonData('PRT_01_입력표', {});
$(document).ready(function(){
    ...
    for(var i = 0; i <  PRT_01_입력표.getData().length; i++){
    	...
    	PRT_01_입력표_obj.대지권소유권 = Number(PRT_01_입력표_obj.대지권소유권).toFixed(2);
    }
	...
	$('#prt_01_collateral').html(
			Mustache.render($('#prt_01_collateral_template').html(), {'list': PRT_01_입력표.getData()})
	);
