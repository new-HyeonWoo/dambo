...
<script id="DBGrid_토지의표시_템플릿" type="text/x-handlebars-template">
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary">
            <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle text-nowrap">
...
<script id="DBGrid_건물의표시_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ maskField name="CB_DATE" value=CB_DATE index=index options='{"mask": "yyyy-mm-dd", "maskType": "날짜"}' }}</td>
        ...
        <td>{{ maskField name="CB_FLOOR" value=CB_FLOOR index=index options='{"mask": "000", "maskType": "숫자"}' }}</td>
        <td>{{ inputField name="CB_USE_MAIN" value=CB_USE_MAIN index=index options='{}' }}</td>
        <td>{{ maskField name="CB_SIZE" value=CB_SIZE index=index options='{"mask": "-;7;#,###1.00", "maskType": "숫자"}' }}</td>
        <td>{{ noneField name="CB_SIZE_PY" value=CB_SIZE_PY index=index options='{"mask": "-;7;#,###1.00", "maskType": "숫자"}' }}</td>
    </tr>
</script>
    ...
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary">
            <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle text-nowrap">
                ...
                <th class="w-150px">사례구분</th>
                <th class="w-100px">경매사건번호</th>
                <th class="w-200px">소재지</th>
                <th class="w-50px">선택</th>
                <th class="w-100px">조사금액</th>
                <th class="w-80px">면적(㎡)</th>
                <th class="w-150px">용도지역</th>
                <th class="w-150px">지목</th>
                <th class="w-150px">이용현황</th>
                <th class="w-150px">도로조건</th>
                <th class="w-150px">형상</th>
                <th class="w-150px">고저</th>
                <th class="w-100px">사례가격(원/㎡)</th>
            </tr>
        </thead>
        <tbody class="text-center">
            {{#each .}}
...
<script id="DBGrid_비준가격_산정사례_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ maskField name="L_SIZE" value=L_SIZE index=index options='{"mask": "-;7;#,###1.00", "maskType": "숫자"}' }}</td>
        <td>{{ comboField name="USE_AREA" value=USE_AREA index=index query='{"id": "Q_코드_용도지역", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ comboField name="LCATEGORY" value=LCATEGORY index=index query='{"id": "Q_코드_지목", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ comboField name="L_USE_CODE" value=L_USE_CODE index=index query='{"id": "Q_코드_이용현황", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ comboField name="OF_ROAD_CODE" value=OF_ROAD_CODE index=index query='{"id": "Q_코드_도로조건", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
    ...
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary">
            <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle">
                ...
                <th class="col-1">일단지구분</th>
                <th class="col-1">표준지</th>
            </tr>
        </thead>
        <tbody>
            {{#each .}}
...
<script id="DBGrid_기준가격집계표_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ noneField name="EDIT_C" value=EDIT_C index=index options='{"mask": "-;7;#,###1.000", "maskType": "숫자", "textType": "text-end"}' }}</td>
    ...
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary">
            <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle">
                ...
                <th class="hide">EDIT_M_DATE</th>
                <th class="min-w-100px">일단지구분</th>
                <th class="min-w-100px">사례번호</th>
                <th class="min-w-100px">사례구분</th>
                <th class="min-w-100px">시점수정</th>
            </tr>
        </thead>
        <tbody>
            {{#each .}}
    ...
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary">
            <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle">
                ...
                <th class="min-w-100px text-center" rowspan="2">사례번호</th>
                <th class="min-w-100px text-center" rowspan="2">사례가격</th>
                <th class="min-w-100px text-center" rowspan="2">시점수정</th>
                <th class="min-w-300px text-center" rowspan="2">소재지</th>
                <th class="min-w-100px text-center" colspan="6">개별요인</th>
                <th class="min-w-100px text-center" rowspan="2">요인합계</th>
                <th class="min-w-100px text-center" rowspan="2">산정단가(원/㎡)</th>
                <th class="min-w-100px text-center" rowspan="2">적용단가(원/㎡)</th>
            </tr>
            <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle">
                <th>가로</th>
                <th>접근</th>
...
<script id="DBGrid_비준가격집계표_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ noneField name="JUSO_M" value=JUSO_M index=index options='{"textType" :"text-start"}' }}</td>
        <td>{{ noneField name="ROAD_C" value=ROAD_C index=index options='{"mask": "-;7;#,###1.00", "maskType": "숫자", "textType" :"text-end"}' }}</td>
        <td>{{ noneField name="APPRO_C" value=APPRO_C index=index options='{"mask": "-;7;#,###1.00", "maskType": "숫자", "textType" :"text-end"}' }}</td>
        <td>{{ noneField name="ENVI_C" value=ENVI_C index=index options='{"mask": "-;7;#,###1.00", "maskType": "숫자", "textType" :"text-end"}' }}</td>
        <td>{{ noneField name="OFFIC_C" value=OFFIC_C index=index options='{"mask": "-;7;#,###1.00", "maskType": "숫자", "textType" :"text-end"}' }}</td>
...
<script id="DBGrid_기타요인_템플릿" type="text/x-handlebars-template">
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        ...
        <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle text-nowrap">
            ...
            <th class="min-w-150px" rowspan="2">일단지구분</th>
            <th class="min-w-100px" rowspan="2">표준지공시지가<br>기준가격의 적용단가</th>
            <th colspan="3">본건지역의 가격수준</th>
        ...
        <tr class="fw-bolder fs-7 text-gray-800 text-center">
            <th class="min-w-100px">선택</th>
            <th class="min-w-100px">최저</th>
            <th class="min-w-100px">최고</th>
        </tr>
        <tbody>
            {{#each .}}
    ...
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary">
            <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle">
                ...
                <th class="col-1">개별공시지가</th>
                <th class="col-1">표준지공시지가<br>기준가격의 적용단가</th>
                <th class="col-1">적용보정률</th>
                <th class="col-1">산정가격(원/㎡)</th>
                <th class="col-1">적용가격(원/㎡)</th>
                <th class="col-1">면적(㎡)</th>
                <th class="col-1">평가가격(원)</th>
            </tr>
        <tbody>
            {{#each .}}
    ...
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary">
            <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle">
                ...
                <th class="hide">SEQ</th>
                <th class="hide">LN_SEQ</th>
                <th class="col-1" rowspan="2">일단지구분</th>
                <th class="col-1" rowspan="2">지번</th>
                <th class="col-1" rowspan="2">평가가격(원)</th>
                <th colspan="3">담보제공비율</th>
                <th class="col-1" rowspan="2">최종평가가액(원)</th>
            </tr>
            <tr class="fw-bolder fs-7 text-gray-800 text-center">
                <th class="col-1">분자</th>
                <th class="col-1">분모</th>
                <th class="col-1">비율</th>
            </tr>
        <tbody>
            {{#each .}}
...
<script id="DBGrid_건물평가액_집계표_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ noneField name="CB_BUILD_DAN" value=CB_BUILD_DAN index=index options='{}' }}</td>
        <td>{{ noneField name="OF_JANGA_RATE" value=OF_JANGA_RATE index=index options='{}' }}</td>
        <td>{{ noneField name="APAS_DAN" value=APAS_DAN index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="APPL_DAN" value=APPL_DAN index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="SEC_OFFER_SIZE" value=SEC_OFFER_SIZE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
...
<script id="DBGrid_감정가액산출내역_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td class="hide">{{ noneField name="SEQ" value=SEQ index=index options='{}' }}</td>
        <td class="hide">{{ noneField name="LN_SEQ" value=LN_SEQ index=index options='{}' }}</td>
        <td>{{ noneField name="NAME" value=NAME index=index options='{}' }}</td>
        <td>{{ noneField name="POT_GU" value=POT_GU index=index options='{}' }}</td>
        <td>{{ noneField name="LOT_NUM" value=LOT_NUM index=index options='{}' }}</td>
        <td>{{ noneField name="FNL_INC_AMT_A" value=FNL_INC_AMT_A index=index options='{"mask": "-;7;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="FNL_INC_AMT" value=FNL_INC_AMT index=index options='{"mask": "-;7;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
    </tr>
</script>
    ...
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary text-nowrap">
            <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle">
                ...
                <th class="w-50px">확정일자<br>보유여부 </th>
...
<script id="DBGrid_배당표_주택임대차보증금_계산_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td class="w-200px">{{ inputField name="RESI_NAME" value=RESI_NAME index=index options='{"textType" : "text-start"}' }} </td>
        <td class="w-150px">{{ maskField name="RESI_RM_CNT" value=RESI_RM_CNT index=index options='{"textType" : "text-end"}' }} </td>
        <td class="w-50px">{{ checkField name="FXDATE_YN" value=FXDATE_YN index=index options='{ "on" : "Y", "off" : "N"}' }} </td>
        <td class="w-150px">{{ maskField name="POSS_A_RM_CNT" value=POSS_A_RM_CNT index=index options='{"textType" : "text-end"}' }} </td>
        <td class="w-150px">{{ maskField name="LEASE_AMT" value=LEASE_AMT index=index options='{"textType" : "text-end"}' }} </td>
        <td class="w-150px">{{ noneField name="REP_BE_SEC_AMT" value=REP_BE_SEC_AMT index=index options='{"textType" : "text-end"}' }} </td>
        <td class="w-150px">{{ noneField name="FXLEA_AMT" value=FXLEA_AMT index=index options='{"textType" : "text-end"}' }} </td>
        <td class="w-150px">{{ noneField name="FXLEA_NO_AMT" value=FXLEA_NO_AMT index=index options='{"textType" : "text-end"}' }} </td>
    </tr>
</script>
...
<script id="DBGrid_배당표_상가건물_임대차보증금_계산_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td class="hide">{{ noneField name="SEQ" value=SEQ index=index options='{}' }} </td>
        <td class="hide">{{ noneField name="REP_AF_SEC_AMT" value=REP_AF_SEC_AMT index=index options='{}' }} </td>
        <td class="w-150px">{{ comboField name="RNO" value=RNO index=index query='{"id": "Q_코드_각구의일련번호", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }} </td>
        <td class="w-150px">{{ inputField name="C_DESC" value=C_DESC index=index options='{"textType" : "text-start"}' }} </td>
        <td class="w-80px">{{ checkField name="POSS_YN" value=POSS_YN index=index options='{ "on" : "Y", "off" : "N"}' }} </td>
        <td class="w-150px">{{ inputField name="HIR_NAME" value=HIR_NAME index=index options='{"textType" : "text-start"}' }} </td>
        <td class="w-150px">{{ maskField name="STO_LSEC_AMT" value=STO_LSEC_AMT index=index options='{"textType" : "text-end"}' }} </td>
        <td class="w-80px">{{ checkField name="FXDATE_YN" value=FXDATE_YN index=index options='{ "on" : "Y", "off" : "N"}' }} </td>
        <td class="w-150px">{{ maskField name="MRENT_AMT" value=MRENT_AMT index=index options='{"textType" : "text-end"}' }} </td>
        <td class="w-150px">{{ noneField name="LEASE_AMT" value=LEASE_AMT index=index options='{"textType" : "text-end"}' }} </td>
        <td class="w-150px">{{ noneField name="REP_BE_SEC_AMT" value=REP_BE_SEC_AMT index=index options='{"textType" : "text-end"}' }} </td>
        <td class="w-150px">{{ noneField name="FXLEA_AMT" value=FXLEA_AMT index=index options='{"textType" : "text-end"}' }} </td>
        <td class="w-150px">{{ noneField name="FXLEA_NO_AMT" value=FXLEA_NO_AMT index=index options='{"textType" : "text-end"}' }} </td>
    </tr>
...
<script id="DBGrid_배당금_계산D_템플릿" type="text/x-handlebars-template">
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        ...
        <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle">
            ...
            <th class="min-w-350px" colspan="3">최고채권액</th>
        </tr>
        <tr class="fw-bolder fs-7 text-gray-800 text-center">
            <th>말소여부</th>
            <th>단독담보</th>
...
<script id="DBGrid_배당금_계산D_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ comboField name="DISP_RANK" value=DISP_RANK index=index query='{"id": "Q_코드_순위", "text": "CD_DESC", "value": "CD_CODE", "조건": ""}' options='{"textType" :"text-center"}' }}</td>
        <td>{{ maskField name="RIGHT_DATE" value=RIGHT_DATE index=index options='{"mask": "yyyy-mm-dd", "maskType": "날짜", "textType" :"text-center"}' }}</td>
        <td>{{ checkField name="HITE_YN" value=HITE_YN isEnable=IS_ENABLE index=index options='{ "on": "Y", "off": "N"}' }}</td>
