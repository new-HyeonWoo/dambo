    ...
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary text-nowrap text-center align-middle">
            <tr class="fw-bolder fs-7 text-gray-800">
                ...
                <th rowspan="2" class="w-100px">일단지구분</th>
                <th rowspan="2" class="w-300px">최소행정구역</th>
                <th rowspan="2" class="w-50px">선택</th>
                <th rowspan="2" class="w-150px">지번</th>
                <th rowspan="2" class="w-150px">지목</th>
                <th colspan="2">면적</th>
                <th colspan="3">개별공시지가</th>
            </tr>
            <tr>
                <th class="w-150px">m<sup>2</sup></th>
                <th class="w-150px">평</th>
                <th class="w-150px">원/m<sup>2</sup></th>
...
<script id="DBGrid_토지의표시_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td class="w-300px"> {{ noneField name="MIN_BOUND" value=MIN_BOUND index=index options='{}' }}</td>
        ...
        <td class="w-150px"> {{ maskField name="L_SIZE" value=L_SIZE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td class="w-150px"> {{ noneField name="L_SIZE_PY" value=L_SIZE_PY index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
    ...
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary text-center align-middle">
            <tr class="fw-bolder fs-7 text-gray-800">
                ...
                <th class="hide">SEC_OFFER_SIZE</th>
                <th class="hide">SEC_DESC</th>
                <th class="w-150px" rowspan="2">등기구분</th>
                <th class="w-150px" rowspan="2">소재지번</th>
                <th class="w-150px" rowspan="2">건축년월일</th>
                <th class="w-200px" rowspan="2">구조</th>
                <th class="w-200px" rowspan="2">지붕</th>
                <th class="w-150px" rowspan="2">층별</th>
                <th class="w-150px" rowspan="2">주용도</th>
...
<script id="DBGrid_건물의표시_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ maskField name="CB_DATE" value=CB_DATE index=index options='{"mask": "yyyy-mm-dd", "maskType": "날짜", "textType": "text-start"}' }}</td>
        <td>{{ comboField name="CB_STRUC" value=CB_STRUC index=index query='{"id": "Q_코드_구조", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ comboField name="CB_ROOF" value=CB_ROOF index=index query='{"id": "Q_코드_지붕", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ maskField name="CB_FLOOR" value=CB_FLOOR index=index options='{}' }}</td>
        <td>{{ inputField name="CB_USE_MAIN" value=CB_USE_MAIN index=index options='{}' }}</td>
        <td>{{ maskField name="CB_SIZE" value=CB_SIZE index=index options='{"mask": "-;7;#,###1.00", "maskType": "숫자", "textType" :"text-end"}' }}</td>
        <td>{{ noneField name="CB_SIZE_PY" value=CB_SIZE_PY index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
    </tr>
</script>
...
<script id="DBGrid_담보제공비율_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td> {{ noneField name="SEC_REGI_SIZE" value=SEC_REGI_SIZE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td> {{ maskField name="SEC_NUME" value=SEC_NUME index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td> {{ maskField name="SEC_DENO" value=SEC_DENO index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td> {{ noneField name="SEC_RATE" value=SEC_RATE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td> {{ noneField name="SEC_OFFER_SIZE" value=SEC_OFFER_SIZE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
...
<script id="DBGrid_담보제공비율_건물_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td class="hide"> {{ noneField name="LN_SEQ" value=LN_SEQ index=index options='{}' }}</td>
        <td class="hide"> {{ noneField name="SEC_DESC_ENABLE" value=SEC_DESC_ENABLE index=index options='{}' }}</td>
        <td> {{ comboField name="REGI_GU" value=REGI_GU index=index query='{"id": "Q_코드_표준지구분", "text": "CD_DESC", "value": "CD_CODE"}' isEnable=IS_ENABLE options='{}' }}</td>
        <td> {{ noneField name="LOT_NUM" value=LOT_NUM index=index options='{}' }}</td>
        <td> {{ noneField name="SEC_REGI_SIZE" value=SEC_REGI_SIZE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td> {{ maskField name="SEC_NUME" value=SEC_NUME index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td> {{ maskField name="SEC_DENO" value=SEC_DENO index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
...
<script id="DBGrid_본건토지_템플릿" type="text/x-handlebars-template">
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary text-center">
            <tr class="fw-bolder fs-7 text-gray-800">
...
<script id="DBGrid_본건토지_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ noneField name="L_SIZE" value=L_SIZE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
...
<script id="DBGrid_표준지공시지가_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ comboField name="L_SHAPE_CODE" value=L_SHAPE_CODE index=index query='{"id": "Q_코드_형상", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ comboField name="L_UNDUR_CODE" value=L_UNDUR_CODE index=index query='{"id": "Q_코드_고저", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ maskField name="STD_ANNO_AMT" value=STD_ANNO_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType" :"text-end"}' }}</td>
    </tr>
</script>
...
<script id="DBGrid_비준가격_산정사례_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td class="hide">{{ noneField name="YYYY" value=YYYY index=index options='{}' }}</td>
        <td class="hide">{{ noneField name="SEQ" value=SEQ index=index options='{}' }}</td>
        <td>{{ noneField name="EX_NO" value=EX_NO index=index options='{}' }}</td>
        ...
        <td>{{ buttonField name="BTN" value="BTN" index=index options='{ "iconType" : "search" }' }}</td>
        <td>{{ maskField name="SURVEY_AMT" value=SURVEY_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType":"text-end"}' }}</td>
        <td>{{ maskField name="L_SIZE" value=L_SIZE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType":"text-end"}' }}</td>
        <td>{{ comboField name="USE_AREA" value=USE_AREA index=index query='{"id": "Q_코드_용도지역", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ comboField name="LCATEGORY" value=LCATEGORY index=index query='{"id": "Q_코드_지목", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ comboField name="L_USE_CODE" value=L_USE_CODE index=index query='{"id": "Q_코드_이용현황", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ comboField name="OF_ROAD_CODE" value=OF_ROAD_CODE index=index query='{"id": "Q_코드_도로조건", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ comboField name="L_SHAPE_CODE" value=L_SHAPE_CODE index=index query='{"id": "Q_코드_형상", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ comboField name="L_UNDUR_CODE" value=L_UNDUR_CODE index=index query='{"id": "Q_코드_고저", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ noneField name="EXAMPLE_PRICE" value=EXAMPLE_PRICE index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType":"text-end"}' }}</td>
    </tr>
</script>
<%--// 감정가액산출1--%>
...
<script id="DBGrid_기준가격_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ comboField name="STD_GU" value=STD_GU index=index query='{"id": "Q_표준지갱신", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
    </tr>
</script>
...
<script id="DBGrid_기준가격집계표_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ noneField name="ROAD_C" value=ROAD_C index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="APPRO_C" value=APPRO_C index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="ENVI_C" value=ENVI_C index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="OFFIC_C" value=OFFIC_C index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="LAND_C" value=LAND_C index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="ETC_C" value=ETC_C index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="FACTOR_TOT" value=FACTOR_TOT index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="APAS_DAN" value=APAS_DAN index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="APPL_DAN" value=APPL_DAN index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
    </tr>
</script>
<%--//감정가액산출2--%>
...
<script id="DBGrid_비준가격집계표_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ noneField name="EX_NO" value=EX_NO index=index options='{}' }}</td>
        <td>{{ noneField name="STD_ANNO_AMT" value=STD_ANNO_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="EDIT_C" value=EDIT_C index=index options='{"mask": "-;12;#,###1.000", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="JUSO_M" value=JUSO_M index=index options='{}' }}</td>
    ...
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary text-center align-middle">
            <tr class="fw-bolder fs-7 text-gray-800">
                ...
                <th rowspan="2">일단지구분</th>
                <th rowspan="2">표준지공시지가기준가격의 적용단가</th>
                <th colspan="3">비준가격</th>
                <th rowspan="2">비준가격</th>
                <th rowspan="2">산정보정률</th>
                <th rowspan="2">사정보정률</th>
                <th rowspan="2">적용보정률</th>
                <th rowspan="2">사유</th>
            </tr>
            <tr class="fw-bolder fs-7 text-gray-800">
                <th>선택</th>
...
<script id="DBGrid_기타요인_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        <td class="hide">{{ noneField name="YYYY" value=YYYY index=index options='{}' }}</td>
        <td class="hide">{{ noneField name="SEQ" value=SEQ index=index options='{}' }}</td>
        <td class="hide">{{ noneField name="ASSESS_DESC_ENABLE" value=ASSESS_DESC_ENABLE index=index options='{}' }}</td>
        <td>{{ comboField name="POT_GU" value=POT_GU index=index query='{"id": "Q_일단지구분갱신", "text": "CD_CODE", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ noneField name="STD_APPL_DAN" value=STD_APPL_DAN index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        ...
        <td>{{ noneField name="MA_NR_MIN_AMT" value=MA_NR_MIN_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="MA_NR_MAX_AMT" value=MA_NR_MAX_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="CO_AMT" value=CO_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="APAS_RATE" value=APAS_RATE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ maskField name="ASSESS_RATE" value=ASSESS_RATE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="APPL_RATE" value=APPL_RATE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ inputField name="ASSESS_DESC" value=ASSESS_DESC index=index options='{}' }}</td>
    </tr>
</script>
...
<script id="DBGrid_평가액_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ noneField name="POT_GU" value=POT_GU index=index options='{}' }}</td>
        <td>{{ noneField name="LOT_NUM" value=LOT_NUM index=index options='{}' }}</td>
        <td>{{ noneField name="ANNO_AMT" value=ANNO_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="STD_APPL_DAN" value=STD_APPL_DAN index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="APPL_RATE" value=APPL_RATE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="APAS_AMT" value=APAS_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="APPL_AMT" value=APPL_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="SEC_OFFER_SIZE" value=SEC_OFFER_SIZE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="INC_AMT" value=INC_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
    </tr>
</script>
...
<script id="DBGrid_담보_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ noneField name="LOT_NUM" value=LOT_NUM index=index options='{}' }}</td>
        <td>{{ noneField name="INC_AMT" value=INC_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="SEC_NUME" value=SEC_NUME index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="SEC_DENO" value=SEC_DENO index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="SEC_RATE" value=SEC_RATE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="FNL_INC_AMT" value=FNL_INC_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
    </tr>
</script>
...
<script id="DBGrid_건물단가_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <th>{{ comboField name="REGI_GU" value=REGI_GU index=index query='{"id": "Q_코드_표준지구분", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</th>
        <th>{{ noneField name="CB_FLOOR" value=CB_FLOOR index=index options='{}' }}</th>
    </tr>
</script>
...
<script id="DBGrid_건물평가액_집계표_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td class="hide">{{ noneField name="LN_SEQ" value=LN_SEQ index=index options='{}' }}</td>
        <td>{{ comboField name="REGI_GU" value=REGI_GU index=index query='{"id": "Q_코드_표준지구분", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ noneField name="CB_FLOOR" value=CB_FLOOR index=index options='{}' }}</td>
        <td>{{ noneField name="CB_BUILD_DAN" value=CB_BUILD_DAN index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="OF_JANGA_RATE" value=OF_JANGA_RATE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="APAS_DAN" value=APAS_DAN index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="APPL_DAN" value=APPL_DAN index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="SEC_OFFER_SIZE" value=SEC_OFFER_SIZE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="INC_AMT" value=INC_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
...
<script id="DBGrid_담보_건물_템플릿" type="text/x-handlebars-template">
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary text-center">
            <tr class="fw-bolder fs-7 text-gray-800">
                <th class="hide">LOT_NUM</th>
                <th class="hide">CB_DATE</th>
                <th class="hide">CB_STRUC</th>
                <th class="hide">CB_ROOF</th>
                <th class="hide">CB_FLOOR</th>
                <th class="hide">CB_USE_MAIN</th>
                <th class="hide">CB_SIZE</th>
                <th class="hide">CB_SIZE_PY</th>
                <th class="hide">SEC_REGI_SIZE</th>
                <th class="hide">SEC_OFFER_SIZE</th>
                <th class="hide">SEC_DESC</th>
                <th class="hide">YYYY</th>
...
<script id="DBGrid_담보_건물_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td class="hide">{{ noneField name="LN_SEQ" value=LN_SEQ index=index options='{}' }}</td>
        <td>{{ comboField name="REGI_GU" value=REGI_GU index=index query='{"id": "Q_코드_표준지구분", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td>{{ noneField name="INC_AMT" value=INC_AMT index=index options='{}' }}</td>
        <td>{{ noneField name="SEC_NUME" value=SEC_NUME index=index options='{}' }}</td>
        <td>{{ noneField name="SEC_DENO" value=SEC_DENO index=index options='{}' }}</td>
        <td>{{ noneField name="SEC_RATE" value=SEC_RATE index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="FNL_INC_AMT" value=FNL_INC_AMT index=index options='{}' }}</td>
    </tr>
</script>
...
<script id="DBGrid_감정가액산출내역_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td class="w-100px">{{ noneField name="POT_GU" value=POT_GU index=index options='{}' }}</td>
        <td class="w-100px">{{ noneField name="LOT_NUM" value=LOT_NUM index=index options='{}' }}</td>
...
<script id="DBGrid_감정가액산출내역_건물_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td class="hide">{{ noneField name="LN_SEQ" value=LN_SEQ index=index options='{}' }}</td>
        <td class="w-50px">{{ noneField name="NAME" value=NAME index=index options='{}' }}</td>
        <td class="w-100px">{{ comboField name="REGI_GU" value=REGI_GU index=index query='{"id": "Q_코드_표준지구분", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }}</td>
        <td class="w-150px">{{ noneField name="FNL_INC_AMT_A" value=FNL_INC_AMT_A index=index options='{"mask": "-;7;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td class="w-150px">{{ noneField name="FNL_INC_AMT" value=FNL_INC_AMT index=index options='{"mask": "-;7;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
    </tr>
</script>
...
<script id="DBGrid_배당표_상가건물_임대차보증금_계산_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td class="w-150px">{{ maskField name="STO_LSEC_AMT" value=STO_LSEC_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }} </td>
        <td class="w-100px">{{ checkField name="FXDATE_YN" value=FXDATE_YN index=index options='{ "on" : "Y", "off" : "N"}' }} </td>
        <td class="w-150px">{{ maskField name="MRENT_AMT" value=MRENT_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }} </td>
        <td class="w-150px">{{ noneField name="LEASE_AMT" value=LEASE_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }} </td>
        <td class="w-150px">{{ noneField name="REP_BE_SEC_AMT" value=REP_BE_SEC_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }} </td>
        <td class="w-150px">{{ noneField name="FXLEA_AMT" value=FXLEA_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }} </td>
        <td class="w-150px">{{ noneField name="FXLEA_NO_AMT" value=FXLEA_NO_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }} </td>
    </tr>
</script>
<%--//배당표1--%>
