...
<script id="DBGrid_가격사례_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td class="hide">{{ noneField name="월관리비" value=월관리비 index=index options='{}' }}</td>
        ...
        <td>{{ comboField name="업무용여부" value=업무용여부 index=index query='{"id" : "Q_DUAL_여부", "text" : "CD_DESC", "value" : "CD_CODE"}' options='{}' }}</td>
        <td>{{ comboField name="이용상황" value=이용상황 index=index query='{"id" : "Q_DUAL_이용상황", "text" : "CD_DESC", "value" : "CD_CODE"}' options='{}' }}</td>
        ...
        <td>{{ noneField name="경과년도" value=경과년도 index=index options='{"textType": "text-center"}' }}</td>
        ...
        <td>{{ maskField name="보증금" value=보증금 index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ maskField name="월임대료" value=월임대료 index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType": "text-end"}' }}</td>
...
<script id="DBGrid_경매사례_템플릿_ROW" type="text/x-handlebars-template">
    <tr class="">
        ...
        <td>{{ inputField name="경매사건번호" value=경매사건번호 index=index options='{"textType": "text-center"}' }}</td>
        <td>{{ inputField name="소재지" value=소재지 index=index options='{"textType": "text-start"}' }}</td>
        <td>{{ buttonField name="주소팝업" value="주소팝업" index=index options='{ "iconType" : "search" }' }}</td>
        <td>{{ comboField name="업무용여부" value=업무용여부 index=index query='{"id" : "Q_DUAL_여부", "text" : "CD_DESC", "value" : "CD_CODE"}' options='{}' }}</td>
        <td>{{ comboField name="이용상황" value=이용상황 index=index query='{"id" : "Q_DUAL_이용상황", "text" : "CD_DESC", "value" : "CD_CODE"}' options='{}' }}</td>
        <td>{{ maskField name="전용면적" value=전용면적 index=index options='{"mask": "-;7;#,###1.00", "maskType": "숫자","textType": "text-end"}' }} </td>
        <td>{{ comboField name="층수_코드" value=층수_코드 index=index query='{"id" : "Q_00_전유부분의위치", "text" : "CD_DESC", "value" : "CD_CODE"}' options='{}' }}</td>
        <td>{{ noneField name="층수_비준율" value=층수_비준율 index=index options='{"textType": "text-end"}' }}</td>
        <td>{{ comboField name="위치" value=위치 index=index query='{"id" : "Q_00_위치별", "text" : "CD_DESC", "value" : "CD_CODE"}' options='{}' }}</td>
        <td>{{ comboField name="용도지역" value=용도지역 index=index query='{"id" : "Q_00_용도지역", "text" : "CD_DESC", "value" : "CD_CODE"}' options='{}' }}</td>
        <td>{{ maskField name="건축년도" value=건축년도 index=index options='{"mask": "####", "maskType": "문자", "textType": "text-center"}' }}</td>
        <td>{{ noneField name="경과년도" value=경과년도 index=index options='{"textType": "text-center"}' }}</td>
    ...
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary text-nowrap">
            <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle">
                ...
                <th class="min-w-250px" rowspan="2">층수</th>
                <th class="min-w-100px" rowspan="2">비준율</th>
                <th class="min-w-100px" rowspan="2">전용면적(㎡)</th>
                <th class="col-6" colspan="3">시세조사내역</th>
                <th class="col-2" rowspan="2">m<sup>2</sup>당 단가</th>
                <th class="col-4" colspan="2">임대내용</th>
            </tr>
...
<script id="DBGrid_본건사례_템플릿_ROW" type="text/x-handlebars-template">
    <tr class="">
        ...
        <td>{{ noneField name="층수_비준율" value=층수_비준율 index=index options='{"mask": "-;7;#,###1.00", "maskType": "숫자", "textType" :"text-end"}' }}</td>
        <td>{{ maskField name="전용면적" value=전용면적 index=index options='{"mask": "-;7;#,###1.00", "maskType": "숫자", "textType" :"text-end"}' }}</td>
        <td>{{ maskField name="최저가" value=최저가 index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType" :"text-end"}' }}</td>
        <td>{{ maskField name="최고가" value=최고가 index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType" :"text-end"}' }}</td>
        <td>{{ noneField name="평균가격" value=평균가격 index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType" :"text-end"}' }}</td>
        <td>{{ noneField name="M2당단가" value=M2당단가 index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType" :"text-end"}' }}</td>
        <td>{{ maskField name="보증금" value=보증금 index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType" :"text-end"}' }}</td>
        <td>{{ maskField name="월임대료" value=월임대료 index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType" :"text-end"}' }}</td>
    </tr>
</script>
    ...
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary text-nowrap">
            <tr class="fw-bolder fs-7 text-gray-800 text-center">
                ...
                <th>사례구분</th>
                <th class="col-1">사례번호</th>
                <th class="col-2">요인합계</th>
                <th class="col-3">시점수정</th>
                <th class="col-3">적용단가</th>
            </tr>
        <tbody>
            {{#each .}}
...
<script id="DBGrid_비준가격_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td class="hide">{{ noneField name="가격_본건_적용율" value=가격_본건_적용율 index=index options='{}' }}</td>
        ...
        <td>{{ noneField name="가격_사례_일자" value=가격_사례_일자 index=index options='{"mask": "yyyy-mm-dd", "maskType": "날짜", "textType": "text-start"}' }}</td>
    ...
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary text-nowrap">
            <tr class="fw-bolder fs-7 text-gray-800 align-middle text-center">
                ...
                <th class="w-250px" rowspan="2" class="col-2">소재지</th>
                <th rowspan="2">시점수정</th>
                <th colspan="6">개별비교</th>
                <th rowspan="2">요인합계</th>
...
<script id="DBGrid_비준가격집계표_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ noneField name="가격_비교치" value=가격_비교치 index=index options='{"mask": "-;12;#,###1.000", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="층별비교_비교치" value=층별비교_비교치 index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="위치별비교_비교치" value=위치별비교_비교치 index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="잔가율비교_비교치" value=잔가율비교_비교치 index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="도로조건_비교치" value=도로조건_비교치 index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="접근조건_비교치" value=접근조건_비교치 index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="기타조건_비교치" value=기타조건_비교치 index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
        <td>{{ noneField name="요인합계" value=요인합계 index=index options='{"mask": "-;12;#,###1.00", "maskType": "숫자", "textType": "text-end"}' }}</td>
...
<script id="DBGrid_배당표_주택임대차보증금_계산_템플릿" type="text/x-handlebars-template">
    <table class="table table-row-bordered table-rounded border gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary text-nowrap">
            <tr class="fw-bolder fs-7 text-gray-800 bg-secondary text-center align-middle">
...
<script id="DBGrid_배당표_주택임대차보증금_계산_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ inputField name="RESI_NAME" value=RESI_NAME index=index options='{"textType": "text-start"}' }} </td>
        ...
        <td>{{ maskField name="POSS_A_RM_CNT" value=POSS_A_RM_CNT index=index options='{"textType": "text-center"}' }} </td>
        <td>{{ maskField name="LEASE_AMT" value=LEASE_AMT index=index options='{"mask": "-;12;#,###1", "maskType": "숫자", "textType" : "text-end"}' }} </td>
        <td>{{ noneField name="REP_BE_SEC_AMT" value=REP_BE_SEC_AMT index=index options='{"textType": "text-end"}' }} </td>
        <td>{{ noneField name="FXLEA_AMT" value=FXLEA_AMT index=index options='{"textType": "text-end"}' }} </td>
...
<script id="DBGrid_배당표_상가건물_임대차보증금_계산_템플릿" type="text/x-handlebars-template">
    <table class="table table-row-bordered table-rounded border gs-5 gy-3 gx-5">
        <thead class="align-top bg-secondary text-nowrap">
            <tr class="fw-bolder fs-7 text-gray-800 bg-secondary text-center align-middle text-nowrap">
                <th class="hide">YYYY</th>
                <th class="hide">SEQ</th>
                <th class="hide">REP_AF_SEC_AMT</th>
                <th>각구의<br>일련번호</th>
...
<script id="DBGrid_배당표_상가건물_임대차보증금_계산_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td class="hide">{{ noneField name="REP_AF_SEC_AMT" value=REP_AF_SEC_AMT index=index options='{}' }} </td>
        <td>{{ comboField name="RNO" value=RNO index=index query='{"id": "Q_코드_각구의일련번호", "text": "CD_DESC", "value": "CD_CODE"}' options='{}' }} </td>
        <td>{{ inputField name="C_DESC" value=C_DESC index=index options='{"textType": "text-end"}' }} </td>
        <td>{{ checkField name="POSS_YN" value=POSS_YN index=index options='{ "on" : "Y", "off" : "N"}' }} </td>
        <td>{{ inputField name="HIR_NAME" value=HIR_NAME index=index options='{"textType": "text-end"}' }} </td>
        <td>{{ maskField name="STO_LSEC_AMT" value=STO_LSEC_AMT index=index options='{"textType": "text-end"}' }} </td>
        <td>{{ checkField name="FXDATE_YN" value=FXDATE_YN index=index options='{ "on" : "Y", "off" : "N"}' }} </td>
        <td>{{ maskField name="MRENT_AMT" value=MRENT_AMT index=index options='{"textType": "text-end"}' }} </td>
        <td>{{ noneField name="LEASE_AMT" value=LEASE_AMT index=index options='{"textType": "text-end"}' }} </td>
        <td>{{ noneField name="REP_BE_SEC_AMT" value=REP_BE_SEC_AMT index=index options='{"textType": "text-end"}' }} </td>
        <td>{{ noneField name="FXLEA_AMT" value=FXLEA_AMT index=index options='{"textType": "text-end"}' }} </td>
        <td>{{ noneField name="FXLEA_NO_AMT" value=FXLEA_NO_AMT index=index options='{"textType": "text-end"}' }} </td>
    </tr>
</script>


<script id="DBGrid_배당금_계산_템플릿" type="text/x-handlebars-template">
    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5 text-center">
        <thead class="align-top bg-secondary text-nowrap">
            <tr class="fw-bolder fs-7 text-gray-800">
...
<script id="DBGrid_배당금_계산_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ comboField name="DISP_RANK" value=DISP_RANK index=index query='{"id": "Q_코드_순위", "text": "CD_DESC", "value": "CD_CODE"}' isEnable=IS_ENABLE options='{"textType": "text-center"}' }} </td>
        ...
        <td>{{ inputField name="RIGHT_PERSON" value=RIGHT_PERSON index=index isEnable=IS_ENABLE options='{"textType": "text-start"}' }} </td>
        <!-- combo 조건 확인필요 -->
...
<script id="DBGrid_사진관리_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <th>{{ inputField name="PHOTO_NAME" value=PHOTO_NAME index=index options='{"textType": "text-start"}' }} </th>
        <th>{{ noneField name="FILE_NAME" value=FILE_NAME index=index options='{"textType": "text-start"}' }} </th>
        <th class="text-center">{{ buttonField name="찾기" value="찾기" index=index options='{ "iconType" : "button" }' }} </th>
        <th>{{ inputField name="REMARK" value=REMARK index=index options='{"textType": "text-start"}' }} </th>
    </tr>
</script>
...
<script id="DBGrid_문서_템플릿_ROW" type="text/x-handlebars-template">
    <tr>
        ...
        <td>{{ inputField name="PHOTO_NAME" value=PHOTO_NAME index=index options='{"textType": "text-start"}' }} </td>
        <td>{{ noneField name="FILE_NAME" value=FILE_NAME index=index options='{"textType": "text-start"}' }} </td>
        <td class="text-center">{{ buttonField name="찾기" value="찾기" index=index options='{ "iconType" : "button" }' }}  </td>
        <td>{{ inputField name="REMARK" value=REMARK index=index options='{"textType": "text-start"}' }} </td>
    </tr>
</script>
