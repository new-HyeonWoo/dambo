...
<%@ include file="/WEB-INF/jsp/template/es03_w01.jsp" %>

<script type="text/javascript">
    componentsMap.set('page', PageType.공통);
    componentsMap.set('es', EsType.ES03W01);
...
<script src="/resources/js/es03/variable/es03_w01.js"></script>
<script src="/resources/js/es03/macro/es03_w01.js"></script>
<script src="/resources/js/es03/page/es03_w01.js"></script>
<script src="/resources/js/es03/zoon/es03_w01.js"></script>
        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">조건별검색</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">조건별검색</li>
                    </ul>
                </div>
            </div>
        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-1 align-self-center">
                                                                    <div class="form-check form-check-custom form-check-warning form-check-solid form-check-sm justify-content-center">
                                                                        <input class="form-check-input" type="checkbox" value="A" id="Check_소재지" />
                                                                ...
                                                                <div class="col-8">
                                                                    <textarea class="form-control fs-7 min-h-100px h-auto" id="Label_소재지" readonly="readonly"></textarea>
                                                                </div>
                                                            </div>
                                                        </th>
                                                    </tr>
                                                        ...
                                                        <th class="fw-bolder bg-white" colspan="2">
                                                            <div class="row">
                                                                <div class="col-2">
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" id="Edit_최종평가가격_최저" class="form-control form-control-transparent py-0 ps-0 text-end fs-7 min-w-100" value="" disabled="disabled" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                ...
                                                                <div class="col-2">
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" id="Edit_최종평가가격_최고" class="form-control form-control-transparent py-0 ps-0 text-end fs-7 min-w-100" value="" disabled="disabled" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                                        </div>
                                                        ...
                                                        <th class="fw-bolder bg-white" colspan="2">
                                                            <div class="row">
                                                                <div class="col-2">
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" id="Edit_낙찰가율_최저" class="form-control form-control-transparent py-0 ps-0 text-end fs-7 min-w-100" value="" disabled="disabled" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                ...
                                                                <div class="col-2">
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" id="Edit_낙찰가율_최고" class="form-control form-control-transparent py-0 ps-0 text-end fs-7 min-w-100" value="" disabled="disabled" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">%</span>
                                                                        </div>
                                                    ...
                                                    <tr class="fs-7 text-gray-800 text-center">
                                                        ...
                                                        <th class="bg-white" colspan="2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-8">
                                                                    <textarea class="form-control fs-7 min-h-100px h-auto" id="Label_담보종류" readonly="readonly"></textarea>
                                                                </div>
                                                            </div>
                                                        </th>
                                                    </tr>
                                                        ...
                                                        <th class="bg-white" colspan="2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-2">
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" id="Edit_면적_건물_최저" class="form-control form-control-transparent py-0 ps-0 text-end fs-7 min-w-100" value="" disabled="disabled" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">m<sup>2</sup></span>
                                                                        </div>
                                                                ...
                                                                <div class="col-2">
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" id="Edit_면적_건물_최고" class="form-control form-control-transparent py-0 ps-0 text-end fs-7 min-w-100" value="" disabled="disabled" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">m<sup>2</sup></span>
                                                                        </div>
                                                    ...
                                                    <tr class="fs-7 text-gray-800 text-center">
                                                        ...
                                                        <th class="bg-white" colspan="2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-8">
                                                                    <textarea class="form-control fs-7 min-h-100px h-auto" id="Label_지목별" readonly="readonly"></textarea>
                                                                </div>
                                                            </div>
                                                        </th>
                                                    </tr>
                                                        ...
                                                        <th class="bg-white text-start" colspan="2">
                                                            <div class="d-flex">
                                                                <div class="form-check form-check-custom form-check-warning form-check-solid form-check-sm">
                                                                    <input class="form-check-input" type="radio" name="Group_자체및업소" id="Option_전체" value="A">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="border rounded p-3 pb-1">
                                                    <input id="Edit_조회건수" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100 transparent"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-2"></div>
