...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            opener.GetComponent('Picture1').rebind($('#Picture1'));
            opener.GetComponent('Command_선택').rebind($('#Command_선택'));
    ...
    <div class="card card-flush shadow-sm">
        <div class="card-header">
            ...
            <div class="card-toolbar align-items-center gap-2 gap-lg-3">
                <button type="button" class="btn btn-sm btn-outline btn-outline-dashed btn-outline-default" id="Picture1">조회</button>
                <button type="button" class="btn btn-sm btn-outline btn-outline-dashed btn-outline-default" id="Command_선택">선택</button>
            </div>
        </div>
