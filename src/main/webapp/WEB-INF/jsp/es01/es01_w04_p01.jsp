...
<%--                                                            <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 text-start min-w-100 border rounded-0" id="#">--%>
                                                    ...
                                                    <tr class="fw-bolder fs-7 text-gray-800">
                                                        ...
                                                        <th rowspan="2">예정액</th>
                                                        <th colspan="3" class="bg-white text-end" data-type="price" id="당사설정금액">
<%--                                                            <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 text-start min-w-100 border rounded-0" id="#">--%>
                                                        </th>
                                                    </tr>
                                                    <tr class="fw-bolder fs-7 text-gray-800">
                                                        <th>건물</th>
                                                        <th colspan="3" class="bg-white text-end" data-type="price" id="건물_당사설정금액">
                                                    </tr>
                                                    <tr class="fw-bolder fs-7 text-gray-800">
