                ...
                <div class="d-flex flex-stack flex-wrap gap-4 ">
                    <div class="d-flex align-items-center flex-wrap gap-3">
                        <div class="d-flex align-items-center fw-bolder">
                            ...
                            <div id="Combo_집합건물종류" class="mx-2"></div>
                        </div>
                        <div class="d-flex align-items-center fw-bolder mx-2">
                            <div class="text-muted fs-7 text-nowrap">담보종류</div>
                            <div id="Combo_사업부문" class="mx-2"></div>
                        </div>
                        <div class="d-flex align-items-center fw-bolder mx-2">
                            <div class="text-muted fs-7 text-nowrap">링크사이트</div>
                            <div id="Combo_링크사이트" class="mx-2"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex flex-stack flex-wrap gap-4">
                    <div class="d-flex align-items-center flex-wrap gap-3">
                        <div class="d-flex align-items-center fw-bolder">
                            ...
                            <input id="MkEdit_감정일" type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 text-center mx-2 w-auto" value="" disabled="disabled"/>
                        </div>
                        <div class="d-flex align-items-center fw-bolder">
                            <div class="text-muted fs-7 text-nowrap">감정자</div>
                            <input id="Edit_감정자" type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 text-center mx-2 w-auto" value="" disabled="disabled"/>
                        </div>
                        <div class="d-flex align-items-center fw-bolder">
                            <div class="text-muted fs-7 text-nowrap">담보건물명</div>
                            <input id="Edit_Doc_Name" type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 text-center mx-2 w-auto" value="" disabled="disabled"/>
                            ...
                            <div class="table-responsive">
                                <table class="table table-row-bordered border table-hover align-middle gs-5 gy-3 gx-5">
                                    <thead class="bg-secondary align-middle">
                                        <tr class="fw-bolder fs-7 text-gray-800 dis">
                                            <th>1. 제1차 거래처</th>
                                            <th class="bg-white">
                                                <div class="row">
                                                    <div class="col-3">
                                                        <input id="Edit_거래처코드" type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end" value="" disabled="disabled"/>
                                                    </div>
                                                    <div class="col-9">
                                                        <div class="d-flex flex-column-fluid">
                                                            <input type="text" id="Edit_거래처" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end" value="" disabled="disabled"/>
                                            ...
                                            <th>대표자</th>
                                            <th class="bg-white">
                                                <input type="text" id="Edit_대표자" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end" value="" disabled="disabled">
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="bg-white">
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                        <div class="d-flex flex-column-fluid">
                                                            <input id="Edit_업소명" type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end" value=""/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </th>
                                            <th>대표자</th>
                                            <th class="bg-white">
                                                <input type="text" id="Edit_업소대표자" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end" value="">
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            <th>3. 채무자</th>
                                            <th class="bg-white">
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                        <div class="d-flex flex-column-fluid">
                                                            <input type="text" id="Edit_채무자" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end" value=""/>
                                                        </div>
                                                    </div>	
                                                </div>
                                            </th>
                                            <th>5. 채무자와 담보제공자의 관계</th>
                                            <th class="bg-white">
                                                <input type="text" id="Edit_채무자와담보제공자의관계" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end " value=""/>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            <th>4. 담보제공자</th>
                                            <th class="bg-white">
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                        <div class="d-flex flex-column-fluid">
                                                            <input type="text" id="Edit_담보제공자" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end" value=""/>
                                                        </div>   
                                                    </div>	
                                                </div>
                                            </th>
                                            <th>6. 이 담보물에 대한 재감정 여부</th>
                                            <th class="bg-white">
                                                <input type="text" id="Edit_재감정여부" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end " value="" disabled="disabled"/>
                                            </th>
                                        </tr>
                                    </thead>
                                </table>
                        ...
                        <div class="border rounded p-5 pb-1">
                                    ...
                                    <thead class="bg-secondary align-middle">
                                        ...
                                        <tr class="fw-normal fs-7 text-gray-800">
                                            <th class="bg-white" colspan="4">
                                                <div class="d-flex flex-column-fluid">
                                                    <input type="text" id="Edit_소재지" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end size-min-width-80 w-auto" value="" disabled="disabled"/>
                                            ...
                                            <th class="bg-white">
                                                <input type="text" id="Edit_지번" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end" value=""/>
                                            </th>
                                            <th class="bg-white">
                                                <input type="text" id="Edit_집합건물의명칭" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end" value=""/>
                                            </th>
                                            <th class="bg-white">
                                                <input type="text" id="Edit_동수" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end" value=""/>
                                            </th>
                                            <th class="bg-white">
                                                <input type="text" id="Edit_호수" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end" value=""/>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800 text-center text-nowrap">
                                            <th colspan="2">지목</th>
                                            <th colspan="2">대지권목적인 일단의 토지 전체의 면적</th>
                                            <th colspan="2">대지권 소유권 /추정세대수 / 추정평</th>
                                            <th colspan="2">가임대보증금 적용지역</th>
                                        </tr>
                                        <tr class="fw-normal fs-7 text-gray-800 bg-white">
                                            ...
                                            <th colspan="2">
                                                <input type="text" id="MkEdit_토지권의목적인" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end " value=""/>
                                            </th>
                                            <th colspan="2">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <input type="text" id="Edit_대지권소유권" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end" value=""/>
                                                    </div>
                                                    <div class="col-3">
                                                        <input type="text" id="Formula1" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end" value="" disabled="disabled"/>
                                                    </div>
                                                    <div class="col-3">
                                                        <input type="text" id="Edit_대지권소유권_평" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end" value="" disabled="disabled"/>
                                                    </div>
                                                </div>
                                            </th>
                                            <th colspan="2">
                            ...
                            <div class="table-responsive">
                                <table class="table table-row-bordered border table-hover gs-5 gy-3 gx-5">
                                    <thead class="bg-secondary align-middle">
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            <th colspan="9">2. 집합건물에 관한 사항</th>
                                        </tr>
                                        <tr class="fs-7 text-gray-800 text-center fw-bolder">
                                            <th colspan="9">전체 규모 및 전용부분의 위치</th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                            <th>구조</th>
                                            <th>지붕</th>
                                        ...
                                        <tr class="fw-normal fs-7 text-gray-800 bg-white">
                                            ...
                                            <th>
                                                <input type="text" id="Edit_지상" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                            </th>
                                            <th>
                                                <input type="text" id="Edit_지하" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                            </th>
                                            <th>
                                                <input type="text" id="Edit_해당층" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                            </th>
                                            <th colspan="3">
                                                <div class="row">
                                                    <div class="col-8">
                                                        <input type="text" id="MkEdit_건축일자" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                                    </div>
                                                    <div class="col-4">
                                                        <div class="row">
                                                            <div class="col-8">
                                                                <input type="text" id="MkEdit_건축년도_경과" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled"/>
                                                            </div>
                                                            <div class="col-4">
                                            ...
                                            <th class="col-md-1">
                                                <input type="text" id="MkEdit_세대수" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                            </th>
                                        </tr>
                                        <tr class="fw-normal fs-7 text-gray-800 text-center">
                                            <th class="col-md-1 fw-bolder text-nowrap">
                                                전유면적
                                            </th>
                                            <th class="col-md-1 bg-white">
                                                <div class="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_전유면적" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                                    </div>
                                            ...
                                            <th class="col-md-1 bg-white">
                                                <div class="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_전유면적_평" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled"/>
                                                    </div>
                                                    <div class="col-3 text-nowrap">
                                            ...
                                            <th class="col-md-1 bg-white">
                                                <div class="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_공유면적" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                                    </div>	
                                                    <div class="col-3 text-nowrap">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">m<sup>2</sup></span>
                                                    </div>
                                            ...
                                            <th class="col-md-1 bg-white">
                                                <div class="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_공유면적_평" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled"/>
                                                    </div>
                                                    <div class="col-3 text-nowrap">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">평</span>
                                                    </div>
                                            ...
                                            <th class="col-md-1 bg-white">
                                                <div class="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_면적합계" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled"/>
                                                    </div>
                                                    <div class="col-3 text-nowrap">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">m<sup>2</sup></span>
                                                    </div>
                                            ...
                                            <th class="col-md-1 bg-white">
                                                <div class="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_면적합계_평" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled"/>
                                                    </div>
                                                    <div class="col-3 text-nowrap">
                                ...
                                <table class="table table-row-bordered border table-hover gs-5 gy-3 gx-5">
                                    <thead class="bg-secondary align-middle text-nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td class="bg-white">
                                                <input type="text" id="Edit_국토의계획" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="col-md-3 fs-7 fw-bolder">다른 법률등에 따른 지역·지구들</td>
                                            <td class="bg-white">
                                                <input type="text" id="Edit_다른법률등" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="col-md-3 fs-7 fw-bolder">시행령 부칙 제3조에 따른 추가기재확인 내용</td>
                                            <td class="bg-white">
                                                <input type="text" id="Edit_시행령부칙" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                            </td>
                                        </tr>
                                        <tr class="fs-7 text-gray-800">
                                            <th class="text-start fw-bolder" colspan="2">"토지이용규제기본법시행령" 제9조 2항 각호에 해당되는 사항</th>
                                            <td class="bg-white">
                                                <input type="text" id="Edit_토지이용규제" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                            </td>
                                        </tr>
                                    </thead>
                                </table>
                                    ...
                                    <thead class="bg-secondary align-middle">
                                        ...
                                        <tr>
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_등기부등본상의시세_총액" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                                    </div>
                                                    <div class="col-3">    
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_등기부등본상의시세_단가" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                                    </div>
                                                    <div class="col-3">    
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_등기부등본상의시세_평당단가" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                                    </div>
                                                    <div class="col-3">   
                                        ...
                                        <tr>
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_기준시가_총액" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                                    </div>
                                                    <div class="col-3">   
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_기준시가_단가" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                                    </div>
                                                    <div class="col-3">   
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원/m<sup>2</sup></span>
                                                    </div>
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_기준시가_평당단가" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                                    </div>
                                                    <div class="col-3">  
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원/평</span>
                                                    </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_등기부상전용면적" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">m<sup>2</sup></span>
                                                    </div>
                                            ...
                                            <td>
                                                <input type="text" id="MkEdit_분자" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                            </td>
                                            <td>
                                                <input type="text" id="MkEdit_분모" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                            </td>
                                            <td>
                                                <div class="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_비율" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled/>
                                                    </div>
                                                    <div class="col-3">
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-9">
                                                        <input type="text" id="MkEdit_담보제공면적" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled"/>
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">m<sup>2</sup></span>
                                                    </div>
                                            ...
                                            <td>
                                                <input type="text" id="Edit_사유" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value=""/>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                        ...
                                        <thead class="bg-secondary">
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                ...
                                                <th class="fw-normal bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_감정가액산출_건축일자" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                ...
                                                <th class="fw-normal bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_감정가액산출_세대수" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                        ...
                                        <tbody class="bg-secondary align-middle  text-center">
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                ...
                                                <td class="fw-normal bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_본건_최저가격" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                                ...
                                                <td rowspan="2" class="fw-normal bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_본건_비율" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">%</span>
                                                        </div>    
                                            ...
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                ...
                                                <td class="fw-normal bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_본건_최고가격" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                            ...
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                ...
                                                <td class="fw-normal bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_인근_최저가격" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                                ...
                                                <td rowspan="2" class="fw-normal bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_인근_비율" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100"  value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">%</span>
                                                        </div>
                                            ...
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                ...
                                                <td class="fw-normal bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_인근_최고가격" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                            ...
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                ...
                                                <td class="fw-normal bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_경매_최저가격" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                                ...
                                                <td rowspan="2" class="fw-normal bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_경매_비율" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">%</span>
                                                        </div>
                                            ...
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                ...
                                                <td class="fw-normal bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_경매_최고가격" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                            ...
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                ...
                                                <td class="fw-bolder bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_결정가격" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                            ...
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                ...
                                                <td class="fw-normal bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_보수평형_평" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">평</span>
                                                        </div>
                                                ...
                                                <td class="fw-normal bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_보수평형" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">m<sup>2</sup></span>
                                                        </div>
                                                ...
                                                <td class="bg-white">
                                                    <div class="input-group input-group-sm">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4">
                                                                <input type="text" id="MkEdit_보수단가" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                            </div>
                                                        </div>    
                                                    </div>
                                                </td>
                                            ...
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                ...
                                                <td class="fw-normal bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_보수금액" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                            ...
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                ...
                                                <td colspan="2" class="bg-white">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_평가가격" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="input-group-sm">
                                                        <input type="text" id="MkEdit_감정가_등기부상전용면적" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input-group-sm">
                                                        <input type="text" id="MkEdit_감정가_분자" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input-group-sm">
                                                        <input type="text" id="MkEdit_감정가_분모" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_감정가_비율" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">%</span>
                                                        </div>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_감정가_담보제공면적" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">평</span>
                                                        </div>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_감정가_평가가격" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_감정가_최종평가가격" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                            ...
                                            <thead class="bg-secondary">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="bg-white">
                                                        <div class="row">
                                                            <div class="col-9">
                                                                <input type="text" id="MkEdit_보정표_당해지역낙찰가율" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="" />
                                                            </div>
                                                            <div class="col-3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="bg-white">
                                                        <div class="row">
                                                            <div class="col-9">
                                                                <input type="text" id="MkEdit_보정표_유사부동산낙찰가율" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="" />
                                                            </div>
                                                            <div class="col-3">
                                                                <span class="input-group-text bg-transparent fs-7 text-danger fw-bolder border-0 p-0">%</span>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="bg-white">
                                                        <div class="row">
                                                            <div class="col-9">
                                                                <input type="text" id="MkEdit_보정표_기준낙찰가율" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="" disabled="disabled">
                                                            </div>
                                                            <div class="col-3">
                                                                <span class="input-group-text bg-transparent fs-7 text-danger fw-bolder border-0 p-0">%</span>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="bg-white">
                                                        <div class="row">
                                                            <div class="col-9">
                                                                <input type="text" id="MkEdit_보정표_적용할낙찰가율" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="" disabled="disabled">
                                                            </div>
                                                            <div class="col-3">
                                                                <span class="input-group-text bg-transparent fs-7 text-danger fw-bolder border-0 p-0">%</span>
                                                            </div>    
                                        ...
                                        <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5 mt-3">
                                            <thead class="bg-secondary">
                                                ...
                                                <tr class="fw-bolder fs-7 text-gray-800 bg-white">
                                                    <th>
                                                        <div class="row">
                                                            <div class="col-9">
                                                                <input type="text" id="MkEdit_보정표_아파트단지규모" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                            </div>
                                                            <div class="col-3">
                                                                <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">세대</span>  
                                                            </div>
                                                    ...
                                                    <th>
                                                        <div class="row">
                                                            <div class="col-9">
                                                                <input type="text" id="MkEdit_보정표_전유부분면적" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                            </div>
                                                            <div class="col-3">
                                                                <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">m<sup>2</sup></span>
                                                            </div>    
                                                    ...
                                                    <th>
                                                        <div class="input-group-sm">
                                                            <input type="text" id="Edit_보정표_전유부분위치" class="form-control form-control-transparent py-0 ps-0 text-end min-w-100 fs-7" value="" disabled="disabled">
                                                        </div>
                                                    </th>
                                                    <th>
                                                        <div class="row">
                                                            <div class="col-9">
                                                                <input type="text" id="MkEdit_보정표_건축물의경과년도" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                            </div>
                                                            <div class="col-3">
                                                                <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">년경과</span>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="input-group-sm">
                                                            <input type="text" id="MkEdit_보정표_아파트단지규모_적용율" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="input-group-sm">
                                                            <input type="text" id="MkEdit_보정표_전유부분면적_적용율" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-4">
                                                                <input type="text" id="Edit20" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                            </div>
                                                            <div class="col-8">
                                                                <input type="text" id="MkEdit_보정표_전유부분위치_적용율" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                            </div>      
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="input-group-sm">
                                                            <input type="text" id="MkEdit_보정표_건축물의경과년도_적용율" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5 mt-3">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="input-group-sm">
                                                            <input type="text" id="MkEdit_보정표_점유자의권리형태" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_보정표_평가가격" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_보정표_최저입찰가" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <input type="text" id="MkEdit_보정표_예상낙찰가" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                        </div>
                                                        <div class="col-3">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                    ...
                                    <thead class="align-middle bg-secondary">
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_사항_청구금액">
                                                    </div>
                                                    <div class="col-3">
                                    ...
                                    <thead class="align-middle bg-secondary">
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800 bg-white">
                                                    <div class ="row">
                                                        <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_내용_토지_금액" />
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>        
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_내용_토지_단가" disabled="disabled"/>
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_내용_토지_단가_평당" disabled="disabled"/>
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_내용_건물_금액" />
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>     
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_내용_건물_단가" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_내용_건물_단가_평당" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>            
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_내용_법원감정가합계" disabled="disabled"/>
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_내용_입찰예정가_금액" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>     
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_내용_입찰예정가_낙찰가율" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">%</span>
                                                    </div>    
                                    ...
                                    <thead class="align-middle bg-secondary">
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_집계표_최고채권액">
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_집계표_최고채권액Combo_Value">
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>        
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th colspan="2" class="fw-normal fs-7 col-md-4 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_집계표_선순위자채권최고액">
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_집계표_선순위자배당금">
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th colspan="2" class="fw-normal fs-7 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_집계표_당사채권최고액">
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_집계표_당사배당금">
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th colspan="2" class="fw-normal fs-7 text-gray-800 bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" id="응찰_집계표_당사미회수채권액">
                                                    </div>
                                                    <div class="col-3">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>       
                                    ...
                                    <thead class="bg-secondary">
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal bg-white">
                                                <div class="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_배당표_예상낙찰가" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                    </div>
                                                    <div class="col-3">    
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal bg-white">
                                                <div class="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_배당표_경락가액" class="form-control form-control-transparent fs-7 py-0 ps-0 text-end min-w-100" value="" disabled="disabled">
                                                    </div>
                                                    <div class="col-3">    
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>       
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800 text-nowrap">
                                            <th colspan="7">2-1. 가임대보증금 적용 범위</th>
                                            <th colspan="2">2-2. 적용할 주택가임대보증금액 (최우선변제 소액임대차보증금) 한도액</th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800 bg-white">
                                            ...
                                            <th colspan="2" class="fw-normal">
                                                <div class="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_배당표_적용할주택가임대보증금액" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="" disabled="disabled">
                                                    </div>
                                                    <div class="col-3">   
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
                                    ...
                                    <tbody class="bg-secondary">
                                        <tr>
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_공통보고서_지점_최저가" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="" disabled="disabled"/>
                                                    </div>
                                                    <div class="col-3">    
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_공통보고서_본사_최저가" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="0" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">  
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
                                        ...
                                        <tr>
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_공통보고서_지점_최고가" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="0" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">  
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_공통보고서_본사_최고가" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="0" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">  
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
                                        ...
                                        <tr>
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_공통보고서_지점_평가가격" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="0" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">  
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>   
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_공통보고서_본사_평가가격" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="0" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">  
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_공통보고서_지점_예상낙찰가율" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="0" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">  
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">%</span>
                                                    </div>   
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_공통보고서_본사_예상낙찰가율" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="0" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">  
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">%</span>
                                                    </div>       
                                        ...
                                        <tr>
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_공통보고서_지점_예상낙찰가" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="0" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">  
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>      
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_공통보고서_본사_예상낙찰가" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="0" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">  
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_공통보고서_지점_당사설정액" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="0" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">  
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_공통보고서_본사_당사설정액" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="0" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">  
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>   
                                        ...
                                        <tr>
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_공통보고서_지점_초과부족설정분" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="0" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3">  
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
                                            ...
                                            <td class="bg-white">
                                                <div class ="row">
                                                    <div class="col-9">
                                                        <input type="text" id="Edit_공통보고서_본사_초과부족설정분" class="form-control form-control-transparent fs-7 py-0 ps-0 mx-2 text-end min-w-100" value="0" disabled="disabled" />
                                                    </div>
                                                    <div class="col-3"> 
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                    </div>    
