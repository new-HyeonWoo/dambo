...
<script src="/resources/js/ezgen/variable/es01_w02_4.js"></script>
<script src="/resources/js/ezgen/macro/es01_w02_4.js"></script>
<script src="/resources/js/ezgen/page/es01_w02_4.js"></script>
<script src="/resources/js/ezgen/zoon/es01_w02_4.js"></script>
        ...
        <div class="row">
            <div class="col-3">
                <div class="d-flex align-items-center justify-content-start gap-4 mb-2 text-nowrap">
                    ...
                    <a href="javascript:void(0)" id="Picture65_저장" class="btn btn-sm btn-flex btn-white btn-active-primary fw-bolder">
                        <i class="fas fa-file-alt"></i>저장
                    </a>
                    <a href="javascript:void(0)" id="Picture66_배당처리" class="btn btn-sm btn-flex btn-white btn-active-primary fw-bolder">
                        <i class="fas fa-file-alt"></i>배당처리
                    </a>
                    <a href="javascript:void(0)" id="Picture72_배당자료수정" class="btn btn-sm btn-flex btn-white btn-active-primary fw-bolder">
        ...
        <div class="card">
            <div class="card-body">
                <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6" id="TabControl1">
                    ...
                    <!-- <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#kt_tab_pane_10">탁상감정</a>
                    </li> -->
                </ul>
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
                        ...
                        <div class="border rounded p-5 pb-1">
                            <div class="table-responsive">
                                <table class="table table-row-bordered border table-hover gs-5 gy-3 gx-5">
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center text-nowrap">
                                        ...
                                        <th>대지권 소유권</th>
                                        <th colspan="4">(주택,상가)가임대보증금 적용지역</th>
                                    </tr>
                                    ...
                                    <thead class="bg-secondary align-middle">
                                        ...
                                        <tr class="fs-7 text-gray-800 text-center fw-bolder text-nowrap">
                                            ...
                                            <th class="bg-white min-w-150px">
                                                <div class="row">
                                                    <div class="col-10">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="MkEdit_입력표_전유면적"/>
                                                    </div>
                                                    <div class="col-2">
                                            ...
                                            <th class="bg-white min-w-150px">
                                                  <div class="row">
                                                    <div class="col-10">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="MkEdit_입력표_전유면적_평"/>
                                                    </div>
                                                    <div class="col-2">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">평</span>
                                                    </div>
                                        ...
                                        <tr class="fw-normal fs-7 text-gray-800 bg-white">
                                            ...
                                            <th rowspan="2">
                                                <div class="row">
                                                    <div class="col-10">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end" id="MkEdit_입력표_내용연수"/>
                                                    </div>
                                                    <div class="col-2">
                                            ...
                                            <th class="bg-white">
                                                <div class="row">
                                                    <div class="col-10">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="MkEdit_입력표_공유면적"/>
                                                    </div>
                                                    <div class="col-2">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">m<sup>2</sup></span>
                                                    </div>
                                            ...
                                            <th class="bg-white">
                                                  <div class="row">
                                                    <div class="col-10">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="MkEdit_입력표_공유면적_평"/>
                                                    </div>
                                                    <div class="col-2">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">평</span>
                                                    </div>
                                        ...
                                        <tr class="fw-normal fs-7 text-gray-800 bg-white">
                                            ...
                                            <th class="bg-white">
                                                <div class="row">
                                                    <div class="col-10">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="MkEdit_입력표_면적합계"/>
                                                    </div>
                                                    <div class="col-2">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">m<sup>2</sup></span>
                                                    </div>
                                            ...
                                            <th class="bg-white">
                                                  <div class="row">
                                                    <div class="col-10">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="MkEdit_입력표_면적합계_평"/>
                                                    </div>
                                                    <div class="col-2">
                                                        <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">평</span>
                                                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-row-bordered border table-hover gs-5 gy-3 gx-5">
                                    <thead class="bg-secondary align-middle">
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            <th colspan="8">3. 오피스텔에 관한 사항</th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                            <th class="col-1">용도</th>
                                            <th class="col-1">바닥난방</th>
                                        ...
                                        <tr class="fs-7 text-gray-800 bg-white">
                                            <th rowspan="2">
                                                <div id="Combo_입력표_용도"></div>
                                            </th>
                                            <th rowspan="2">
                                                <div id="Combo_입력표_바닥난방"></div>
                                            </th>
                                            <th>
                                                <div class="row">
                                                    <div class="col-7">
                                            ...
                                            <th rowspan="2">
                                                <div class="row">
                                                    <div class="col-8">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 text-start min-w-100" id="Edit_입력표_기타조건"/>
                                                    </div>
                                                    <div class="col-4">
                                        ...
                                        <tr class="fs-7 text-gray-800 bg-white">
                                            <th>
                                                <div class="row">
                                                    <div class="col-6"></div>
                                                    <div class="col-6">
                                                        <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end" id="MkEdit_입력표_층별지수"/>
                                                    </div>
                                                </div>
                                            </th>
                                            <th>
                        ...
                        <div class="border rounded p-5 pb-1">
                            <div class="table-responsive">
                                <table class="table table-row-bordered border gs-5 gy-3 gx-5 text-nowrap">
                                    <thead class="bg-secondary align-middle">
                                        <tr class="fw-bolder fs-7 text-gray-800 text-center">
                    ...
                    <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
                        ...
                        <div id="kt_content_container">
                            ...
                            <div class="border rounded p-5 pb-1">
                                ...
                                <div class="table-responsive table-loading" id="DBGrid_본건사례"></div>
                            </div>
                            <div class="my-5"></div>
                            <div class="border rounded p-5 pb-1">
                                ...
                                <div class="table-responsive table-loading" id="DBGrid_가격사례"></div>
                            </div>
                            <div class="my-5"></div>
                            <div class="border rounded p-5 pb-1">
                                <div class="d-flex justify-content-between mb-3">
                                            ...
                                            <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
                                                <thead class="align-top bg-secondary text-center text-nowrap align-middle">
                                                    ...
                                                    <tr class="fw-bolder fs-7 text-gray-800">
                                                        ...
                                                        <th class="fw-normal">
                                                            <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 text-end min-w-100" id="MkEdit_비준_사례가격" value="" />
                                                        </th>
                                                        <th class="fw-normal"></th>
                                                    </tr>
                                                    <tr class="fw-bolder fs-7 text-gray-800">
                                                        ...
                                                        <th class="fw-normal">
                                                            <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 text-end min-w-100" id="MkEdit_비준_가격_비교" />
                                                        </th>
                                                    </tr>
                                                    <tr class="fw-bolder fs-7 text-gray-800">
                                                        <th>
                                                        ...
                                                        <th>
                                                            <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 min-w-100" id="비준_Label_시점_사례_경과일" />
                                                        </th>
                                                        <th></th>
                                                    </tr>
                                                    <tr class="fw-bolder fs-7 text-gray-800">
                                    ...
                                    <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
                                        <thead class="align-top bg-secondary text-center align-middle">
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                ...
                                                <th rowspan="2" class="col-1">최저/최고비율(%)</th>
                                            </tr>
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                <th>총액</th>
                                            ...
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                <th rowspan="2">인근 가격사례</th>
                                                <th>최저가격</th>
                                                <th class="fw-normal bg-white">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_평가_가격_최저_총액" >
                                                </th>
                                                <th class="fw-normal bg-white">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_평가_가격_최저_단가" >
                                                </th>
                                                <th rowspan="2" class="fw-normal bg-white">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_평가_가격_비율" >
                                                </th>
                                            </tr>
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                <th>최고가격</th>
                                                <th class="fw-normal bg-white">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_평가_가격_최고_총액" >
                                                </th>
                                                <th class="fw-normal bg-white">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_평가_가격_최고_단가" >
                                                </th>
                                            </tr>
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                <th rowspan="2">경매사례</th>
                                                <th>최저가격</th>
                                                <th class="fw-normal bg-white">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_평가_경매_최저_총액" >
                                                </th>
                                                <th class="fw-normal bg-white">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_평가_경매_최저_단가" >
                                                </th>
                                                <th rowspan="2" class="fw-normal bg-white">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_평가_경매_비율" >
                                                </th>
                                            </tr>
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                <th>최고가격</th>
                                                <th class="fw-normal bg-white">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_평가_경매_최고_총액" >
                                                </th>
                                                <th class="fw-normal bg-white">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_평가_경매_최고_단가" >
                                                </th>
                                            </tr>
                                            <tr class="fw-bolder fs-7 text-gray-800">
                                                <th colspan="2">결정가격</th>
                                                <th class="fw-normal bg-white">
                        ...
                        <div id="kt_content_container">
                            <div class="border rounded p-5 pb-1">
                                <div class="row">
                                    <div class="table-responsive table-loading">
                                        <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
                                            <thead class="align-top bg-secondary align-middle text-center">
                                                <tr class="fw-bolder fs-7 text-gray-800">
                        ...
                        <div id="kt_content_container">
                                ...
                                <div class="col-lg-9 col-md-12 col-sm-12">
                                    <div class="table-responsive table-loading">
                                        <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5 mt-3">
                                            <thead class="align-top align-top bg-secondary align-middle text-center">
                                                <tr class="fw-bolder fs-7 text-gray-800">
                                                    <th>전유부분의 면적</th>
                                                    <th rowspan="2">입지조건</th>
                                                    <th colspan="2">총 층수중 전유부분의 위치</th>
                                                    <th>건축물의 경과년도</th>
                                                </tr>
                                                <tr class="fw-bolder fs-7 text-gray-800">
                                                    <th class="bg-white">
                                                        <div class="row">
                                                            <div class="col-lg-10 col-md-10">
                                                                <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_보정표_전유부분면적">
                                                            </div>
                                                            <div class="col-lg-2 col-md-2">
                                                                <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">m<sup>2</sup></span>
                                                            </div>
                                                    ...
                                                    <th colspan="2" class="bg-white">
                                                        <input type="text" class="form-control form-control-transparent py-0 px-2 fs-7 min-w-100" id="Edit_보정표_전유부분위치">
                                                    </th>
                                                    <th class="bg-white">
                                                        <div class="row">
                                                            <div class="col-lg-10 col-md-10">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div id="Combo_보정표_전유부분의면적"></div>
                                                    </td>
                                                    <td>
                                                        <div id="Combo_보정표_입지조건"></div>
                                                    </td>
                                                    <td colspan="2">
                                                        <div id="Combo_보정표_전유부분의위치"></div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_보정표_전유부분면적_적용율">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_보정표_입지조건_적용율">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_보정표_전유부분위치_등급">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" id="MkEdit_보정표_전유부분위치_적용율">
                                                    </td>
                                                    <td>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-12 col-sm-12">
                                    <div class="table-responsive table-loading">
                                        <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5 mt-3">
                                            <thead class="align-top align-top bg-secondary">
                                                <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                                    <th>점유자의 권리 형태</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <!-- <select class="form-select form-select-sm form-select-transparent py-0" aria-label="Select">
                                                            <option>소유자 본인이 주거 및 상가부분 전부를 직접사용</option>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="row">
                                                        <div class="col-lg-11 col-md-10">
                                                            <input type="text" class="form-control form-control-transparent py-0 px-2 fs-7 text-end min-w-100" id="MkEdit_보정표_평가가격">
                                                        </div>
                                                        <div class="col-lg-1 col-md-2">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-lg-11 col-md-10">
                                                            <input type="text" class="form-control form-control-transparent py-0 px-2 fs-7 text-end min-w-100" id="MkEdit_보정표_최저입찰가">
                                                        </div>
                                                        <div class="col-lg-1 col-md-2">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-lg-11 col-md-10">
                                                            <input type="text" class="form-control form-control-transparent py-0 px-2 fs-7 text-end min-w-100" id="MkEdit_보정표_예상낙찰가">
                                                        </div>
                                                        <div class="col-lg-1 col-md-2">
                                                            <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                        </div>
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th colspan="3" class="fw-normal">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2" id="응찰_사항_사건번호">
                                                </div>
                                            </th>
                                            <th>2. 관할법원</th>
                                            <th colspan="3" class="fw-normal">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2" id="응찰_사항_관할법원">
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th colspan="3" class="fw-normal">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2" id="응찰_사항_경매구분">
                                                </div>
                                            </th>
                                            <th>4. 경매계</th>
                                            <th class="fw-normal">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2" id="응찰_사항_경매계">
                                                </div>
                                            </th>
                                            <th>전화번호</th>
                                            <th class="fw-normal">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2" id="응찰_사항_전화번호">
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2" id="응찰_사항_경매신청채권자">
                                                </div>
                                            </th>
                                            <th>청구금액</th>
                                            <th class="fw-normal">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_사항_청구금액">
                                    ...
                                    <thead class="align-middle bg-secondary">
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_내용_토지_금액">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_내용_토지_단가">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_내용_토지_단가_평당">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_내용_건물_금액">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_내용_건물_단가">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_내용_건물_단가_평당">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_내용_법원감정가합계">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th colspan="2"></th>
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_내용_입찰예정가_금액">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_내용_입찰예정가_낙찰가율">
                                ...
                                <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
                                    <thead class="align-middle bg-secondary">
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_집계표_최고채권액">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th class="fw-normal fs-7 text-gray-800">
                                            ...
                                            <th class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_집계표_최고채권액Combo_Value">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th colspan="2" class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_집계표_선순위자채권최고액">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th>2. 선순위자 배당금합계</th>
                                            <th class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_집계표_선순위자배당금">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th colspan="2" class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_집계표_당사채권최고액">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th>4. 당사 배당금합계</th>
                                            <th class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_집계표_당사배당금">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th colspan="2" class="fw-normal fs-7 text-gray-800">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_집계표_당사미회수채권액">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th></th>
                                ...
                                <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
                                    <thead class="align-middle bg-secondary">
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th colspan="2">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_개요_지점_예상낙찰가율">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">%</span>
                                                </div>
                                            </th>
                                            <th colspan="2">
                                            ...
                                            <th colspan="2">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_개요_본사_예상낙찰가율">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">%</span>
                                                </div>
                                            </th>
                                            <th colspan="3">
                                ...
                                <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
                                    <thead class="align-middle bg-secondary">
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_부담비용합계">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th colspan="4"></th>
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_입찰예정가">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th>실제취득가</th>
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_실제취득가">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_예정_낙찰후매각가능">
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_예상매각금액">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th rowspan="2">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_예상공시지가상승률">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">%</span>
                                                </div>
                                            </th>
                                            <th rowspan="2" colspan="3">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2" id="응찰_수지_예상매각확신사유">
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_예상매각확신금액">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_취득_취득세">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_취득_등록세">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_취득_강제집행">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th rowspan="3">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_취득_합계">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th rowspan="3">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_취득_원가합계">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th rowspan="3">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_취득_총원가합계">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_취득_채권매입">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_취득_기타취득">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_보유수익_임대수익">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th>임대 보증금</th>
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_보유수익_임대보증금">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            <th>월 임대수입</th>
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_보유수익_월임대수입">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_보유수익_기타수익">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            ...
                                            <th colspan="2">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_보유수익_합계">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_보유비용_기회비용">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            ...
                                            <th rowspan="6" colspan="2">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_보유비용_합계">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_보유비용_부가세">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_보유비용_법인세">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_보유비용_재산세">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_보유비용_종부세">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_보유비용_기타유지보수비용">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_처분_비용">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                            ...
                                            <th rowspan="2" colspan="2">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_처분_합계">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_처분_기타비용">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th colspan="3">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_항목별_비용합계">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        ...
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th colspan="3">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_항목별_수익합계">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th colspan="3">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_항목별_예상손익">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="fw-bolder fs-7 text-gray-800">
                                            ...
                                            <th>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" id="응찰_수지_전체손익">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </th>
                    ...
                    <div class="tab-pane fade" id="kt_tab_pane_7" role="tabpanel">
                                ...
                                <thead class="bg-secondary">
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        ...
                                        <th class="fw-normal bg-white">
                                            <div class="row">
                                                <div class="col-lg-11 col-md-10">
                                                    <input id="Edit_배당표_최고채권액" type="text" class="form-control form-control-transparent py-0 px-2 fs-7 text-end min-w-100" />
                                                </div>
                                                <div class="col-lg-1 col-md-2">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <th class="fw-normal bg-white">
                                            <div class="row">
                                                <div class="col-lg-11 col-md-10">
                                                    <input id="Edit_배당표_경매비용" type="text" class="form-control form-control-transparent py-0 px-2 fs-7 text-end min-w-100" />
                                                </div>
                                                <div class="col-lg-1 col-md-2">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="mt-2">
                                <a href="javascript:void(0)" id="Picture27_배당표_주택임차보증금의계산_플러스">
                                    <i class="fas fa-plus-circle"></i>
                                </a>
                                <a href="javascript:void(0)" id="Picture29_배당표_주택임차보증금의계산_마이너스">
                                    <i class="fas fa-minus-circle"></i>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <a href="javascript:void(0)" id="Picture62_배당표_상가건물_임대차보증금의계산_플러스">
                                    <i class="fas fa-plus-circle"></i>
                                </a>
                                <a href="javascript:void(0)" id="Picture64_배당표_상가건물_임대차보증금의계산_마이나스">
                                    <i class="fas fa-minus-circle"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="kt_tab_pane_8" role="tabpanel">
                        ...
                        <div id="kt_content_container">
                            <div class="table-responsive" id="DBGrid_문서"></div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="kt_tab_pane_9" role="tabpanel">
                        ...
                        <div class="card bg-gray-100" id="TreeView1_공통보고서_감정의견">
                        </div>
                    </div>
                                ...
                                <table class="table table-row-bordered table-rounded border gs-5 gy-3 gx-5">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-transparent py-0 px-2 text-end" value="0" readonly="readonly">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0">원</span>
                                                </div>
                                            </td>
                                            <td>
