                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5 mt-3">
                                                    ...
                                                    <tr class="fw-bolder fs-7 text-gray-800">
                                                        <th>가. 설정전 담보여력</th>
                                                        <th colspan="4" class="bg-white text-end" data-type="price" id="담보여력_설정전">
                                                        </th>
                                                    </tr>
                                                    <tr class="fw-bolder fs-7 text-gray-800">
                                                        <th>나. 당사의 설정 예정액</th>
                                                        <th>순위</th>
                                                        <th class="bg-white text-end" data-type="rank" id="당사순위"></th>
                                                        <th>예정액</th>
                                                        <th class="bg-white text-end" data-type="price" id="당사설정금액">
<%--                                                            <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 text-start min-w-100 border rounded-0" id="#">--%>
                                                        </th>
                                                    </tr>

                                                    <tr class="fw-bolder fs-7 text-gray-800">
                                                        <th>다. 당사 설정금액 담보여력</th>
                                                        <th colspan="4" class="bg-white text-end" data-type="price" id="담보여력_설정후">
                                                        </th>
                                                    </tr>

                                                    <tr class="fw-bolder fs-7 text-gray-800">
                                                        <th rowspan="3">라. 당사 설정 후 담보여력</th>
                                                        <th colspan="4" class="bg-white text-end" id="초과_부족설정액_문자">
                                                        </th>
                                                    </tr>
                                                    </thead>
