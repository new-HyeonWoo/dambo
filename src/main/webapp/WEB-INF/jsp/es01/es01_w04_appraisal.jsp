...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            opener.GetComponent('Picture52').rebind($('#Picture52'));
        ...
        <div class="card card-flush shadow-sm">
            <div class="card-header">
                ...
                <div class="card-toolbar align-items-center gap-2 gap-lg-3">
                    <button type="button" class="btn btn-sm btn-outline btn-outline-dashed btn-outline-default" id="Picture52">선택</button>
                </div>
            </div>
