    ...
    function sendPagePopup( dataForm, uri, target, sizeX, sizeY, scroll ) {
     ...
     // 시세조사 사례 
        ...
        function fn_save_Button(){
        	document.listForm.action = "<c:url value='/es01_w02_save.do'/>";
           	document.listForm.submit();
        }
        ...
        function fn_Press_Opinion(){
        	...
        	url ="<c:url value='/es01_w02_p03.do'/>";
        ...
        function fn_find_geoCode(){
        	...
        	url ="<c:url value='/es01_w02_p04.do'/>";
        	sendPagePopup(form, url, target, sizeX, sizeY, scroll )
        ...
        function fn_priceCaseMCheck(piceCaseMLncnt){
 		...
 		function fn_Press_Dividend(){
 			...
 			document.listForm.action = "<c:url value='/es01_w02_Dividend_save.do'/>";
           	document.listForm.submit();
        }
        ...
        <div id="content_pop">
        	...
        	<div id="search">
        		<ul>
        			...
        			<li>
        	            <span class="btn_blue_l">
        	                 <a href="#" onclick="fn_Press_Button('2');">감정가액산출</a>
        	                <img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
        	            </span>
        	        </li>
        	        <li>
				...
				<c:set var="numHousehold" value="${BuildingList.numHousehold}"> </c:set>
					...
					<tbody>
					  ...
					  <tr>
						...
						<td class="tg-0pky"> <input type="text" name="cbYyyy" id="cbYyyy" value="${BuildingList.cbYyyy}" maxlength="10"></input>
						</td>
						<td class="tg-0pky">
							<input type="text" name="numHousehold" id="numHousehold" value="${BuildingList.numHousehold}"></input>
					...
					<tbody>
					  ...
					  <tr>
						...
						<td align="center" rowspan="2">
							<!-- 지붕  select box -->
							<select name="cbRoof" cssClass="use">
								<c:forEach var="roofTypeList" items="${selectRoofTypeList}" varStatus="status">
						...
						<td class="tg-0pky"><input type="text" name=cbYyyy id=cbYyyy value="" maxlength=10 /> 
							 
						</td>
						<td class="tg-0pky">
							<input type="text" name=numHousehold id=numHousehold value=""/>
						 </td>
						<th align="center">공유면적 </th>
					  ...
					  <tr>
						<th align="center" rowspan="3">지역/지구등 <br>지정여부</th>
						<th align="center" colspan="5">국토의 계획 및 이용에 관한 법률에 따른 지역/지구등</th>
						<td class="tg-0pky" colspan="5"><input type="text" name="restPlUse" id="restPlUse" value="" ></input></td>
					  </tr>
					  <tr>
						<th align="center" colspan="5">다른 법률등에 따른 지역 /지구등</th>
						<td  colspan="5"><input type="text" name="restOtLaw" id="restOtLaw" value="" ></input></td>
					  </tr>
					  <tr>
						<th align="center" colspan="5">시행령 부착 제3조에 따른 추가기재확인 내용</th>
						<td class="tg-0pky" colspan="5"><input type="text" name="restEnRule" id="restEnRule" value="" ></input></td>
					  </tr>
					  <tr>
						<th align="center" colspan="6">토지이용규제 기본법시행령 제 9조 제2항 각호에 해당디는 사항</th>
						<td class="tg-0pky" colspan="5"><input type="text" name="restFuLaw" id="restFuLaw" value="" ></input> </td>
					  </tr>
