...
<%@ include file="/WEB-INF/jsp/template/es01_w04.jsp" %>

<script src="/resources/js/ezgen/variable/es01_w04.js"></script>
<script src="/resources/js/ezgen/macro/es01_w04.js"></script>
<script src="/resources/js/ezgen/page/es01_w04.js"></script>
<script src="/resources/js/ezgen/zoon/es01_w04.js"></script>
    ...
    <div class ="row">
        <div class="col-3">
            <div class="d-flex align-items-center justify-content-start gap-4 mb-2 text-nowrap">
                ...
                <a href="javascript:void(0)" id="Picture70" class="btn btn-sm btn-flex btn-white btn-active-primary fw-bolder">
                    <i class="fas fa-file-alt"></i>저장
                </a>
                <a href="javascript:void(0)" id="Picture71" class="btn btn-sm btn-flex btn-white btn-active-primary fw-bolder">
        ...
        <div class="col-9">
            <div class="d-flex align-items-center justify-content-end gap-4 mb-2 text-nowrap">
                ...
                <a href="javascript:void(0)" id="Picture88" class="btn btn-sm btn-flex btn-white btn-active-primary fw-bolder">
    ...
    <div class="card">
        <div class="card-body">
            <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6" id="TabControl1">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#kt_tab_pane_8">배당표Ⅰ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#kt_tab_pane_9">배당표Ⅱ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#kt_tab_pane_10">문서관리</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#kt_tab_pane_11">공통보고서</a>
                </li>
            </ul>
            <div class="tab-content">
                            ...
                            <table class="table table-row-bordered border table-hover align-middle gs-5 gy-3 gx-5">
                                <thead class="bg-secondary align-middle">
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800">
                                        ...
                                        <th class="bg-white">
                                            <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 text-start min-w-100" id="Edit_업소대표자">
                                        </th>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800">
                                        <th>3. 채무자</th>
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        ...
                                        <th class="col-5 bg-white">
                                            <div class="d-flex flex-column-fluid">
                                                <input type="text" id="Edit_소재지" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-start min-w-100" value="" disabled="disabled"/>
                                        ...
                                        <td colspan="8">
                                            <table class="table table-row-bordered border gs-5 gy-3 gx-5">
                                                ...
                                                <tfoot class="bg-secondary">
                                                    <tr>
                                                        <td class="w-750px text-center">합계</td>
                                                        <td class="w-150px bg-white">
                            ...
                            <table class="table table-row-bordered border gs-5 gy-3 gx-5">
                                <thead class="bg-secondary align-middle">
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        ...
                                        <th class="col-1">총액</th>
                                        <th class="col-1">m<sup>2</sup>당 가격</th>
                                        <th class="col-1">평당 단가</th>
                                    </tr>
                                    <tr>
                                        <td class="fw-bolder fs-7 text-gray-800 text-center">실거래가격(등기부상 실거래가격)</td>
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-lg-11 col-md-10">
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-lg-11 col-md-10">
                                                    <input type="text" id="Edit_실거래가격_단가" class="form-control form-control-transparent fs-7 py-0 px-2 text-end min-w-100" value=""/>
                                                </div>
                                                <div class="col-lg-1 col-md-2">
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-lg-11 col-md-10">
                                                    <input type="text" id="Edit_실거래가격_평당단가" class="form-control form-control-transparent fs-7 py-0 px-2 text-end min-w-100" value=""/>
                                                </div>
                                                <div class="col-lg-1 col-md-2">
                            ...
                            <table class="table table-row-bordered table-rounded border gs-5 gy-3 gx-5">
                                ...
                                <tbody>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle text-center bg-secondary">
                                        ...
                                        <td>최저가</td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_상업용_최저가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_상업용_최저가_평" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center text-center bg-secondary">
                                        <td>최고가</td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_상업용_최고가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_상업용_최고가_평" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle text-center bg-secondary">
                                        <td rowspan="2">2</td>
                                        ...
                                        <td>최저가</td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_주거용_최저가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_주거용_최저가_평" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center text-center bg-secondary">
                                        <td>최고가</td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_주거용_최고가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_주거용_최고가_평" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle text-center bg-secondary">
                                        <td rowspan="2">3</td>
                                        ...
                                        <td>최저가</td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_일반용_최저가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_일반용_최저가_평" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center text-center bg-secondary">
                                        <td>최고가</td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_일반용_최고가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_일반용_최고가_평" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle text-center bg-secondary">
                                        <td rowspan="2">4</td>
                                        ...
                                        <td>최저가</td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_전_최저가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_전_최저가_평" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center text-center bg-secondary">
                                        <td>최고가</td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_전_최고가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_전_최고가_평" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle text-center bg-secondary">
                                        <td rowspan="2">5</td>
                                        ...
                                        <td>최저가</td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_답_최저가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_답_최저가_평" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center text-center bg-secondary">
                                        <td>최고가</td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_답_최고가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_답_최고가_평" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center align-middle text-center bg-secondary">
                                        <td rowspan="2">6</td>
                                        ...
                                        <td>최저가</td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_임야_최저가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_임야_최저가_평" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center text-center bg-secondary">
                                        <td>최고가</td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_임야_최고가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_본건인근지역_임야_최고가_평" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7">
                                <table class="table table-row-bordered table-rounded border gs-5 gy-3 gx-5 text-nowrap">
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_표준지요인_공시지가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        ...
                                        <td class="bg-white">
                                            <div class="row">
                                                <div class="col-4">
                                                    <input type="text" id="Edit_기준가격_본건요인_시점수정_날짜" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" disabled/>
                                                </div>
                                                <div class="col-4">
                                                    <span class="fs-7 fw-normal">현재</span>
                                                </div>
                                                <div class="col-4">
                                                    <input type="text" id="Edit_기준가격_본건요인_시점수정" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" disabled/>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="bg-white">
                                            <div class="row">
                                                <div class="col-4">
                                                    <input type="text" id="Edit_기준가격_표준지요인_시점수정_날짜" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" />
                                                </div>
                                                <div class="col-4">
                                                    <span class="fs-7 fw-normal">부터 감정일까지</span>
                                                </div>
                                                <div class="col-4">
                                                    <input type="text" id="Edit_기준가격_표준지요인_시점수정" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" />
                                                </div>
                                            </div>
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_시점수정" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td class="bg-white">
                                            <input type="text" id="기준_Label_시점_본건_경과일" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled />
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_표준지요인_시점수정_날짜_경과일" class="form-control form-control-transparent py-0 px-2 fs-7 min-w-100" value="" disabled />
                                        </td>
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_본건요인_소재지" class="form-control form-control-transparent py-0 px-2 fs-7 min-w-100" value="" disabled>
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_표준지요인_소재지" class="form-control form-control-transparent py-0 px-2 fs-7 min-w-100" value="" disabled>
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_소재지" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_도로조건" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_도로거리" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_관공서접근성" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_중심지역접근성" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_본건요인_기타접근성" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_표준지요인_기타접근성" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_기타접근성" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td rowspan="3" class="align-middle">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_철도접근성" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_폐기물접근성" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_본건요인_기타환경조건" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_표준지요인_기타환경조건" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_기타환경조건" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_용도지역" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_용도지구" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_도시계획" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_저촉률" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_고저" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_형상" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_방위" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_면적" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" />
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_토지이용상황" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" />
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Combo_기준가격_본건요인_기타" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" />
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Combo_기준가격_표준지요인_기타" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" />
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_기타" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" />
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td rowspan="2" class="align-middle">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Combo_기준가격_본건요인_장래의동향" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Combo_기준가격_표준지요인_장래의동향" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_장래의동향" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_본건요인_기타조건" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_표준지요인_기타조건" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_기타조건" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td colspan="5">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_요인합계" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled/>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td colspan="5">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_감가율" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled/>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td colspan="5">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_적용요인합계" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled/>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td colspan="5">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_산정단가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled/>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td colspan="5">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_기준가격_비교치_적용단가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled/>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                ...
                <div class="tab-pane fade" id="kt_tab_pane_4" role="tabpane4">
                    ...
                    <div class="border rounded p-5 pb-1">
                        <div class="row d-flex">
                            <div id="DBGrid_비준가격" class="col-lg-4 col-md-12 col-sm-12">
                            </div>
                            <div class="col-lg-8 col-md-12 col-sm-12">
                                <table class="table table-row-bordered table-rounded border gs-5 gy-3 gx-5 text-nowrap">
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_표준지요인_가격사례" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                        <th class="bg-white"></th>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        ...
                                        <td class="bg-white">
                                            <div class="row">
                                                <div class="col-4">
                                                    <input type="text" id="Edit_비준가격_본건요인_시점수정_날짜" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" disabled/>
                                                </div>
                                                <div class="col-4">
                                                    <span class="fs-7 fw-normal">현재</span>
                                                </div>
                                                <div class="col-4">
                                                    <input type="text" id="Edit_비준가격_본건요인_시점수정" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" disabled/>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="bg-white">
                                            <div class="row">
                                                <div class="col-4">
                                                    <input type="text" id="Edit_비준가격_표준지요인_시점수정_날짜" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" />
                                                </div>
                                                <div class="col-4">
                                                    <span class="fs-7 fw-normal">부터 감정일까지</span>
                                                </div>
                                                <div class="col-4">
                                                    <input type="text" id="Edit_비준가격_표준지요인_시점수정" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" />
                                                </div>
                                            </div>
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_시점수정" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td class="bg-white">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_표준지요인_시점수정_날짜_경과일" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled />
                                        </td>
                                        <td class="bg-white"></td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_본건요인_소재지" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_표준지요인_소재지" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_소재지" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td rowspan="20" class="align-middle">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_도로조건" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_도로거리" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td rowspan="3" class="align-middle">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_관공서접근성" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_중심지역접근성" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_본건요인_기타접근성" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_표준지요인_기타접근성" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_기타접근성" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td rowspan="3" class="align-middle">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_철도접근성" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_폐기물접근성" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_본건요인_기타환경조건" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_표준지요인_기타환경조건" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_기타환경조건" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td rowspan="4" class="align-middle">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_용도지역" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_용도지구" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_도시계획" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_저촉률" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td rowspan="6" class="align-middle">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_고저" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_형상" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_방위" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_면적" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" />
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_토지이용상황" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" />
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Combo_비준가격_본건요인_기타" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" />
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Combo_비준가격_표준지요인_기타" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" />
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_기타" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" />
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td rowspan="2" class="align-middle">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Combo_비준가격_본건요인_장래의동향" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Combo_비준가격_표준지요인_장래의동향" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_장래의동향" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td>
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_본건요인_기타조건" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_표준지요인_기타조건" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_기타조건" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="">
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td colspan="5">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_요인합계" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled/>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td colspan="5">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_산정단가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled/>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td colspan="5">
                                        ...
                                        <td class="bg-white">
                                            <input type="text" id="Edit_비준가격_비교치_적용단가" class="form-control form-control-transparent py-0 px-2 text-end fs-7 min-w-100" value="" disabled/>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="row d-flex">
                            <div class="col-lg-4 col-md-12 col-sm-12">
                                <table class="table table-row-bordered table-rounded border gs-5 gy-3 gx-5">
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td class="w-250px">당해지역의 낙찰가율</td>
                                        <td class="bg-white">
                                            <div class="row">
                                                <div class="col-11">
                                ...
                                <table class="table table-row-bordered table-rounded border gs-5 gy-3 gx-5">
                                    <thead class="bg-secondary">
                                    <tr class="fw-bolder fs-7 text-gray-800">
                                        <td colspan="2">0. 법정지상권의 성립사유 및 적용률</td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td class="w-250px">법정지상권 성립사유</td>
                                        <td class="bg-white">
                            ...
                            <div class="col-lg-8 col-md-12 col-sm-12">
                                <table class="table table-row-bordered table-rounded border gs-5 gy-3 gx-5 text-nowrap">
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800r">
                                        <th colspan="4">1. 주거, 상업, 공업지역내의 나지 (건축물이 없는 토지)</th>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <th class="col-1">접한 도로의 폭</th>
                                        <th class="col-1">토지의 형상</th>
                                        <th class="col-1">담보물의 입지조건</th>
                                        <th class="col-1">토지의 고저</th>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <td class="bg-white">
                                            <div id="Combo_보정표_접한도로폭"></div>
                                        </td>
                                        <td class="bg-white">
                                            <div id="Combo_보정표_토지형상"></div>
                                        </td>
                                        <td class="bg-white">
                                            <div id="Combo_보정표_입지조건"></div>
                                        </td>
                                        <td class="bg-white">
                                            <div id="Combo_보정표_고저"></div>
                                        </td>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <th class="bg-white">
                                            <input type="text" id="Edit_보정표_접한도로폭_적용율" class="form-control form-control-transparent fs-7 py-0 px-2 text-end min-w-100" value="" disabled="disabled">
                                        </th>
                                        <th class="bg-white">
                                            <input type="text" id="Edit_보정표_토지형상_적용률" class="form-control form-control-transparent fs-7 py-0 px-2 text-end min-w-100" value="" disabled="disabled">
                                        </th>
                                        <th class="bg-white">
                                            <input type="text" id="Edit_보정표_입지조건_적용률" class="form-control form-control-transparent fs-7 py-0 px-2 text-end min-w-100" value="" disabled="disabled">
                                        </th>
                                        <th class="bg-white">
                                            <input type="text" id="Edit_보정표_고저_적용율" class="form-control form-control-transparent fs-7 py-0 px-2 text-end min-w-100" value="" disabled="disabled">
                                        </th>
                                    </tr>
                                    </thead>
                                </table>
                                <table class="table table-row-bordered table-rounded border gs-5 gy-3 gx-5 text-nowrap">
                                    <thead class="bg-secondary align-middle">
                                    <tr class="fw-bolder fs-7 text-gray-800">
                                        <th colspan="4">2. 농지(도시계획구역내 녹지지역 또는 도시계획구역외에 위치한 농지)</th>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <th class="col-1">농지의 현황</th>
                                        <th class="col-1">토지의 고저</th>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <th class="bg-white">
                                            <div id="Combo_보정표_농지현황"></div>
                                        </th>
                                        <th class="bg-white">
                                            <div id="Combo_보정표_토지고저"></div>
                                        </th>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <th class="bg-white">
                                            <input type="text" id="Edit_보정표_농지현황_적용률" class="form-control form-control-transparent fs-7 py-0 px-2 text-end min-w-100" value="" disabled="disabled">
                                        </th>
                                        <th class="bg-white">
                                            <input type="text" id="Edit_보정표_토지의고저_적용률" class="form-control form-control-transparent fs-7 py-0 px-2 text-end min-w-100" value="" disabled="disabled">
                                        </th>
                                    </tr>
                                    </thead>
                                </table>
                                <table class="table table-row-bordered table-rounded border gs-5 gy-3 gx-5 text-nowrap">
                                    <thead class="bg-secondary align-middle">
                                    <tr class="fw-bolder fs-7 text-gray-800">
                                        <th colspan="4">3. 임야(도시계획구역내 녹지지역 또는 도시계획구역외에 위치한 임야)</th>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <th class="col-1">임야의 현황</th>
                                        <th class="col-1">개발가능성(경사도)</th>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <th class="bg-white">
                                            <div id="Combo_보정표_임야현황"></div>
                                        </th>
                                        <th class="bg-white">
                                            <div id="Combo_보정표_경사도"></div>
                                        </th>
                                    </tr>
                                    <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                        <th class="bg-white">
                                            <input type="text" id="Edit_보정표_임야현황_적용률" class="form-control form-control-transparent fs-7 py-0 px-2 text-end min-w-100" value="" disabled="disabled">
                                        </th>
                                        <th class="bg-white">
                                            <input type="text" id="Edit_보정표_개발경사도_적용률" class="form-control form-control-transparent fs-7 py-0 px-2 text-end min-w-100" value="" disabled="disabled">
                                        </th>
                                    </tr>
                                    </thead>
                                </table>
                                <div class="row d-flex">
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <table class="table table-row-bordered table-rounded border gs-5 gy-3 gx-5 text-nowrap">
                                            ...
                                            <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                                <th class="bg-white">
                                                    <div id="Combo_보정표_위치"></div>
                                                </th>
                                            </tr>
                                            <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                                <th class="bg-white">
                                                    <input type="text" id="Edit_보정표_위치_적용률" class="form-control form-control-transparent fs-7 py-0 px-2 text-end min-w-100" value="" disabled="disabled">
                                                </th>
                                            </tr>
                                            </thead>
                                        </table>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <table class="table table-row-bordered table-rounded border gs-5 gy-3 gx-5 text-nowrap">
                                            ...
                                            <tr class="fw-bolder fs-7 text-gray-800 text-center">
                                                <th class="bg-white">
                                                    <input type="text" id="Edit_보정표_공유지분_적용률" class="form-control form-control-transparent fs-7 py-0 px-2 text-end min-w-100" value="" disabled="disabled">
                                                </th>
                                            </tr>
                                            </thead>
                                        </table>
                                ...
                                <div class="d-flex align-items-center justify-content-start gap-4 mb-2 text-nowrap">
                                    <div class="fw-bold text-danger">&#8251;자연환경보전지역, 개발제한구역내의 농지 또는 임야의 경우 농입지역에 준하여 비준율을 적용할것</div>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800">
                                        ...
                                        <th class="fw-normal bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_사항_청구금액">
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 mx-2">원</span>
                                                </div>
                                            </div>
                                        </th>
                                        <th>6.경매개시등기일</th>
                                ...
                                <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800">
                                        ...
                                        <th class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_내용_토지_금액" />
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <th class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_내용_토지_단가" disabled="disabled"/>
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <th class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_내용_토지_단가_평당" disabled="disabled"/>
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800">
                                        ...
                                        <th class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_내용_건물_금액" />
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <th class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_내용_건물_단가" disabled="disabled" />
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <th class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_내용_건물_단가_평당" disabled="disabled" />
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800">
                                        ...
                                        <th class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_내용_법원감정가합계" disabled="disabled"/>
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800">
                                        ...
                                        <th class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_내용_입찰예정가_금액" disabled="disabled" />
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <th class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_내용_입찰예정가_낙찰가율" disabled="disabled" />
                                                </div>
                                                <div class="col-3">
                                ...
                                <table class="table table-row-bordered table-rounded border table-hover gs-5 gy-3 gx-5">
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800">
                                        ...
                                        <th class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_집계표_최고채권액">
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <th class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_집계표_최고채권액Combo_Value">
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800">
                                        ...
                                        <th colspan="2" class="fw-normal fs-7 col-md-4 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_집계표_선순위자채권최고액">
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <th class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_집계표_선순위자배당금">
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800">
                                        ...
                                        <th colspan="2" class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_집계표_당사채권최고액">
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <th class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_집계표_당사배당금">
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                    ...
                                    <tr class="fw-bolder fs-7 text-gray-800">
                                        ...
                                        <th colspan="2" class="fw-normal fs-7 text-gray-800 bg-white">
                                            <div class ="row">
                                                <div class="col-9">
                                                    <input type="text" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" id="응찰_집계표_당사미회수채권액">
                                                </div>
                                                <div class="col-3">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                ...
                <div class="tab-pane fade" id="kt_tab_pane_8" role="tabpane8">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="mt-2">
                            ...
                            <a href="javascript:void(0)" id="Picture45">
                                <i class="fas fa-minus-circle"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="mt-2">
                            ...
                            <a href="javascript:void(0)" id="Picture48">
                                <i class="fas fa-minus-circle"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="kt_tab_pane_10" role="tabpane10">
                ...
                <div class="tab-pane fade" id="kt_tab_pane_11" role="tabpane11">
                    <div class="d-flex justify-content-between">
                        <h5 class="mt-1">
                            <span class="svg-icon svg-icon-primary svg-icon-2hx">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <table class="table table-row-bordered table-rounded border gs-5 gy-3 gx-5">
                                    ...
                                    <tr>
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-11">
                                                    <input type="text" id="Edit_공통보고서_지점_최저가" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" value="" disabled="disabled"/>
                                                </div>
                                                <div class="col-1">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-11">
                                                    <input type="text" id="Edit_공통보고서_본사_최저가" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" value="" disabled="disabled" />
                                                </div>
                                                <div class="col-1">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-11">
                                                    <input type="text" id="Edit_공통보고서_지점_최고가" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" value="" disabled="disabled" />
                                                </div>
                                                <div class="col-1">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-11">
                                                    <input type="text" id="Edit_공통보고서_본사_최고가" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" value="" disabled="disabled" />
                                                </div>
                                                <div class="col-1">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-11">
                                                    <input type="text" id="Edit_공통보고서_지점_평가가격" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" value="" disabled="disabled" />
                                                </div>
                                                <div class="col-1">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-11">
                                                    <input type="text" id="Edit_공통보고서_본사_평가가격" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" value="" disabled="disabled" />
                                                </div>
                                                <div class="col-1">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-11">
                                                    <input type="text" id="Edit_공통보고서_지점_예상낙찰가율" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" value="" disabled="disabled" />
                                                </div>
                                                <div class="col-1">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">%</span>
                                                </div>
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-11">
                                                    <input type="text" id="Edit_공통보고서_본사_예상낙찰가율" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" value="" disabled="disabled" />
                                                </div>
                                                <div class="col-1">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">%</span>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-11">
                                                    <input type="text" id="Edit_공통보고서_지점_예상낙찰가" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" value="" disabled="disabled" />
                                                </div>
                                                <div class="col-1">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-11">
                                                    <input type="text" id="Edit_공통보고서_본사_예상낙찰가" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" value="" disabled="disabled" />
                                                </div>
                                                <div class="col-1">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-11">
                                                    <input type="text" id="Edit_공통보고서_지점_당사설정액" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" value="" disabled="disabled" />
                                                </div>
                                                <div class="col-1">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-11">
                                                    <input type="text" id="Edit_공통보고서_본사_당사설정액" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" value="" disabled="disabled" />
                                                </div>
                                                <div class="col-1">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-11">
                                                    <input type="text" id="Edit_공통보고서_지점_초과부족설정분" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" value="" disabled="disabled" />
                                                </div>
                                                <div class="col-1">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                                        ...
                                        <td class="bg-white">
                                            <div class ="row">
                                                <div class="col-11">
                                                    <input type="text" id="Edit_공통보고서_본사_초과부족설정분" class="form-control form-control-transparent fs-7 py-0 px-2 mx-2 text-end min-w-100" value="" disabled="disabled" />
                                                </div>
                                                <div class="col-1">
                                                    <span class="input-group-text bg-transparent fs-10 text-danger fw-bolder border-0 p-0 py-1">원</span>
                                                </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="mb-2">
                            <a id="Picture51" href="javascript:void(0)" class="btn btn-sm btn-outline btn-outline-dashed btn-outline-default me-2 mb-2">의견보기</a>
                        </div>
                    </div>
