...
function saveImage(){
	...
	svgCanvas.rasterExport('PNG', NaN, 'front');
...
<div id="svg_editor">
  ...
  <div style="position: absolute;top:28px;left:4px;" ><input id="btn_Image" type="button" value="저장 " role="<%=imgType%>"></div>
