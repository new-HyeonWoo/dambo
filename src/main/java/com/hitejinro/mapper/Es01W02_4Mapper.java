 ...
 */
@Mapper
public interface Es01W02_4Mapper {
    /** PRT_00_담보마스타 */
    ...
    /** Q_영업감정요청자료 */
    default List<HashMap<String, Object>> selectList90WithCondition(HashMap<String, Object> params) {
        params.put("condition1", String.valueOf(params.get("전체선택여부")));
        return selectList90(params);
    }
    ...
    /** 저장_00_담보마스터 */
    int save101(HashMap<String, Object> params);

    /** 저장_01_규제의표시 */
    int save102(HashMap<String, Object> params);

    /** 저장_02_입력표 */
    int save103(HashMap<String, Object> params);

    int delete104(HashMap<String, Object> params);
    int insert104(HashMap<String, Object> params);

    /** 저장_10_감정가_본건 */
    default void save104(HashMap<String, Object> sParam, List<HashMap<String, Object>> params){
        delete104(sParam);
    ...
    /** 저장_10_감정가_본건_입지특성 */
    int save105(HashMap<String, Object> params);

    int delete106(HashMap<String, Object> params);
    int insert106(HashMap<String, Object> params);

    /** 저장_11_감정가_가격사례 */
    default void save106(HashMap<String, Object> sParam, List<HashMap<String, Object>> params){
        delete106(sParam);
        for (HashMap<String, Object> param : params) {
            insert106(param);
        }
    ...
    int delete107(HashMap<String, Object> params);
    int insert107(HashMap<String, Object> params);

    /** 저장_12_감정가_경매사례 */
    default void save107(HashMap<String, Object> sParam, List<HashMap<String, Object>> params){
        delete107(sParam);
		for (HashMap<String, Object> param : params) {
            insert107(param);
        }
    ...
    int delete108(HashMap<String, Object> params);
    int insert108(HashMap<String, Object> params);

    /** 저장_13_감정가_비준가격 */
    default void save108(HashMap<String, Object> sParam, List<HashMap<String, Object>> params){
        delete108(sParam);
		for (HashMap<String, Object> param : params) {
            insert108(param);
        }
    ...
    /** 저장_결재자현황_영업_Clear */
    int save117(HashMap<String, Object> params);

    /** 저장_담보마스타_담보여력등 */
    int save118(HashMap<String, Object> params);

    int delete119(HashMap<String, Object> params);
    int insert119(HashMap<String, Object> params);

    /** 저장_문서관리 */
    default void save119(HashMap<String, Object> sParam, List<HashMap<String, Object>> params){
        delete119(sParam);
		for (HashMap<String, Object> param : params) {
            insert119(param);
        }
    ...
    int delete120(HashMap<String, Object> params);
    int insert120(HashMap<String, Object> params);

    /** 저장_문서관리_문서 */
    default void save120(HashMap<String, Object> sParam, List<HashMap<String, Object>> params){
        delete120(sParam);
		for (HashMap<String, Object> param : params) {
            insert120(param);
        }
    ...
    int delete121(HashMap<String, Object> params);
    int insert121(HashMap<String, Object> params);

    /** 저장_배당금_배당금 */
    default void save121(HashMap<String, Object> sParam, SaveRequest saveRequest){
        delete121(sParam);
    ...
    /** 저장_배당금_배당표M */
    int save122(HashMap<String, Object> params);
