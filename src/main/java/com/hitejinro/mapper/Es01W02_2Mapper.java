 ...
 */
@Mapper
public interface Es01W02_2Mapper {
    /** PRT_00_담보마스타 */
    ...
    /** Q_영업감정요청자료 */
    default List<HashMap<String, Object>> selectList92WithCondition(HashMap<String, Object> params) {
        params.put("condition1", String.valueOf(params.get("전체선택여부")));
        return selectList92(params);
    }
    ...
    /** 저장_02_입력표 */
    int save104(HashMap<String, Object> params);

    /** 저장_10_감정가_본건 */
    int save105(HashMap<String, Object> params);

    /** 저장_19_감정가_평가액산정 */
    int save106(HashMap<String, Object> params);

    /** 저장_20_낙찰가율보정표 */
    int save107(HashMap<String, Object> params);

    /** 저장_40_응찰마스타 */
    int save108(HashMap<String, Object> params);
    ...
    /** 저장_담보마스타_담보여력등 */
    int save112(HashMap<String, Object> params);
    ...
    /** 저장_탁상감정_담보감정M변경 */
    int save115(HashMap<String, Object> params);
    ...
    default void save121(HashMap<String, Object> sParam, List<HashMap<String, Object>> params) {
        delete121(sParam);
        for (HashMap<String, Object> param : params) {
            insert121(param);
        }
    ...
    default void save124(HashMap<String, Object> sParam, SaveRequest saveRequest) {
        delete124(sParam);
