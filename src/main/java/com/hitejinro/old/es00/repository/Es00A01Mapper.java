...
@Mapper
public interface Es00A01Mapper {
	...
	int insertTopMenu(Object insertObj) throws Exception;
	
	int updateTopMenu(Object updateObj) throws Exception;
	
	int deleteTopMenu(Object deleteObj) throws Exception;
	
	int margeMenu(Object margeObj) throws Exception;
	
	int deleteMenu(Object deleteObj) throws Exception;
	
	int margeGroup(Object margeObj) throws Exception;
