...
public class Es01W03Controller {
    ...
    private static final Logger logger = LoggerFactory.getLogger(Es01W03Controller.class); 
    ...
    @RequestMapping(value = "/es01_w03_edit.do")
	public String es01_w03_edit(@ModelAttribute("searchVO") Es01SearchEntity searchVO,
		...
		System.out.println("liquorType===>"+liquorType);
		...
		System.out.println("selectLandUseZoneList===>"+selectLandUseZoneList);
		...
		System.out.println("selectRoofTypeList===>"+selectRoofTypeList);
		...
		System.out.println("selectFormOccpantAptList===>"+selectFormOccpantAptList);
		...
		//00_일련번호
		List<?> selectEs01_w03DIV999List = es01W03Service.selectEs01_w03DIV999List(searchVO);
		model.addAttribute("selectEs01_w03DIV999List", selectEs01_w03DIV999List);
		System.out.println("selectEs01_w03DIV999List===>"+selectEs01_w03DIV999List);
