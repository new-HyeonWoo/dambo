...
import com.hitejinro.mapper.popup.Es01W04PopupMapper;
...
@Service("Es01W04PopupService")
@RequiredArgsConstructor
public class Es01W04PopupServiceImpl implements Es01PopupService {
	private final Es01W04PopupMapper es01W04PopupMapper;
	...
	public List<HashMap<String, Object>> findQuery(HashMap<String, Object> params, String name) {
		switch (name) {
			case "Q_당사설정시담보여력":
				return es01W04PopupMapper.selectList6(params);
			case "Q_말소되지않는권리자의존재여부":
				return es01W04PopupMapper.selectList7(params);
			case "Q_크로스":
				return es01W04PopupMapper.selectList8(params);
			case "Q_배당금집계_근거내역":
				return es01W04PopupMapper.selectList9(params);
			default:
	...
	public void saveQuery(SaveRequest saveRequest, String name) {
		...
		switch (name) {
			case "00_수정_배당금_ES3402":
				es01W04PopupMapper.save3List(params, saveRequest.getListMap());
				break;
			case "00_수정_배당금_ES3405":
				es01W04PopupMapper.save4List(params, saveRequest.getListMap());
				break;
			case "저장_담보마스타_담보여력등":
				es01W04PopupMapper.save5(params);
				break;
			default:
